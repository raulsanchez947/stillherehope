...
#line 44 "include/gba/syscall.h"
void CpuFastSet(const void *src, void *dest, u32 control);
#line 56 "include/gba/syscall.h"
...
#line 1066 "include/constants/pokedex.h"
enum {
    HOENN_DEX_NONE,
    HOENN_DEX_TREECKO,
    HOENN_DEX_GROVYLE,
...
struct SaveBlock2
{
    ...
    u8 questData[((((29 + 1)) / (8)) + ((((29 + 1)) % (8)) ? 1 : 0)) * 5];
    u8 subQuests[((((10 + 20)) / (8)) + ((((10 + 20)) % (8)) ? 1 : 0))];
};
...
struct Tileset
{
      ...
      TilesetCB callback;
      const u16 (*fall_palettes)[16];
      const u16 (*winter_palettes)[16];
      const u16 (*spring_palettes)[16];
};
...
#line 281 "include/global.fieldmap.h"
enum
{
    ACRO_BIKE_NORMAL,
    ACRO_BIKE_TURNING,
...
struct PokemonSubstruct3
{
   ...
   u32 unusedRibbons:2;
   u32 abilityNum:2;
#line 197 "include/pokemon.h"
   u32 modernFatefulEncounter:1;
};
#line 209 "include/pokemon.h"
...
extern const struct Fusion *const gFusionTablePointers[1010 + 370 + 1];
#line 458 "include/pokemon.h"
extern u8 gPlayerPartyCount;
extern struct Pokemon gPlayerParty[6];
extern struct Pokemon gPlayerPartyBackup[6];
...
extern const u8 *const gItemEffectTable[818];
...
extern const u16 *const gFormSpeciesIdTables[1010 + 370 + 1];
extern const struct FormChange *const gFormChangeTablePointers[1010 + 370 + 1];
extern const u32 sExpCandyExperienceTable[];
extern const u16 gEvolutionLines[1010 + 370 + 1][22];
...
struct SaveBlock1
{
      ...
      struct WaldaPhrase waldaPhrase;
               u8 dexNavSearchLevels[1010 + 370 + 1];
               u8 dexNavChain;
