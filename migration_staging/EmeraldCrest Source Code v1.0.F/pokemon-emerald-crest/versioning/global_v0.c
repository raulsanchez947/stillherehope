...
#line 1052 "include/constants/pokedex.h"
enum {
    HOENN_DEX_NONE,
    HOENN_DEX_TREECKO,
    HOENN_DEX_GROVYLE,
...
extern const struct Fusion *const gFusionTablePointers[1010 + 343 + 1];
...
extern const u16 *const gFormSpeciesIdTables[1010 + 343 + 1];
extern const struct FormChange *const gFormChangeTablePointers[1010 + 343 + 1];
extern const u32 sExpCandyExperienceTable[];
extern const u16 gEvolutionLines[1010 + 343 + 1][22];
...
struct SaveBlock1
{
      ...
      u8 dexSeen[((((NATIONAL_DEX_IRON_LEAVES + 1)) / (8)) + ((((NATIONAL_DEX_IRON_LEAVES + 1)) % (8)) ? 1 : 0))];
      u8 dexCaught[((((NATIONAL_DEX_IRON_LEAVES + 1)) / (8)) + ((((NATIONAL_DEX_IRON_LEAVES + 1)) % (8)) ? 1 : 0))];
      ...
      struct WaldaPhrase waldaPhrase;
               u8 dexNavSearchLevels[1010 + 343 + 1];
               u8 dexNavChain;
