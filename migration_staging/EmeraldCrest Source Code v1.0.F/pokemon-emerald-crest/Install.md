...
2.  - If libpng is **not installed**, then go to [Installing libpng (macOS)](#installing-libpng-macos).
    ...
    - Otherwise, **open the Terminal** and go to [Choosing where to store pokemon-emerald-crest (macOS)](#choosing-where-to-store-pokemon-emerald-crest-macos)
...
3. Run the following command to install libpng.
    ...
    If both pkg-config and devkitARM are already installed, go to [Choosing where to store pokemon-emerald-crest (macOS)](#choosing-where-to-store-pokemon-emerald-crest-macos).
...
3. Run the following command to install libpng.
    ...
    Continue to [Installing devkitARM (macOS)](#installing-devkitarm-macos) if **devkitARM is not installed**, otherwise, go to [Choosing where to store pokemon-emerald-crest (macOS)](#choosing-where-to-store-pokemon-emerald-crest-macos).
...
# Building pokemon-emerald-crest
Follow these steps to build `pokemon-emerald-crest`.
1. Navigate to the directory you want to keep the project in, be aware of any system specific limitations.
2. Download `emerald-crest`
