...
struct SaveBlock2
{
    // _saveSentinel, saveVersion and expansionVersion are used by the save migration system. Please do not (re)move them.
    ...
    /*0x14*/ u16 optionsTextSpeed:3; // OPTIONS_TEXT_SPEED_[SLOW/MID/FAST]
             ...
             u16 optionsUnitSystem:1;   //optionsPlus
             u16 optionsHpBarSpeed:4;   //optionsPlus
             u16 optionsExpBarSpeed:4;  //optionsPlus
             u16 optionsDisableMatchCall:1; //optionsPlus
             u16 optionsCurrentFont:1;  //optionsPlus
    ...
    /*0x????*/ u8 autoRun:1;
    /*0x????*/ u8 version; // crest version
               u16 Blost; // Battle's Lost
               u8 badges:4; //number of badges obtained.
               u8 ExpShare:1; // Used in setting to have exp share on or off
               u8 follower:1;
               u8 playerPartyAvg;
               u32 playerRank;
               u16 rarecandycount;
               ...
               u8 storedIndex;
               u16 fossilSpecies;
               u16 SpecialMysteryGifts[100];
               u8 specialMysteryGiftCount;
               u8 seasons:2;
               u8 seasonalEncounters:1;
               u8 seasonalEvolutions:1;
...
struct SaveBlock1
{
    ...
    /*0x3D88*/ u8 NuzlockeEncounterFlags[9]; 
        ...
        u8 in_battle_type_effectiveness:1;    // Used in setting to have in-battle type effectiveness shown
        u8 padding:6;
        ...
        u8 seasons:2; // 4 seasons
        u8 tx_Challenges_MegaEvo:1;
    // sizeof: 0x3???
};
