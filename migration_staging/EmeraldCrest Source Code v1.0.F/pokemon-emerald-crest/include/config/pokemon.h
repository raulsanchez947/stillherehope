...
#define P_FLAG_FORCE_NO_SHINY   FLAG_NO_SHINY     // If this flag is set, all wild and gift Pokémon will forced into NOT being Shiny.
...
#define P_CRY_POKEMON               TRUE        // Generation 9 cry
