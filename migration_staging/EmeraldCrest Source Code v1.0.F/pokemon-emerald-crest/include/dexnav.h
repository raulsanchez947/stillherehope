...
#define DEXNAV_TIMEOUT                  20  //20 seconds is the time out. Max of 1092 seconds allowed
...
#define HIDDEN_MON_PROBABILTY       60  //x% chance of finding hidden mon compared to regular encounter data
...
struct DexNavSearch
{
    ...
    u8 hiddenSearch:1;
    u8 isHiddenMon:1;
    u8 taskId:4;                              // Stores the taskId for the dexnav
    u8 unk:2;
    u16 palBuffer[16];
};

extern struct DexNavSearch *gDexNavSearchDataPtr;
