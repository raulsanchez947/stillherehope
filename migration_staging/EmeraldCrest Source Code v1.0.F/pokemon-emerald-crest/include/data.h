...
extern const struct CompressedSpritePalette gHisuiMonPaletteTable[];
extern const struct CompressedSpritePalette gShinyHisuiMonPaletteTable[];
...
extern const u8 gSeasonNames[][7 + 1];
