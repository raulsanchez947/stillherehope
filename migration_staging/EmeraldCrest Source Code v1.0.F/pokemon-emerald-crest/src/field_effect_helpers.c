...
u16 GetDisguiseTreePal(u8 fldEffObj)
{
    if (!FlagGet(FLAG_SEASONS))
        return gFieldEffectObjectTemplatePointers[fldEffObj]->paletteTag;
    ...
    case 0:
        ...
        break;
    case 1:
        return gFieldEffectObjectTemplatePointers[fldEffObj]->paletteTag_Fall;
        break;
    case 2:
        return gFieldEffectObjectTemplatePointers[fldEffObj]->paletteTag_Winter;
        break;
    case 3:
        return gFieldEffectObjectTemplatePointers[fldEffObj]->paletteTag_Spring;
        break;
    default:
        return gFieldEffectObjectTemplatePointers[fldEffObj]->paletteTag;
        break;
...
u32 FldEff_TallGrass(void)
{
    ...
    if (FlagGet(FLAG_SEASONS))
    {
        ...
        case 0:
            ...
            break;
        case 1:
            spriteId = CreateSpriteAtEnd(gFieldEffectObjectTemplatePointers[FLDEFFOBJ_TALL_GRASS_FALL], x, y, 0);
            break;
        case 2:
            spriteId = CreateSpriteAtEnd(gFieldEffectObjectTemplatePointers[FLDEFFOBJ_TALL_GRASS_WINTER], x, y, 0);
            break;
        case 3:
            spriteId = CreateSpriteAtEnd(gFieldEffectObjectTemplatePointers[FLDEFFOBJ_TALL_GRASS_SPRING], x, y, 0);
            break;        
        default:
            spriteId = CreateSpriteAtEnd(gFieldEffectObjectTemplatePointers[FLDEFFOBJ_TALL_GRASS], x, y, 0);
            break;
...
u32 FldEff_LongGrass(void)
{
    ...
    if (FlagGet(FLAG_SEASONS))
    {
        ...
        case 0:
            ...
            break;
        case 1:
            spriteId = CreateSpriteAtEnd(gFieldEffectObjectTemplatePointers[FLDEFFOBJ_LONG_GRASS_FALL], x, y, 0);
            break;
        case 2:
            spriteId = CreateSpriteAtEnd(gFieldEffectObjectTemplatePointers[FLDEFFOBJ_LONG_GRASS_WINTER], x, y, 0);
            break;
        case 3:
            spriteId = CreateSpriteAtEnd(gFieldEffectObjectTemplatePointers[FLDEFFOBJ_LONG_GRASS_SPRING], x, y, 0);
            break;        
        default:
            spriteId = CreateSpriteAtEnd(gFieldEffectObjectTemplatePointers[FLDEFFOBJ_LONG_GRASS], x, y, 0);
            break;
...
u32 FldEff_ShakingGrass(void)
{
    ...
    if (FlagGet(FLAG_SEASONS))
    {
        ...
        case 0:
            ...
            break;
        case 1:
            spriteId = CreateSpriteAtEnd(gFieldEffectObjectTemplatePointers[FLDEFFOBJ_SHAKING_GRASS_FALL], gFieldEffectArguments[0], gFieldEffectArguments[1], gFieldEffectArguments[2]);
            break;
        case 2:
            spriteId = CreateSpriteAtEnd(gFieldEffectObjectTemplatePointers[FLDEFFOBJ_SHAKING_GRASS_WINTER],gFieldEffectArguments[0], gFieldEffectArguments[1], gFieldEffectArguments[2]);
            break;
        case 3:
            spriteId = CreateSpriteAtEnd(gFieldEffectObjectTemplatePointers[FLDEFFOBJ_SHAKING_GRASS_SPRING], gFieldEffectArguments[0], gFieldEffectArguments[1], gFieldEffectArguments[2]);
            break;        
        default:
            spriteId = CreateSpriteAtEnd(gFieldEffectObjectTemplatePointers[FLDEFFOBJ_UNUSED_GRASS], gFieldEffectArguments[0], gFieldEffectArguments[1], gFieldEffectArguments[2]);
            break;
...
u32 FldEff_ShakingGrass2(void)
{
    ...
    if (FlagGet(FLAG_SEASONS))
    {
        ...
        case 0:
            ...
            break;
        case 1:
            spriteId = CreateSpriteAtEnd(gFieldEffectObjectTemplatePointers[FLDEFFOBJ_SHAKING_GRASS2_FALL], gFieldEffectArguments[0], gFieldEffectArguments[1], gFieldEffectArguments[2]);
            break;
        case 2:
            spriteId = CreateSpriteAtEnd(gFieldEffectObjectTemplatePointers[FLDEFFOBJ_SHAKING_GRASS2_WINTER],gFieldEffectArguments[0], gFieldEffectArguments[1], gFieldEffectArguments[2]);
            break;
        case 3:
            spriteId = CreateSpriteAtEnd(gFieldEffectObjectTemplatePointers[FLDEFFOBJ_SHAKING_GRASS2_SPRING], gFieldEffectArguments[0], gFieldEffectArguments[1], gFieldEffectArguments[2]);
            break;        
        default:
            spriteId = CreateSpriteAtEnd(gFieldEffectObjectTemplatePointers[FLDEFFOBJ_UNUSED_GRASS_2], gFieldEffectArguments[0], gFieldEffectArguments[1], gFieldEffectArguments[2]);
            break;
...
static u32 ShowDisguiseFieldEffect(u8 fldEff, u8 fldEffObj, u8 paletteNum)
{
    ...
    {
        sprite = &gSprites[spriteId];
        sprite->oam.paletteNum = LoadObjectEventPalette(GetDisguiseTreePal(fldEffObj));
