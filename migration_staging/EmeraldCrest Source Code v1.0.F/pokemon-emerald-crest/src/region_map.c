...
const u16 sRegionMapBg_Pal_Fall[] = INCBIN_U16("graphics/pokenav/region_map/map_fall.gbapal");
const u16 sRegionMapBg_Pal_Winter[] = INCBIN_U16("graphics/pokenav/region_map/map_winter.gbapal");
const u16 sRegionMapBg_Pal_Spring[] = INCBIN_U16("graphics/pokenav/region_map/map_spring.gbapal");
...
static const u16 *const seasons[4] = {
    sRegionMapBg_Pal,
    sRegionMapBg_Pal_Fall,
    sRegionMapBg_Pal_Winter,
    sRegionMapBg_Pal_Spring,
};
...
bool8 LoadRegionMapGfx(void)
{
    ...
    case 2:
        if (!FreeTempTileDataBuffersIfPossible()) {
            ...
            {
                GetCurrentSeason();
                LoadPalette(seasons[gSaveBlock1Ptr->seasons], BG_PLTT_ID(7), 3 * PLTT_SIZE_4BPP);
            } else {
