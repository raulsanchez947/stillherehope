...
static const u8 sLevelCapTable_Normal[] = 
{
    ...
    [LEVEL_CAP_BADGE_1]     = 20,
    [LEVEL_CAP_BADGE_2]     = 26,
    [LEVEL_CAP_BADGE_3]     = 35,
    [LEVEL_CAP_BADGE_4]     = 38,
    [LEVEL_CAP_BADGE_5]     = 46,
    [LEVEL_CAP_BADGE_6]     = 56,
    [LEVEL_CAP_BADGE_7]     = 62,
    [LEVEL_CAP_BADGE_8]     = 88,
};
...
static const u8 sLevelCapTable_Hard[] = 
{
    ...
    [LEVEL_CAP_BADGE_3]     = 34,
    [LEVEL_CAP_BADGE_4]     = 37,
    [LEVEL_CAP_BADGE_5]     = 46,
    [LEVEL_CAP_BADGE_6]     = 54,
    [LEVEL_CAP_BADGE_7]     = 60,
    [LEVEL_CAP_BADGE_8]     = 86,
};

static const u8 sLevelCap_Hard[] = 
{
    [LEVEL_CAP_NO_BADGES]   = 17,
    [LEVEL_CAP_BADGE_1]     = 21,
    [LEVEL_CAP_BADGE_2]     = 25,
    [LEVEL_CAP_BADGE_3]     = 37,
    [LEVEL_CAP_BADGE_4]     = 43,
    [LEVEL_CAP_BADGE_5]     = 53,
    [LEVEL_CAP_BADGE_6]     = 63,
    [LEVEL_CAP_BADGE_7]     = 71,
    [LEVEL_CAP_BADGE_8]     = 96,
};

static const u8 sLevelCap_Extreme[] = 
{
    [LEVEL_CAP_NO_BADGES]   = 15,
    [LEVEL_CAP_BADGE_1]     = 19,
    [LEVEL_CAP_BADGE_2]     = 23,
    [LEVEL_CAP_BADGE_3]     = 35,
    [LEVEL_CAP_BADGE_4]     = 41,
    [LEVEL_CAP_BADGE_5]     = 51,
    [LEVEL_CAP_BADGE_6]     = 61,
    [LEVEL_CAP_BADGE_7]     = 69,
...
u8 GetCurrentPartyLevelCap(void)
{
    ...
    if (gSaveBlock1Ptr->tx_Difficulty >= 2) {
        ...
        if (gSaveBlock1Ptr->tx_Challenges_LevelCap == 1)
            return sLevelCap_Hard[gSaveBlock2Ptr->badges];

        if (gSaveBlock1Ptr->tx_Challenges_LevelCap == 2)
            return sLevelCap_Extreme[gSaveBlock2Ptr->badges];        
    }
  
    if (gSaveBlock1Ptr->tx_Challenges_LevelCap == 1) //normal level cap
        return sLevelCapTable_Normal[gSaveBlock2Ptr->badges];

    if (gSaveBlock1Ptr->tx_Challenges_LevelCap == 2) //hard level cap
        return sLevelCapTable_Hard[gSaveBlock2Ptr->badges];
...
u8 GetCurrentTrainerIVs(void)
{
  ...
  if (FlagGet(FLAG_OPEN_WORLD)) {
    ...
    {
    case 1:     return sIV_Table[gSaveBlock2Ptr->badges];
...
u8 GetCurrentTrainerEVs(void)
{
    ...
    {
    case 1:     return sEV_Table[gSaveBlock2Ptr->badges];
    case 2:     return 252;
    case 3:     return 0;
    default:    return 0;
    }
