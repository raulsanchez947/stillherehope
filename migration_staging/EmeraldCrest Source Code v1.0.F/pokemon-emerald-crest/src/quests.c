...
static const u8 sText_AllHeader[] = _("{COLOR WHITE}All Missions");
static const u8 sText_InactiveHeader[] = _("{COLOR WHITE}Inactive Missions");
static const u8 sText_ActiveHeader[] = _("{COLOR WHITE}Active Missions");
static const u8 sText_RewardHeader[] = _("{COLOR WHITE}Reward Available");
static const u8 sText_CompletedHeader[] =
      _("{COLOR WHITE}Completed Missions");
static const u8 sText_QuestNumberDisplay[] =
      _("{COLOR WHITE}{STR_VAR_1}/{STR_VAR_2}");
static const u8 sText_Unk[] = _("{COLOR WHITE}??????");
...
static const u8 sText_Type[] = _("{R_BUTTON}{COLOR WHITE}Type");
...
static const u8 sText_Close[] = _("{COLOR WHITE}Close");
...
u8 GenerateList(bool8 isFiltered)
{
	...
	for (countQuest = 0; countQuest < 6; countQuest++)
	{
...
static void GenerateDenominatorNumQuests(void)
{
	ConvertIntToDecimalStringN(gStringVar2, 6,
