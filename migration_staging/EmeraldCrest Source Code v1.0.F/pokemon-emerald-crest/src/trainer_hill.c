...
static const u16 sPrizeListRareCandy1[]  = {ITEM_GOLD_BOTTLE_CAP,       ITEM_GOLD_BOTTLE_CAP, ITEM_BOTTLE_CAP, ITEM_EXP_CANDY_XL, ITEM_ABILITY_CAPSULE, ITEM_ABILITY_PATCH};
static const u16 sPrizeListLuxuryBall1[] = {ITEM_GOLD_BOTTLE_CAP,      ITEM_GOLD_BOTTLE_CAP, ITEM_BOTTLE_CAP, ITEM_EXP_CANDY_XL, ITEM_ABILITY_CAPSULE, ITEM_ABILITY_PATCH};
static const u16 sPrizeListMaxRevive1[]  = {ITEM_GOLD_BOTTLE_CAP,       ITEM_GOLD_BOTTLE_CAP, ITEM_BOTTLE_CAP, ITEM_EXP_CANDY_XL, ITEM_ABILITY_CAPSULE, ITEM_ABILITY_PATCH};
static const u16 sPrizeListMaxEther1[]   = {ITEM_GOLD_BOTTLE_CAP,        ITEM_GOLD_BOTTLE_CAP, ITEM_BOTTLE_CAP, ITEM_EXP_CANDY_XL, ITEM_ABILITY_CAPSULE, ITEM_ABILITY_PATCH};
static const u16 sPrizeListElixir1[]     = {ITEM_MYSTIC_TICKET,  ITEM_GOLD_BOTTLE_CAP, ITEM_BOTTLE_CAP, ITEM_EXP_CANDY_XL, ITEM_ABILITY_CAPSULE, ITEM_ABILITY_PATCH};
static const u16 sPrizeListRoar[]        = {ITEM_GOLD_BOTTLE_CAP,        ITEM_GOLD_BOTTLE_CAP, ITEM_BOTTLE_CAP, ITEM_EXP_CANDY_XL, ITEM_ABILITY_CAPSULE, ITEM_ABILITY_PATCH};
static const u16 sPrizeListSludgeBomb[]  = {ITEM_GOLD_BOTTLE_CAP, ITEM_GOLD_BOTTLE_CAP, ITEM_BOTTLE_CAP, ITEM_EXP_CANDY_XL, ITEM_ABILITY_CAPSULE, ITEM_ABILITY_PATCH};
static const u16 sPrizeListToxic[]       = {ITEM_GOLD_BOTTLE_CAP,       ITEM_GOLD_BOTTLE_CAP, ITEM_BOTTLE_CAP, ITEM_EXP_CANDY_XL, ITEM_ABILITY_CAPSULE, ITEM_ABILITY_PATCH};
static const u16 sPrizeListSunnyDay[]    = {ITEM_GOLD_BOTTLE_CAP,   ITEM_GOLD_BOTTLE_CAP, ITEM_BOTTLE_CAP, ITEM_EXP_CANDY_XL, ITEM_ABILITY_CAPSULE, ITEM_ABILITY_PATCH};
static const u16 sPrizeListEarthQuake[]  = {ITEM_TM26_EARTHQUAKE,  ITEM_GOLD_BOTTLE_CAP, ITEM_BOTTLE_CAP, ITEM_EXP_CANDY_XL, ITEM_ABILITY_CAPSULE, ITEM_ABILITY_PATCH};

static const u16 sPrizeListRareCandy2[]  = {ITEM_GOLD_BOTTLE_CAP,       ITEM_GOLD_BOTTLE_CAP, ITEM_BOTTLE_CAP, ITEM_EXP_CANDY_XL, ITEM_ABILITY_CAPSULE, ITEM_ABILITY_PATCH};
static const u16 sPrizeListLuxuryBall2[] = {ITEM_GOLD_BOTTLE_CAP,      ITEM_GOLD_BOTTLE_CAP, ITEM_BOTTLE_CAP, ITEM_EXP_CANDY_XL, ITEM_ABILITY_CAPSULE, ITEM_ABILITY_PATCH};
static const u16 sPrizeListMaxRevive2[]  = {ITEM_GOLD_BOTTLE_CAP,       ITEM_GOLD_BOTTLE_CAP, ITEM_BOTTLE_CAP, ITEM_EXP_CANDY_XL, ITEM_ABILITY_CAPSULE, ITEM_ABILITY_PATCH};
static const u16 sPrizeListMaxEther2[]   = {ITEM_GOLD_BOTTLE_CAP,        ITEM_GOLD_BOTTLE_CAP, ITEM_BOTTLE_CAP, ITEM_EXP_CANDY_XL, ITEM_ABILITY_CAPSULE, ITEM_ABILITY_PATCH};
static const u16 sPrizeListElixir2[]     = {ITEM_GOLD_BOTTLE_CAP,           ITEM_GOLD_BOTTLE_CAP, ITEM_BOTTLE_CAP, ITEM_EXP_CANDY_XL, ITEM_ABILITY_CAPSULE, ITEM_ABILITY_PATCH};
static const u16 sPrizeListBrickBreak[]  = {ITEM_MASTER_BALL, ITEM_GOLD_BOTTLE_CAP, ITEM_BOTTLE_CAP, ITEM_EXP_CANDY_XL, ITEM_ABILITY_CAPSULE, ITEM_ABILITY_PATCH};
static const u16 sPrizeListTorment[]     = {ITEM_GOLD_BOTTLE_CAP,     ITEM_GOLD_BOTTLE_CAP, ITEM_BOTTLE_CAP, ITEM_EXP_CANDY_XL, ITEM_ABILITY_CAPSULE, ITEM_ABILITY_PATCH};
static const u16 sPrizeListSkillSwap[]   = {ITEM_GOLD_BOTTLE_CAP,  ITEM_GOLD_BOTTLE_CAP, ITEM_BOTTLE_CAP, ITEM_EXP_CANDY_XL, ITEM_ABILITY_CAPSULE, ITEM_ABILITY_PATCH};
static const u16 sPrizeListGigaDrain[]   = {ITEM_EON_TICKET,  ITEM_GOLD_BOTTLE_CAP, ITEM_BOTTLE_CAP, ITEM_EXP_CANDY_XL, ITEM_ABILITY_CAPSULE, ITEM_ABILITY_PATCH};
static const u16 sPrizeListAttract[]     = {ITEM_GOLD_BOTTLE_CAP,     ITEM_GOLD_BOTTLE_CAP, ITEM_BOTTLE_CAP, ITEM_EXP_CANDY_XL, ITEM_ABILITY_CAPSULE, ITEM_ABILITY_PATCH};
...
static u16 GetPrizeItemId(void)
{
    ...
    if (minutes < 12)
        ...
        id = 1; // ITEM_GOLD_BOTTLE_CAP
    else if (minutes < 14)
        id = 2; // ITEM_BOTTLE_CAP
    else if (minutes < 16)
        id = 3; // ITEM_EXP_CANDY_XL
    else if (minutes < 18)
        id = 4; // ITEM_ABILITY_CAPSULE
    else
        id = 5; // ITEM_ABILITY_PATCH
