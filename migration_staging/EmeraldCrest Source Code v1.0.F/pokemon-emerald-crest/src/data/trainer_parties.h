...
static const struct TrainerMonItemCustomMoves sParty_Roxanne1[] = {
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_STEALTH_ROCK, MOVE_WOOD_HAMMER, MOVE_COPYCAT, MOVE_TOXIC}
    },
    {
    .iv = 250,
    .lvl = 16,
    ...
    .moves = {MOVE_ROCK_TOMB, MOVE_METAL_CLAW, MOVE_ROCK_SMASH, MOVE_VISE_GRIP}
    },
    {
    .iv = 250,
    .lvl = 15,
    ...
    .heldItem = ITEM_LEFTOVERS,
    .moves = {MOVE_POWER_GEM, MOVE_ROCK_SLIDE, MOVE_THUNDER_WAVE, MOVE_BLOCK}
    },
    {
    .iv = 100,
    .lvl = 15,
    ...
    .moves = {MOVE_STEALTH_ROCK, MOVE_EARTHQUAKE, MOVE_ROCK_BLAST, MOVE_ENDURE}
    },
    {
    .iv = 200,
    .lvl = 16,
    ...
    .moves = {MOVE_THUNDER_FANG, MOVE_WING_ATTACK, MOVE_SUPERSONIC, MOVE_SCARY_FACE}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Brawly1[] = {
    ...
    .species = SPECIES_FLAMIGO,
    .heldItem = ITEM_LEFTOVERS,
    .moves = {MOVE_DOUBLE_KICK, MOVE_WING_ATTACK, MOVE_LOW_KICK, MOVE_COPYCAT}
    },
    {
    .iv = 250,
    .lvl = 19,
    ...
    .moves = {MOVE_DIG, MOVE_WILD_CHARGE, MOVE_QUICK_ATTACK, MOVE_REVIVAL_BLESSING}
    },
    {
    .iv = 200,
    .lvl = 20,
    ...
    .moves = {MOVE_WORK_UP, MOVE_FORCE_PALM, MOVE_COUNTER, MOVE_LIFE_DEW}
    },
    {
    .iv = 250,
    .lvl = 20,
    ...
    .heldItem = ITEM_EVIOLITE,
    .moves = {MOVE_DRAIN_PUNCH, MOVE_SLUDGE_BOMB, MOVE_KNOCK_OFF, MOVE_BULK_UP}
    },
    {
    .iv = 100,
    .lvl = 18,
    ...
    .heldItem = ITEM_ASSAULT_VEST,
    .moves = {MOVE_DRAIN_PUNCH, MOVE_THUNDER_PUNCH, MOVE_MACH_PUNCH, MOVE_RAPID_SPIN}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Wattson1[] = {
    ...
    .species = SPECIES_AMPHAROS,
    .heldItem = ITEM_LEFTOVERS,
    .moves = {MOVE_VOLT_SWITCH, MOVE_THUNDERBOLT, MOVE_DRAGON_PULSE, MOVE_FOCUS_BLAST}
    },
    {
    .iv = 250,
    .lvl = 25,
    .species = SPECIES_BELLIBOLT,
    .heldItem = ITEM_LEFTOVERS,
    .moves = {MOVE_MUD_SHOT, MOVE_WATER_GUN, MOVE_SPARK, MOVE_SLACK_OFF}
    },
    {
    .iv = 250,
    .lvl = 26,
    ...
    .moves = {MOVE_FLAMETHROWER, MOVE_THUNDERBOLT, MOVE_ICE_FANG, MOVE_CRUNCH}
    },
    {
    .iv = 220,
    .lvl = 25,
    ...
    .heldItem = ITEM_LEFTOVERS,
    .moves = {MOVE_THUNDER_WAVE, MOVE_THUNDERBOLT, MOVE_HIDDEN_POWER, MOVE_CRUNCH}
    },
    {
    .iv = 240,
    .lvl = 23,
    ...
    .heldItem = ITEM_LEFTOVERS,
    .moves = {MOVE_HYPER_VOICE, MOVE_THUNDERBOLT, MOVE_TOXIC, MOVE_SHADOW_BALL}
    },
    {
    .iv = 220,
    .lvl = 26,
    ...
    .moves = {MOVE_FAKE_OUT, MOVE_EXTREME_SPEED, MOVE_KNOCK_OFF, MOVE_PLAY_ROUGH}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Flannery1[] = {
    ...
    .heldItem = ITEM_FOCUS_SASH,
    .moves = {MOVE_PSYSHOCK, MOVE_LAVA_PLUME, MOVE_MYSTICAL_FIRE, MOVE_NIGHT_SHADE}
    },
    {
    .iv = 250,
    .lvl = 35,
    ...
    .species = SPECIES_CAMERUPT,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_FLAMETHROWER, MOVE_EARTH_POWER, MOVE_STEALTH_ROCK, MOVE_HIDDEN_POWER}
    },
    {
    .iv = 250,
    .lvl = 36,
    ...
    .moves = {MOVE_FLAMETHROWER, MOVE_RAZOR_LEAF, MOVE_ZEN_HEADBUTT, MOVE_BITE}
    },
    {
    .iv = 250,
    .lvl = 35,
    ...
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_DOUBLE_EDGE, MOVE_FLAMETHROWER, MOVE_HEX, MOVE_THUNDER_PUNCH}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Norman1[] = {
    ...
    .heldItem = ITEM_LEFTOVERS,
    .moves = {MOVE_BODY_SLAM, MOVE_REST, MOVE_SLEEP_TALK, MOVE_EARTHQUAKE}
    },
    {
    .iv = 250,
    .lvl = 36,
    ...
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_HYPER_DRILL, MOVE_DRILL_RUN, MOVE_GLARE, MOVE_ROOST}
    },
    {
    .iv = 200,
    .lvl = 37,
    ...
    .heldItem = ITEM_EVIOLITE,
    .moves = {MOVE_TOXIC, MOVE_TELEPORT, MOVE_ICE_BEAM, MOVE_RECOVER}
    },
    {
    .iv = 250,
    .lvl = 38,
    .species = SPECIES_KANGASKHAN,
    .heldItem = ITEM_KANGASKHANITE,
    .moves = {MOVE_FAKE_OUT, MOVE_SUCKER_PUNCH, MOVE_EARTHQUAKE, MOVE_FAKE_OUT}
    },
    {
    .iv = 250,
    .lvl = 38,
    ...
    .heldItem = ITEM_LIFE_ORB,
    .moves = {MOVE_RETURN, MOVE_EARTHQUAKE, MOVE_SUCKER_PUNCH, MOVE_FIRE_BLAST}
    }    
};
...
static const struct TrainerMonItemCustomMoves sParty_Winona1[] = {
    ...
    .heldItem = ITEM_LEFTOVERS,
    .moves = {MOVE_IRON_DEFENSE, MOVE_BODY_PRESS, MOVE_ROOST, MOVE_U_TURN}
    },
    {
    .iv = 252,
    .lvl = 44,
    ...
    .moves = {MOVE_EARTHQUAKE, MOVE_FIRE_BLAST, MOVE_DRAGON_DANCE, MOVE_RETURN}
    },
    {
    .iv = 255,
    .lvl = 45,
    ...
    .moves = {MOVE_MEGA_KICK, MOVE_AIR_SLASH, MOVE_ROOST, MOVE_COPYCAT}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_TateAndLiza1[] = {
    ...
    .moves = {MOVE_PROTECT, MOVE_IRON_HEAD, MOVE_STOMPING_TANTRUM, MOVE_BULLET_PUNCH}
    },
    {
    .iv = 250,
    .lvl = 55,
    ...
    .heldItem = ITEM_ASSAULT_VEST,
    .moves = {MOVE_PSYCHIC, MOVE_MOONBLAST, MOVE_PETAL_BLIZZARD, MOVE_PETAL_DANCE}
    },
    {
    .iv = 250,
    .lvl = 56,
    ...
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_HYPER_VOICE, MOVE_PSYSHOCK, MOVE_FOCUS_BLAST, MOVE_TAUNT}
    },
    {
    .iv = 250,
    .lvl = 56,
    ...
    .moves = {MOVE_FOCUS_BLAST, MOVE_NASTY_PLOT, MOVE_DAZZLING_GLEAM, MOVE_EXPANDING_FORCE}
    },
    {
    .iv = 250,
    .lvl = 55,
    .species = SPECIES_ESPEON,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_PSYCHIC, MOVE_TRICK, MOVE_DAZZLING_GLEAM, MOVE_SHADOW_BALL}
    },
    {
    .iv = 250,
    .lvl = 55,
    .species = SPECIES_ESPATHRA,
    .heldItem = ITEM_LIFE_ORB,
    .moves = {MOVE_LAST_RESORT, MOVE_PSYCHIC, MOVE_DAZZLING_GLEAM, MOVE_SHADOW_BALL}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Juan1[] = {
    ...
    .species = SPECIES_WUGTRIO,
    .heldItem = ITEM_LIFE_ORB,
    .moves = {MOVE_THROAT_CHOP, MOVE_SUCKER_PUNCH, MOVE_STOMPING_TANTRUM, MOVE_TRIPLE_DIVE}
    },
    {
    .iv = 200,
    .lvl = 58,
    ...
    .moves = {MOVE_HYDRO_PUMP, MOVE_AURA_SPHERE, MOVE_DRAGON_PULSE, MOVE_DARK_PULSE}
    },
    {
    .iv = 250,
    .lvl = 61,
    ...
    .moves = {MOVE_WATERFALL, MOVE_BOUNCE, MOVE_DRAGON_DANCE, MOVE_EARTHQUAKE}        
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_BrendanRustboroTreecko[] = {
    ...
    .species = SPECIES_GOOMY,
    .heldItem = ITEM_DRAGONIUM_Z,
    .moves = {MOVE_BIDE, MOVE_PROTECT, MOVE_ABSORB, MOVE_DRAGON_BREATH}
    }
};
...
static const struct TrainerMonItemCustomMoves sHardParty_Roxanne1[] = {
    ...
    .species = SPECIES_SUDOWOODO,
    .heldItem = ITEM_LEFTOVERS,
    .moves = {MOVE_STEALTH_ROCK, MOVE_WOOD_HAMMER, MOVE_STONE_EDGE, MOVE_TOXIC}
    },
    {
    .iv = 250,
    .lvl = 16,
    ...
    .species = SPECIES_AERODACTYL,
    .heldItem = ITEM_AERODACTYLITE,
    .moves = {MOVE_THUNDER_FANG, MOVE_WING_ATTACK, MOVE_ICE_FANG, MOVE_SCARY_FACE}
    },
    {
    .iv = 255,
    .lvl = 15,
...
static const struct TrainerMonItemCustomMoves sHardParty_Brawly1[] = {
    ...
    .species = SPECIES_PANCHAM,
    .heldItem = ITEM_EVIOLITE,
    .moves = {MOVE_PARTING_SHOT, MOVE_DRAIN_PUNCH, MOVE_KNOCK_OFF, MOVE_ZEN_HEADBUTT}
    },
    {
    .iv = 255,
    .lvl = 19,
