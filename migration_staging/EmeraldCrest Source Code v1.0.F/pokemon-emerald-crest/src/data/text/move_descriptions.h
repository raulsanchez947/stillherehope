...
#if CONFIG_DECAPITALIZE_MOVE_DESCRIPTION_STRINGS == TRUE
...
static const u8 sMoveFourLineDescription_Pluck[] = _("The user pecks the\nfoe. If the foe has\na Berry, the user\ngains its effect.");
...
static const u8 sMoveFourLineDireClawDescription[] = _("High critical hit\nchance. May\nparalyze, poison or\ndrowse.");
static const u8 sMoveFourLinePsyshieldBashDescription[] = _("Hits a foe\nwith psychic energy.\nMay raise Defense.");
static const u8 sMoveFourLinePowerShiftDescription[] = _("The user swaps\nits Attack and\nDefense stats.");
static const u8 sMoveFourLineStoneAxeDescription[] = _("High critical hit\nratio. Sets\nSplinters that\nhurt the foe.");
static const u8 sMoveFourLineSpringtideStormDescription[] = _("Wraps a foe in\nfierce winds.\nVaries with the\nuser's form.");
static const u8 sMoveFourLineMysticalPowerDescription[] = _("A mysterious power\nstrikes, raising\nthe user's\nSp. Atk.");
static const u8 sMoveFourLineRagingFuryDescription[] = _("A rampage of 2 to\n3 turns that\nconfuses the user.");
static const u8 sMoveFourLineWaveCrashDescription[] = _("A slam shrouded\nin water. It also\nhurts the user.");
static const u8 sMoveFourLineChloroblastDescription[] = _("A user-hurting blast of\namassed chlorophyll.");
static const u8 sMoveFourLineMountainGaleDescription[] = _("Giant chunks of ice damage\nthe foe. It may flinch.");
static const u8 sMoveFourLineVictoryDanceDescription[] = _("Dances to raise Attack,\nDefense and Speed.");
static const u8 sMoveFourLineHeadlongRushDescription[] = _("Hits with a full-body tackle.\nLowers the users's defenses.");
static const u8 sMoveFourLineBarbBarrageDescription[] = _("Can poison on impact. Powers\nup against poisoned foes.");
static const u8 sMoveFourLineEsperWingDescription[] = _("High critical hit ratio.\nUps the user's Speed.");
static const u8 sMoveFourLineBitterMaliceDescription[] = _("A spine-chilling\nresentment. May\nlower the foe's\nAttack.");
static const u8 sMoveFourLineShelterDescription[] = _("The user hardens their skin,\nsharply raising its Defense.");
static const u8 sMoveFourLineTripleArrowsDescription[] = _("High critical hit ratio.\nMay lower Defense or flinch.");
static const u8 sMoveFourLineInfernalParadeDescription[] = _("Hurts a foe harder if it has\nan ailment. May leave a burn.");
static const u8 sMoveFourLineCeaselessEdgeDescription[] = _("High critical hit ratio. Sets\nSplinters that hurt the foe.");
static const u8 sMoveFourLineBleakwindStormDescription[] = _("Hits with brutal, cold winds.\nMay lower the foe's Speed.");
static const u8 sMoveFourLineWildboltStormDescription[] = _("Hits with a brutal tempest.\nMay inflict paralysis.");
static const u8 sMoveFourLineSandsearStormDescription[] = _("Hits with brutally hot sand.\nMay inflict a burn.");


static const u8 sMoveFourLineLunarBlessingDescription[] = _(
    "The user heals and cures\nitself and its ally.");

static const u8 sMoveFourLineTakeHeartDescription[] = _(
    "The user lifts\nits spirits to\nheal and strengthen\nitself.");

// static const u8 sMoveFourLineTeraBlastDescription[] = _(
//     "If the user's Terastallized,\nit hits with its Tera-type.");

static const u8 sMoveFourLineSilkTrapDescription[] =_(
    "Protects itself,\nlowering Speed\non contact.");

static const u8 sMoveFourLineAxeKickDescription[] = _(
    "May miss and hurt the kicker.\nMay cause confusion.");

static const u8 sMoveFourLineLastRespectsDescription[] = _(
    "This move deals more damage\nfor each defeated ally.");

static const u8 sMoveFourLineLuminaCrashDescription[] = _(
    "A mind-affecting\nlight harshly\nlowers Sp. Def.");

static const u8 sMoveFourLineOrderUpDescription[] = _(
    "Boosts a user's stats\ndepending on Tatsugiri.");

static const u8 sMoveFourLineJetPunchDescription[] = _(
    "A punch is thrown\nat blinding speed\nto strike first.");

static const u8 sMoveFourLineSpicyExtractDescription[] = _(
    "Sharply ups target's Attack,\nharshly lowers its Defense.");

static const u8 sMoveFourLineSpinOutDescription[] = _(
    "Furiously strains its legs.\nHarshly lowers user's Speed.");

static const u8 sMoveFourLinePopulationBombDescription[] = _(
    "The user's fellows hit one\nto ten times in a row.");

static const u8 sMoveFourLineIceSpinnerDescription[] = _(
    "Ice-covered feet\nhits a foe and\ndestroy the terrain.");

static const u8 sMoveFourLineGlaiveRushDescription[] = _(
    "Foe attacks next turn can't\nmiss and do double damage.");

static const u8 sMoveFourLineRevivalBlessingDescription[] = _(
    "Revives a fainted\nparty {PKMN} and\nrestores half of\nits HP.");

static const u8 sMoveFourLineSaltCureDescription[] = _(
    "Hurts foe every turn. Double\ndamage to Steel and Water.");

static const u8 sMoveFourLineTripleDiveDescription[] = _(
    "Hits target with\nsplashes of water\n3 times in a row.");

static const u8 sMoveFourLineMortalSpinDescription[] = _(
    "Erases trap moves and Leech\nSeed. Poisons adjecent foes.");

static const u8 sMoveFourLineDoodleDescription[] = _(
    "Changes user's and ally's\nAbility into the target's.");

static const u8 sMoveFourLineFilletAwayDescription[] = _(
    "Sharply boosts offenses and\nSpeed by using its own HP.");

static const u8 sMoveFourLineKowtowCleaveDescription[] = _(
    "User slashes\nthe foe after\nkowtowing. It never\nmisses.");

static const u8 sMoveFourLineFlowerTrickDescription[] = _(
    "Rigged bouquet.\nAlways gets a\ncritical hit,\nnever missing.");

static const u8 sMoveFourLineTorchSongDescription[] = _(
    "Flames scorch\nthe target.\nBoosts the user's\nSp. Atk.");

static const u8 sMoveFourLineAquaStepDescription[] = _(
    "Hits with light,\nfluid dance steps.\nUps the user's\nSpeed.");

static const u8 sMoveFourLineRagingBullDescription[] = _(
    "Tackle that\nbreaks barriers.\nUser's form\ndetermines type.");

static const u8 sMoveFourLineMakeItRainDescription[] = _(
    "Lowers the user's\nSp. Atk.\nMoney is recovered\nafter.");

static const u8 sMoveFourLineRuinationDescription[] = _(
    "Summons a ruinous\ndisaster and cuts\nhalf the foe's\nHP.");

static const u8 sMoveFourLineCollisionCourseDescription[] = _(
    "Prehistoric explosion\nthat's stronger\nif supereffective.");

static const u8 sMoveFourLineElectroDriftDescription[] = _(
    "Futuristic electricity.\nIt's stronger\nif supereffective.");

static const u8 sMoveFourLineShedTailDescription[] = _(
    "Creates a Substitute\nfor itself\nbefore switching\nout.");

static const u8 sMoveFourLineChillyReceptionDescription[] =_(
    "Bad joke summons snowstorm.\nThe user also switches out.");

static const u8 sMoveFourLineTidyUpDescription[] = _(
    "User tidies up hazards and\nraises its Attack and Speed.");

static const u8 sMoveFourLineSnowscapeDescription[] = _(
    "Summons a snowstorm\nthat lasts for five\nturns.");

static const u8 sMoveFourLinePounceDescription[] = _(
    "The user pounces\non the foe, lowering\nits Speed.");

static const u8 sMoveFourLineTrailblazeDescription[] = _(
    "The user attacks\nsuddenly, raising\nits Speed.");

static const u8 sMoveFourLineChillingWaterDescription[] = _(
    "A shower with\nice-cold water\nlowers the target's\nAttack.");

static const u8 sMoveFourLineHyperDrillDescription[] = _(
    "A spinning\npointed part\nbypasses a foe's\nProtect.");

static const u8 sMoveFourLineTwinBeamDescription[] = _(
    "Mystical eye-beams\nthat hit the target\ntwice in a row.");

static const u8 sMoveFourLineRageFistDescription[] = _(
    "The more the\nuser has been\nhit, the stronger\nthe move.");

static const u8 sMoveFourLineArmorCannonDescription[] = _(
    "A strong attack\nbut lowers the\ndefensive stats.");

static const u8 sMoveFourLineBitterBladeDescription[] = _(
    "An attack that\nabsorbs half the\ndamage inflicted.");

static const u8 sMoveFourLineDoubleShockDescription[] = _(
    "Discharges all\nelectricity, losing the\nElectric type.");

static const u8 sMoveFourLineGigatonHammerDescription[] = _(
    "Swings a\nhuge hammer. Can't\nbe used twice\nin a row.");

static const u8 sMoveFourLineComeuppanceDescription[] = _(
    "Retaliates strongly\nagainst who last\nhurt the user.");

static const u8 sMoveFourLineAquaCutterDescription[] = _(
    "Pressurized water\ncut with a high\ncritical-hit ratio.");

static const u8 sMoveFourLineBlazingTorqueDescription[] = _(
    "---");

static const u8 sMoveFourLineWickedTorqueDescription[] = _(
    "---");

static const u8 sMoveFourLineNoxiousTorqueDescription[] = _(
    "---");

static const u8 sMoveFourLineCombatTorqueDescription[] = _(
    "---");

static const u8 sMoveFourLineMagicalTorqueDescription[] = _(
    "---");

static const u8 sMoveFourLinePsybladeDescription[] = _(
    "This move's power\nincreases when on\nElectric Terrain.");

static const u8 sMoveFourLineHydroSteamDescription[] = _(
    "This move's power\nincreases under harsh\nsunlight.");

static const u8 sMoveFourLineBloodMoonDescription[] = _(
    "Unleashes the blood moon.\nCan't be used\ntwice in a row.");

static const u8 sMoveFourLineMatchaGotchaDescription[] = _(
    "Absorbs half the\ndamage inflicted.\nMay cause a burn.");

static const u8 sMoveFourLineSyrupBombDescription[] = _(
    "Lowers the foe's\nspeed each turn\nfor 3 turns.");

static const u8 sMoveFourLineIvyCudgelDescription[] = _(
    "Type changes\nwith held mask.\nHigh critical-hit\nratio.");
#endif
...
const u8 *const gMoveFourLineDescriptionPointers[MOVES_COUNT - 1] = {
    ...
    [MOVE_DIRE_CLAW         - 1] = sMoveFourLineDireClawDescription,
    [MOVE_PSYSHIELD_BASH    - 1] = sMoveFourLinePsyshieldBashDescription,
    [MOVE_POWER_SHIFT       - 1] = sMoveFourLinePowerShiftDescription,
    [MOVE_STONE_AXE         - 1] = sMoveFourLineStoneAxeDescription,
    [MOVE_SPRINGTIDE_STORM  - 1] = sMoveFourLineSpringtideStormDescription,
    [MOVE_MYSTICAL_POWER    - 1] = sMoveFourLineMysticalPowerDescription,
    [MOVE_RAGING_FURY       - 1] = sMoveFourLineRagingFuryDescription,
    [MOVE_WAVE_CRASH        - 1] = sMoveFourLineWaveCrashDescription,
    [MOVE_CHLOROBLAST       - 1] = sMoveFourLineChloroblastDescription,
    [MOVE_MOUNTAIN_GALE     - 1] = sMoveFourLineMountainGaleDescription,
    [MOVE_VICTORY_DANCE     - 1] = sMoveFourLineVictoryDanceDescription,
    [MOVE_HEADLONG_RUSH     - 1] = sMoveFourLineHeadlongRushDescription,
    [MOVE_BARB_BARRAGE      - 1] = sMoveFourLineBarbBarrageDescription,
    [MOVE_ESPER_WING        - 1] = sMoveFourLineEsperWingDescription,
    [MOVE_BITTER_MALICE     - 1] = sMoveFourLineBitterMaliceDescription,
    [MOVE_SHELTER           - 1] = sMoveFourLineShelterDescription,
    [MOVE_TRIPLE_ARROWS     - 1] = sMoveFourLineTripleArrowsDescription,
    [MOVE_INFERNAL_PARADE   - 1] = sMoveFourLineInfernalParadeDescription,
    [MOVE_CEASELESS_EDGE    - 1] = sMoveFourLineCeaselessEdgeDescription,
    [MOVE_BLEAKWIND_STORM   - 1] = sMoveFourLineBleakwindStormDescription,
    [MOVE_WILDBOLT_STORM    - 1] = sMoveFourLineWildboltStormDescription,
    [MOVE_SANDSEAR_STORM    - 1] = sMoveFourLineSandsearStormDescription,
    // [MOVE_LUNAR_BLESSING    - 1] = sMoveFourLineLunarBlessingDescription,
    [MOVE_TAKE_HEART        - 1] = sMoveFourLineTakeHeartDescription,
    // [MOVE_TERA_BLAST        - 1] = sMoveFourLineTeraBlastDescription,
    [MOVE_SILK_TRAP         - 1] = sMoveFourLineSilkTrapDescription,
    [MOVE_AXE_KICK          - 1] = sMoveFourLineAxeKickDescription,
    // [MOVE_LAST_RESPECTS     - 1] = sMoveFourLineLastRespectsDescription,
    [MOVE_LUMINA_CRASH      - 1] = sMoveFourLineLuminaCrashDescription,
    // [MOVE_ORDER_UP          - 1] = sMoveFourLineOrderUpDescription,
    [MOVE_JET_PUNCH         - 1] = sMoveFourLineJetPunchDescription,
    // [MOVE_SPICY_EXTRACT     - 1] = sMoveFourLineSpicyExtractDescription,
    [MOVE_SPIN_OUT          - 1] = sMoveFourLineSpinOutDescription,
    // [MOVE_POPULATION_BOMB   - 1] = sMoveFourLinePopulationBombDescription,
    [MOVE_ICE_SPINNER       - 1] = sMoveFourLineIceSpinnerDescription,
    // [MOVE_GLAIVE_RUSH       - 1] = sMoveFourLineGlaiveRushDescription,
    [MOVE_REVIVAL_BLESSING  - 1] = sMoveFourLineRevivalBlessingDescription,
    [MOVE_SALT_CURE         - 1] = sMoveFourLineSaltCureDescription,
    [MOVE_TRIPLE_DIVE       - 1] = sMoveFourLineTripleDiveDescription,
    // [MOVE_MORTAL_SPIN       - 1] = sMoveFourLineMortalSpinDescription,
    // [MOVE_DOODLE            - 1] = sMoveFourLineDoodleDescription,
    // [MOVE_FILLET_AWAY       - 1] = sMoveFourLineFilletAwayDescription,
    [MOVE_KOWTOW_CLEAVE     - 1] = sMoveFourLineKowtowCleaveDescription,
    [MOVE_FLOWER_TRICK      - 1] = sMoveFourLineFlowerTrickDescription,
    [MOVE_TORCH_SONG        - 1] = sMoveFourLineTorchSongDescription,
    [MOVE_AQUA_STEP         - 1] = sMoveFourLineAquaStepDescription,
    // [MOVE_RAGING_BULL       - 1] = sMoveFourLineRagingBullDescription,
    [MOVE_MAKE_IT_RAIN      - 1] = sMoveFourLineMakeItRainDescription,
    [MOVE_RUINATION         - 1] = sMoveFourLineRuinationDescription,
    [MOVE_COLLISION_COURSE  - 1] = sMoveFourLineCollisionCourseDescription,
    // [MOVE_ELECTRO_DRIFT     - 1] = sMoveFourLineElectroDriftDescription,
    // [MOVE_SHED_TAIL         - 1] = sMoveFourLineShedTailDescription,
    // [MOVE_CHILLY_RECEPTION  - 1] = sMoveFourLineChillyReceptionDescription,
    // [MOVE_TIDY_UP           - 1] = sMoveFourLineTidyUpDescription,
    [MOVE_SNOWSCAPE         - 1] = sMoveFourLineSnowscapeDescription,
    [MOVE_POUNCE            - 1] = sMoveFourLinePounceDescription,
    [MOVE_TRAILBLAZE        - 1] = sMoveFourLineTrailblazeDescription,
    [MOVE_CHILLING_WATER    - 1] = sMoveFourLineChillingWaterDescription,
    [MOVE_HYPER_DRILL       - 1] = sMoveFourLineHyperDrillDescription,
    [MOVE_TWIN_BEAM         - 1] = sMoveFourLineTwinBeamDescription,
    // [MOVE_RAGE_FIST         - 1] = sMoveFourLineRageFistDescription,
    [MOVE_ARMOR_CANNON      - 1] = sMoveFourLineArmorCannonDescription,
    [MOVE_BITTER_BLADE      - 1] = sMoveFourLineBitterBladeDescription,
    [MOVE_DOUBLE_SHOCK      - 1] = sMoveFourLineDoubleShockDescription,
    [MOVE_GIGATON_HAMMER    - 1] = sMoveFourLineGigatonHammerDescription,
    [MOVE_COMEUPPANCE       - 1] = sMoveFourLineComeuppanceDescription,
    [MOVE_AQUA_CUTTER       - 1] = sMoveFourLineAquaCutterDescription,
    [MOVE_BLAZING_TORQUE    - 1] = sMoveFourLineBlazingTorqueDescription,
    [MOVE_WICKED_TORQUE     - 1] = sMoveFourLineWickedTorqueDescription,
    [MOVE_NOXIOUS_TORQUE    - 1] = sMoveFourLineNoxiousTorqueDescription,
    [MOVE_COMBAT_TORQUE     - 1] = sMoveFourLineCombatTorqueDescription,
    [MOVE_MAGICAL_TORQUE    - 1] = sMoveFourLineMagicalTorqueDescription,
    [MOVE_PSYBLADE          - 1] = sMoveFourLinePsybladeDescription,
    [MOVE_HYDRO_STEAM       - 1] = sMoveFourLineHydroSteamDescription,
    [MOVE_BLOOD_MOON - 1] = sMoveFourLineBloodMoonDescription,
    [MOVE_MATCHA_GOTCHA - 1] = sMoveFourLineMatchaGotchaDescription,
    [MOVE_SYRUP_BOMB - 1] = sMoveFourLineSyrupBombDescription,
    [MOVE_IVY_CUDGEL - 1] = sMoveFourLineIvyCudgelDescription,
};
