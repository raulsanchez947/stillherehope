...
bool8 UpdateSave_v2_v6(const struct SaveSectorLocation *locations)
{
    const struct SaveBlock2_v2* sOldSaveBlock2Ptr = (struct SaveBlock2_v2*)(locations[0].data); // SECTOR_ID_SAVEBLOCK2
