const struct Evolution gEvolutionTable[NUM_SPECIES][EVOS_PER_MON] =
{
    ...
    [SPECIES_PIKACHU]               = {{EVO_ITEM, ITEM_THUNDER_STONE, SPECIES_RAICHU},
                                       {EVO_MAPSEC, MAPSEC_NEW_MAUVILLE, SPECIES_RAICHU_ALOLAN},
                                       {EVO_SEASONAL, SEASON_SUMMER, SPECIES_RAICHU_ALOLAN}},
    ...
    [SPECIES_GLOOM]                 = {{EVO_ITEM, ITEM_LEAF_STONE, SPECIES_VILEPLUME},
                                       ...
                                       {EVO_SEASONAL, SEASON_SPRING, SPECIES_BELLOSSOM}},
    ...
    [SPECIES_SUNKERN]               = {{EVO_ITEM, ITEM_SUN_STONE, SPECIES_SUNFLORA},
                                        {EVO_SEASONAL, SEASON_SPRING, SPECIES_SUNFLORA}},
#if P_GEN_4_POKEMON == TRUE
    ...
    [SPECIES_MIME_JR]               = {{EVO_MOVE, MOVE_MIMIC, SPECIES_MR_MIME},
                                       {EVO_LEVEL_NIGHT, 20, SPECIES_MR_MIME_GALARIAN}},
    ...
    [SPECIES_PETILIL]               = {{EVO_ITEM, ITEM_SUN_STONE, SPECIES_LILLIGANT},
                                       {EVO_SPECIFIC_MAP, MAP_ROUTE120, SPECIES_LILLIGANT_HISUIAN},
                                       {EVO_SEASONAL, SEASON_SPRING, SPECIES_LILLIGANT_HISUIAN}},
    ...
    [SPECIES_DEERLING]              = {{EVO_LEVEL, 34, SPECIES_SAWSBUCK},
                                        {EVO_SEASONAL, SEASON_SPRING, SPECIES_SAWSBUCK}},
    ...
    [SPECIES_RUFFLET]               = {{EVO_LEVEL, 54, SPECIES_BRAVIARY},
                                       {EVO_SPECIFIC_MAP, MAP_MT_PYRE_SUMMIT, SPECIES_BRAVIARY_HISUIAN}},
    ...
    [SPECIES_PHANTUMP]              = {{EVO_TRADE, 0, SPECIES_TREVENANT},
                                       ...
                                       {EVO_SEASONAL, SEASON_FALL, SPECIES_TREVENANT}},
    [SPECIES_PUMPKABOO]             = {{EVO_TRADE, 0, SPECIES_GOURGEIST},
                                       {EVO_ITEM, ITEM_LINKING_CORD, SPECIES_GOURGEIST},
                                       {EVO_SEASONAL, SEASON_FALL, SPECIES_GOURGEIST}},
    [SPECIES_BERGMITE]              = {{EVO_LEVEL, 37, SPECIES_AVALUGG},
                                       {EVO_SPECIFIC_MAP, MAP_SHOAL_CAVE_LOW_TIDE_ICE_ROOM, SPECIES_AVALUGG_HISUIAN},
                                       {EVO_SEASONAL, SEASON_WINTER, SPECIES_AVALUGG_HISUIAN}},
    ...
    [SPECIES_CRABRAWLER]            = {{EVO_SPECIFIC_MAP, MAP_SHOAL_CAVE_LOW_TIDE_ICE_ROOM, SPECIES_CRABOMINABLE},
                                       {EVO_ITEM, ITEM_ICE_STONE, SPECIES_CRABOMINABLE},
                                        {EVO_SEASONAL, SEASON_WINTER, SPECIES_CRABOMINABLE}},
    ...
    [SPECIES_DIPPLIN]               =  {{EVO_LEVEL, 48, SPECIES_HYDRAPPLE}},
    ...
    [SPECIES_PAWMO]                 = {{EVO_LEVEL, 28, SPECIES_PAWMOT}},
    [SPECIES_TANDEMAUS]             = {{EVO_LEVEL, 25, SPECIES_MAUSHOLD},
                                       {EVO_LEVEL, 25, SPECIES_MAUSHOLD_FAMILY_OF_THREE}},
    ...
    [SPECIES_CETODDLE]              = {{EVO_ITEM, ITEM_ICE_STONE, SPECIES_CETITAN},
                                        {EVO_SEASONAL, SEASON_WINTER, SPECIES_CETITAN}},
    [SPECIES_FRIGIBAX]              = {{EVO_LEVEL, 35, SPECIES_ARCTIBAX}},
    [SPECIES_ARCTIBAX]              = {{EVO_LEVEL, 54, SPECIES_BAXCALIBUR}},
    [SPECIES_GIMMIGHOUL]            = {{EVO_LEVEL, 42, SPECIES_GHOLDENGO}},
    [SPECIES_GIMMIGHOUL_ROAMING]    = {{EVO_LEVEL, 42, SPECIES_GHOLDENGO}},
    ...
    [SPECIES_SANDSHREW_ALOLAN]      = {{EVO_ITEM, ITEM_ICE_STONE, SPECIES_SANDSLASH_ALOLAN},
                                        {EVO_SEASONAL, SEASON_WINTER, SPECIES_SANDSLASH_ALOLAN}},
    [SPECIES_VULPIX_ALOLAN]         = {{EVO_ITEM, ITEM_ICE_STONE, SPECIES_NINETALES_ALOLAN},
                                        {EVO_SEASONAL, SEASON_WINTER, SPECIES_NINETALES_ALOLAN}},
    ...
    [SPECIES_DARUMAKA_GALARIAN]     = {{EVO_ITEM, ITEM_ICE_STONE, SPECIES_DARMANITAN_GALARIAN},
                                        {EVO_SEASONAL, SEASON_SPRING, SPECIES_DARMANITAN_GALARIAN}},
    [SPECIES_YAMASK_GALARIAN]       = {{EVO_SCRIPT_TRIGGER_DMG, 49, SPECIES_RUNERIGUS}},
#else
    [SPECIES_ZIGZAGOON_GALARIAN]    = {{EVO_LEVEL, 20, SPECIES_LINOONE_GALARIAN}},
    [SPECIES_DARUMAKA_GALARIAN]     = {{EVO_ITEM, ITEM_ICE_STONE, SPECIES_DARMANITAN_GALARIAN},
                                        {EVO_SEASONAL, SEASON_WINTER, SPECIES_DARMANITAN_GALARIAN}},
#endif
#if P_GEN_4_POKEMON == TRUE
    ...
    [SPECIES_DEERLING_SUMMER]       = {{EVO_LEVEL, 34, SPECIES_SAWSBUCK_SUMMER},
                                        {EVO_SEASONAL, SEASON_SUMMER, SPECIES_SAWSBUCK_SUMMER}},
    [SPECIES_DEERLING_AUTUMN]       = {{EVO_LEVEL, 34, SPECIES_SAWSBUCK_AUTUMN},
                                        {EVO_SEASONAL, SEASON_FALL, SPECIES_SAWSBUCK_AUTUMN}},
    [SPECIES_DEERLING_WINTER]       = {{EVO_LEVEL, 34, SPECIES_SAWSBUCK_WINTER},
                                        {EVO_SEASONAL, SEASON_WINTER, SPECIES_SAWSBUCK_WINTER}},
#endif
#if P_GEN_6_POKEMON == TRUE
    ...
    [SPECIES_STANTLER]              = {{EVO_LEVEL, 30, SPECIES_WYRDEER}},
    [SPECIES_BASCULIN_WHITE_STRIPED] = {{EVO_LEVEL_MALE, 30, SPECIES_BASCULEGION},
                                        {EVO_LEVEL_FEMALE, 30,SPECIES_BASCULEGION_FEMALE }},
...
#endif
    [SPECIES_DURALUDON]             =  {{EVO_ITEM, ITEM_METAL_COAT, SPECIES_ARCHALUDON}},
};
