const struct CompressedSpriteSheet gMonBackPicTable[] =
{
    ...
    SPECIES_SPRITE(POLTCHAGEIST_COUNTERFEIT, gMonBackPic_Poltchageist),
    SPECIES_SPRITE(POLTCHAGEIST_ARTISAN, gMonBackPic_Poltchageist),
    SPECIES_SPRITE(SINISTCHA_UNREMARKABLE, gMonBackPic_Sinistcha),
    SPECIES_SPRITE(SINISTCHA_MASTERPIECE, gMonBackPic_Sinistcha),
    ...
    SPECIES_SPRITE(OGERPON, gMonBackPic_OgerponTeal),
    ...
    // SPECIES_SPRITE(OGERPON_TEAL_TERA, gMonBackPic_OgerponTealTera),
    // SPECIES_SPRITE(OGERPON_WELLSPRING_TERA, gMonBackPic_OgerponWellspringTera),
    // SPECIES_SPRITE(OGERPON_HEARTHFLAME_TERA, gMonBackPic_OgerponHearthflameTera),
    // SPECIES_SPRITE(OGERPON_CORNERSTONE_TERA, gMonBackPic_OgerponCornerstoneTera),
