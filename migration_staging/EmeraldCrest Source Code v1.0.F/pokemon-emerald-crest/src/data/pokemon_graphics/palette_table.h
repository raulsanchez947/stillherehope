const struct CompressedSpritePalette gMonPaletteTable[] =
{
    ...
    SPECIES_PAL(SINISTCHA_MASTERPIECE, gMonPalette_Sinistcha),
    ...
    SPECIES_PAL(OGERPON, gMonPalette_OgerponTeal),
    ...
    // SPECIES_PAL(OGERPON_TEAL_TERA, gMonPalette_OgerponTealTera),
    // SPECIES_PAL(OGERPON_WELLSPRING_TERA, gMonPalette_OgerponWellspringTera),
    // SPECIES_PAL(OGERPON_HEARTHFLAME_TERA, gMonPalette_OgerponHearthflameTera),
    // SPECIES_PAL(OGERPON_CORNERSTONE_TERA, gMonPalette_OgerponCornerstoneTera),
...
const struct CompressedSpritePalette gHisuiMonPaletteTable[] =
{
    SPECIES_PAL(WYRDEER, gMonPalette_followerWyrdeer),
    SPECIES_PAL(KLEAVOR, gMonPalette_followerKleavor),
    SPECIES_PAL(URSALUNA, gMonPalette_followerUrsaluna),
    SPECIES_PAL(BASCULEGION, gMonPalette_followerBasculegion),
    SPECIES_PAL(SNEASLER, gMonPalette_followerSneasler),
    SPECIES_PAL(OVERQWIL, gMonPalette_followerOverqwil),
    SPECIES_PAL(GROWLITHE_HISUIAN, gMonPalette_followerGrowlitheHisuian),
    SPECIES_PAL(ARCANINE_HISUIAN, gMonPalette_followerArcanineHisuian),
    SPECIES_PAL(VOLTORB_HISUIAN, gMonPalette_followerVoltorbHisuian),
    SPECIES_PAL(ELECTRODE_HISUIAN, gMonPalette_followerElectrodeHisuian),
    SPECIES_PAL(TYPHLOSION_HISUIAN, gMonPalette_followerTyphlosionHisuian),
    SPECIES_PAL(QWILFISH_HISUIAN, gMonPalette_followerQwilfishHisuian),
    SPECIES_PAL(SNEASEL_HISUIAN, gMonPalette_followerSneaselHisuian),
    SPECIES_PAL(SAMUROTT_HISUIAN, gMonPalette_followerSamurottHisuian),
    SPECIES_PAL(LILLIGANT_HISUIAN, gMonPalette_followerLilligantHisuian),
    SPECIES_PAL(ZORUA_HISUIAN, gMonPalette_followerZoruaHisuian),
    SPECIES_PAL(ZOROARK_HISUIAN, gMonPalette_followerZoroarkHisuian),
    SPECIES_PAL(BRAVIARY_HISUIAN, gMonPalette_followerBraviaryHisuian),
    SPECIES_PAL(SLIGGOO_HISUIAN, gMonPalette_followerSliggooHisuian),
    SPECIES_PAL(GOODRA_HISUIAN, gMonPalette_followerGoodraHisuian),
    SPECIES_PAL(AVALUGG_HISUIAN, gMonPalette_followerAvaluggHisuian),
    SPECIES_PAL(DECIDUEYE_HISUIAN, gMonPalette_followerDecidueyeHisuian),
    SPECIES_PAL(BASCULIN_WHITE_STRIPED, gMonPalette_followerBasculinWhiteStriped),
    SPECIES_PAL(BASCULEGION_FEMALE, gMonPalette_followerBasculegionFemale),
    SPECIES_PAL(SPRIGATITO, gMonPalette_followersprigatito),
    SPECIES_PAL(FLORAGATO, gMonPalette_followerfloragato),
    SPECIES_PAL(MEOWSCARADA, gMonPalette_followermeowscarada),
    SPECIES_PAL(FUECOCO, gMonPalette_followerfuecoco),
    SPECIES_PAL(CROCALOR, gMonPalette_followercrocalor),
    SPECIES_PAL(SKELEDIRGE, gMonPalette_followerskeledirge),
    SPECIES_PAL(QUAXLY, gMonPalette_followerquaxly),
    SPECIES_PAL(QUAXWELL, gMonPalette_followerquaxwell),
    SPECIES_PAL(QUAQUAVAL, gMonPalette_followerquaquaval),
    SPECIES_PAL(LECHONK, gMonPalette_followerlechonk),
    SPECIES_PAL(OINKOLOGNE, gMonPalette_followeroinkologne),
    SPECIES_PAL(TAROUNTULA, gMonPalette_followertarountula),
    SPECIES_PAL(SPIDOPS, gMonPalette_followerspidops),
    SPECIES_PAL(NYMBLE, gMonPalette_followernymble),
    SPECIES_PAL(LOKIX, gMonPalette_followerlokix),
    SPECIES_PAL(PAWMI, gMonPalette_followerpawmi),
    SPECIES_PAL(PAWMO, gMonPalette_followerpawmo),
    SPECIES_PAL(PAWMOT, gMonPalette_followerpawmot),
    SPECIES_PAL(TANDEMAUS, gMonPalette_followertandemaus),
    SPECIES_PAL(MAUSHOLD, gMonPalette_followermaushold),
    SPECIES_PAL(MAUSHOLD_FAMILY_OF_THREE, gMonPalette_followermaushold_family),
    SPECIES_PAL(FIDOUGH, gMonPalette_followerfidough),
    SPECIES_PAL(DACHSBUN, gMonPalette_followerdachsbun),
    SPECIES_PAL(SMOLIV, gMonPalette_followersmoliv),
    SPECIES_PAL(DOLLIV, gMonPalette_followerdolliv),
    SPECIES_PAL(ARBOLIVA, gMonPalette_followerarboliva),
    SPECIES_PAL(SQUAWKABILLY, gMonPalette_followersquawkabilly),
    SPECIES_PAL(NACLI, gMonPalette_followernacli),
    SPECIES_PAL(NACLSTACK, gMonPalette_followernaclstack),
    SPECIES_PAL(GARGANACL, gMonPalette_followergarganacl),
    SPECIES_PAL(CHARCADET, gMonPalette_followercharcadet),
    SPECIES_PAL(ARMAROUGE, gMonPalette_followerarmarouge),
    SPECIES_PAL(CERULEDGE, gMonPalette_followerceruledge),
    SPECIES_PAL(TADBULB, gMonPalette_followertadbulb),
    SPECIES_PAL(BELLIBOLT, gMonPalette_followerbellibolt),
    SPECIES_PAL(WATTREL, gMonPalette_followerwattrel),
    SPECIES_PAL(KILOWATTREL, gMonPalette_followerkilowattrel),
    SPECIES_PAL(MASCHIFF, gMonPalette_followermaschiff),
    SPECIES_PAL(MABOSSTIFF, gMonPalette_followermabosstiff),
    SPECIES_PAL(SHROODLE, gMonPalette_followershroodle),
    SPECIES_PAL(GRAFAIAI, gMonPalette_followergrafaiai),
    SPECIES_PAL(BRAMBLIN, gMonPalette_followerbramblin),
    SPECIES_PAL(BRAMBLEGHAST, gMonPalette_followerbrambleghast),
    SPECIES_PAL(TOEDSCOOL, gMonPalette_followertoedscool),
    SPECIES_PAL(TOEDSCRUEL, gMonPalette_followertoedscruel),
    SPECIES_PAL(KLAWF, gMonPalette_followerklawf),
    SPECIES_PAL(CAPSAKID, gMonPalette_followercapsakid),
    SPECIES_PAL(SCOVILLAIN, gMonPalette_followerscovillain),
    SPECIES_PAL(RELLOR, gMonPalette_followerrellor),
    SPECIES_PAL(RABSCA, gMonPalette_followerrabsca),
    SPECIES_PAL(FLITTLE, gMonPalette_followerflittle),
    SPECIES_PAL(ESPATHRA, gMonPalette_followerespathra),
    SPECIES_PAL(TINKATINK, gMonPalette_followertinkatink),
    SPECIES_PAL(TINKATUFF, gMonPalette_followertinkatuff),
    SPECIES_PAL(TINKATON, gMonPalette_followertinkaton),
    SPECIES_PAL(WIGLETT, gMonPalette_followerwiglett),
    SPECIES_PAL(WUGTRIO, gMonPalette_followerwugtrio),
    SPECIES_PAL(BOMBIRDIER, gMonPalette_followerbombirdier),
    SPECIES_PAL(FINIZEN, gMonPalette_followerfinizen),
    SPECIES_PAL(PALAFIN, gMonPalette_followerpalafin),
    SPECIES_PAL(VAROOM, gMonPalette_followervaroom),
    SPECIES_PAL(REVAVROOM, gMonPalette_followerrevavroom),
    SPECIES_PAL(CYCLIZAR, gMonPalette_followercyclizar),
    SPECIES_PAL(ORTHWORM, gMonPalette_followerorthworm),
    SPECIES_PAL(GLIMMET, gMonPalette_followerglimmet),
    SPECIES_PAL(GLIMMORA, gMonPalette_followerglimmora),
    SPECIES_PAL(GREAVARD, gMonPalette_followergreavard),
    SPECIES_PAL(HOUNDSTONE, gMonPalette_followerhoundstone),
    SPECIES_PAL(FLAMIGO, gMonPalette_followerflamigo),
    SPECIES_PAL(CETODDLE, gMonPalette_followercetoddle),
    SPECIES_PAL(CETITAN, gMonPalette_followercetitan),
    SPECIES_PAL(VELUZA, gMonPalette_followerveluza),
    SPECIES_PAL(DONDOZO, gMonPalette_followerdondozo),
    SPECIES_PAL(TATSUGIRI, gMonPalette_followertatsugiri),
    SPECIES_PAL(ANNIHILAPE, gMonPalette_followerannihilape),
    // SPECIES_PAL(CLODSIRE, gMonPalette_followerclodsire),
    SPECIES_PAL(FARIGIRAF, gMonPalette_followerfarigiraf),
    SPECIES_PAL(DUDUNSPARCE, gMonPalette_followerdudunsparce),
    SPECIES_PAL(KINGAMBIT, gMonPalette_followerkingambit),
    SPECIES_PAL(GREAT_TUSK, gMonPalette_followergreat_tusk),
    SPECIES_PAL(SCREAM_TAIL, gMonPalette_followerscream_tail),
    SPECIES_PAL(BRUTE_BONNET, gMonPalette_followerbrute_bonnet),
    SPECIES_PAL(FLUTTER_MANE, gMonPalette_followerflutter_mane),
    SPECIES_PAL(SLITHER_WING, gMonPalette_followerslither_wing),
    SPECIES_PAL(SANDY_SHOCKS, gMonPalette_followersandy_shocks),
    SPECIES_PAL(IRON_TREADS, gMonPalette_followeriron_treads),
    SPECIES_PAL(IRON_BUNDLE, gMonPalette_followeriron_bundle),
    SPECIES_PAL(IRON_HANDS, gMonPalette_followeriron_hands),
    SPECIES_PAL(IRON_JUGULIS, gMonPalette_followeriron_jugulis),
    SPECIES_PAL(IRON_MOTH, gMonPalette_followeriron_moth),
    SPECIES_PAL(IRON_THORNS, gMonPalette_followeriron_thorns),
    SPECIES_PAL(FRIGIBAX, gMonPalette_followerfrigibax),
    SPECIES_PAL(ARCTIBAX, gMonPalette_followerarctibax),
    SPECIES_PAL(BAXCALIBUR, gMonPalette_followerbaxcalibur),
    SPECIES_PAL(GIMMIGHOUL, gMonPalette_followergimmighoul),
    SPECIES_PAL(GHOLDENGO, gMonPalette_followergholdengo),
    SPECIES_PAL(WO_CHIEN, gMonPalette_followerwo_chien),
    SPECIES_PAL(CHIEN_PAO, gMonPalette_followerchien_pao),
    SPECIES_PAL(TING_LU, gMonPalette_followerting_lu),
    SPECIES_PAL(CHI_YU, gMonPalette_followerchi_yu),
    SPECIES_PAL(ROARING_MOON, gMonPalette_followerroaring_moon),
    SPECIES_PAL(IRON_VALIANT, gMonPalette_followeriron_valiant),
    SPECIES_PAL(KORAIDON, gMonPalette_followerkoraidon),
    SPECIES_PAL(MIRAIDON, gMonPalette_followermiraidon),
    SPECIES_PAL(WALKING_WAKE, gMonPalette_followerwalking_wake),
    SPECIES_PAL(IRON_LEAVES, gMonPalette_followeriron_leaves),
    SPECIES_PAL(OINKOLOGNE_FEMALE, gMonPalette_followeroinkologne_female),
    SPECIES_PAL(SQUAWKABILLY_BLUE_PLUMAGE, gMonPalette_followersquawkabilly_blue_plumage),
    SPECIES_PAL(SQUAWKABILLY_YELLOW_PLUMAGE, gMonPalette_followersquawkabilly_yellow_plumage),
    SPECIES_PAL(SQUAWKABILLY_WHITE_PLUMAGE, gMonPalette_followersquawkabilly_white_plumage),
    SPECIES_PAL(PALAFIN_HERO, gMonPalette_followerpalafin_hero),
    SPECIES_PAL(TATSUGIRI_DROOPY, gMonPalette_followertatsugiri_droopy),
    SPECIES_PAL(TATSUGIRI_STRETCHY, gMonPalette_followertatsugiri_stretchy),
    SPECIES_PAL(TAUROS_PALDEAN_BLAZE_BREED, gMonPalette_followertauros_paldean_blaze_breed),
    SPECIES_PAL(TAUROS_PALDEAN_AQUA_BREED, gMonPalette_followertauros_paldean_aqua_breed),
    SPECIES_PAL(DIPPLIN, gMonPalette_followerdipplin),
    SPECIES_PAL(POLTCHAGEIST_COUNTERFEIT, gMonPalette_followerpoltchageist_counterfeit),
    SPECIES_PAL(POLTCHAGEIST_ARTISAN, gMonPalette_followerpoltchageist_artisan),
    SPECIES_PAL(SINISTCHA_UNREMARKABLE, gMonPalette_followersinistcha_unremarkable),
    SPECIES_PAL(SINISTCHA_MASTERPIECE, gMonPalette_followersinistcha_masterpiece),
    SPECIES_PAL(OKIDOGI, gMonPalette_followerokidogi),
    SPECIES_PAL(MUNKIDORI, gMonPalette_followermunkidori),
    SPECIES_PAL(FEZANDIPITI, gMonPalette_followerfezandipiti),
    SPECIES_PAL(OGERPON, gMonPalette_followerogerpon),
    SPECIES_PAL(OGERPON_WELLSPRING, gMonPalette_followerogerpon_wellspring),
    SPECIES_PAL(OGERPON_HEARTHFLAME, gMonPalette_followerogerpon_hearthflame),
    SPECIES_PAL(OGERPON_CORNERSTONE, gMonPalette_followerogerpon_cornerstone),
    SPECIES_PAL(ARCHALUDON, gMonPalette_followerarchaludon),
    SPECIES_PAL(HYDRAPPLE, gMonPalette_followerhydrapple),
    SPECIES_PAL(GOUGING_FIRE, gMonPalette_followergouging_fire),
    SPECIES_PAL(RAGING_BOLT, gMonPalette_followerraging_bolt),
    SPECIES_PAL(IRON_BOULDER, gMonPalette_followeriron_boulder),
    SPECIES_PAL(IRON_CROWN, gMonPalette_followeriron_crown),
    SPECIES_PAL(TERAPAGOS, gMonPalette_followerterapagos),
    SPECIES_PAL(PECHARUNT, gMonPalette_followerpecharunt),
};
