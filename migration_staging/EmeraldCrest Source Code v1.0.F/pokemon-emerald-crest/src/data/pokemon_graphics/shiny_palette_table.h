const struct CompressedSpritePalette gMonShinyPaletteTable[] =
{
    ...
    SPECIES_SHINY_PAL(OGERPON, gMonShinyPalette_OgerponTeal),
    ...
    SPECIES_PAL(PECHARUNT, gMonShinyPalette_Pecharunt),
    
#endif
    SPECIES_SHINY_PAL(EGG, gMonPalette_Egg),
};

const struct CompressedSpritePalette gShinyHisuiMonPaletteTable[] =
{
    SPECIES_PAL(WYRDEER, gMonShinyPalette_followerWyrdeer),
    SPECIES_PAL(KLEAVOR, gMonShinyPalette_followerKleavor),
    SPECIES_PAL(URSALUNA, gMonShinyPalette_followerUrsaluna),
    SPECIES_PAL(BASCULEGION, gMonShinyPalette_followerBasculegion),
    SPECIES_PAL(SNEASLER, gMonShinyPalette_followerSneasler),
    SPECIES_PAL(OVERQWIL, gMonShinyPalette_followerOverqwil),
    SPECIES_PAL(GROWLITHE_HISUIAN, gMonShinyPalette_followerGrowlitheHisuian),
    SPECIES_PAL(ARCANINE_HISUIAN, gMonShinyPalette_followerArcanineHisuian),
    SPECIES_PAL(VOLTORB_HISUIAN, gMonShinyPalette_followerVoltorbHisuian),
    SPECIES_PAL(ELECTRODE_HISUIAN, gMonShinyPalette_followerElectrodeHisuian),
    SPECIES_PAL(TYPHLOSION_HISUIAN, gMonShinyPalette_followerTyphlosionHisuian),
    SPECIES_PAL(QWILFISH_HISUIAN, gMonShinyPalette_followerQwilfishHisuian),
    SPECIES_PAL(SNEASEL_HISUIAN, gMonShinyPalette_followerSneaselHisuian),
    SPECIES_PAL(SAMUROTT_HISUIAN, gMonShinyPalette_followerSamurottHisuian),
    SPECIES_PAL(LILLIGANT_HISUIAN, gMonShinyPalette_followerLilligantHisuian),
    SPECIES_PAL(ZORUA_HISUIAN, gMonShinyPalette_followerZoruaHisuian),
    SPECIES_PAL(ZOROARK_HISUIAN, gMonShinyPalette_followerZoroarkHisuian),
    SPECIES_PAL(BRAVIARY_HISUIAN, gMonShinyPalette_followerBraviaryHisuian),
    SPECIES_PAL(SLIGGOO_HISUIAN, gMonShinyPalette_followerSliggooHisuian),
    SPECIES_PAL(GOODRA_HISUIAN, gMonShinyPalette_followerGoodraHisuian),
    SPECIES_PAL(AVALUGG_HISUIAN, gMonShinyPalette_followerAvaluggHisuian),
    SPECIES_PAL(DECIDUEYE_HISUIAN, gMonShinyPalette_followerDecidueyeHisuian),
    SPECIES_PAL(BASCULIN_WHITE_STRIPED, gMonShinyPalette_followerBasculinWhiteStriped),
    SPECIES_PAL(BASCULEGION_FEMALE, gMonShinyPalette_followerBasculegionFemale),
    SPECIES_PAL(SPRIGATITO, gMonShinyPalette_followersprigatito),
    SPECIES_PAL(FLORAGATO, gMonShinyPalette_followerfloragato),
    SPECIES_PAL(MEOWSCARADA, gMonShinyPalette_followermeowscarada),
    SPECIES_PAL(FUECOCO, gMonShinyPalette_followerfuecoco),
    SPECIES_PAL(CROCALOR, gMonShinyPalette_followercrocalor),
    SPECIES_PAL(SKELEDIRGE, gMonShinyPalette_followerskeledirge),
    SPECIES_PAL(QUAXLY, gMonShinyPalette_followerquaxly),
    SPECIES_PAL(QUAXWELL, gMonShinyPalette_followerquaxwell),
    SPECIES_PAL(QUAQUAVAL, gMonShinyPalette_followerquaquaval),
    SPECIES_PAL(LECHONK, gMonShinyPalette_followerlechonk),
    SPECIES_PAL(OINKOLOGNE, gMonShinyPalette_followeroinkologne),
    SPECIES_PAL(TAROUNTULA, gMonShinyPalette_followertarountula),
    SPECIES_PAL(SPIDOPS, gMonShinyPalette_followerspidops),
    SPECIES_PAL(NYMBLE, gMonShinyPalette_followernymble),
    SPECIES_PAL(LOKIX, gMonShinyPalette_followerlokix),
    SPECIES_PAL(PAWMI, gMonShinyPalette_followerpawmi),
    SPECIES_PAL(PAWMO, gMonShinyPalette_followerpawmo),
    SPECIES_PAL(PAWMOT, gMonShinyPalette_followerpawmot),
    SPECIES_PAL(TANDEMAUS, gMonShinyPalette_followertandemaus),
    SPECIES_PAL(MAUSHOLD, gMonShinyPalette_followermaushold),
        SPECIES_PAL(MAUSHOLD_FAMILY_OF_THREE, gMonShinyPalette_followermaushold_family),
    SPECIES_PAL(FIDOUGH, gMonShinyPalette_followerfidough),
    SPECIES_PAL(DACHSBUN, gMonShinyPalette_followerdachsbun),
    SPECIES_PAL(SMOLIV, gMonShinyPalette_followersmoliv),
    SPECIES_PAL(DOLLIV, gMonShinyPalette_followerdolliv),
    SPECIES_PAL(ARBOLIVA, gMonShinyPalette_followerarboliva),
    SPECIES_PAL(SQUAWKABILLY, gMonShinyPalette_followersquawkabilly),
    SPECIES_PAL(NACLI, gMonShinyPalette_followernacli),
    SPECIES_PAL(NACLSTACK, gMonShinyPalette_followernaclstack),
    SPECIES_PAL(GARGANACL, gMonShinyPalette_followergarganacl),
    SPECIES_PAL(CHARCADET, gMonShinyPalette_followercharcadet),
    SPECIES_PAL(ARMAROUGE, gMonShinyPalette_followerarmarouge),
    SPECIES_PAL(CERULEDGE, gMonShinyPalette_followerceruledge),
    SPECIES_PAL(TADBULB, gMonShinyPalette_followertadbulb),
    SPECIES_PAL(BELLIBOLT, gMonShinyPalette_followerbellibolt),
    SPECIES_PAL(WATTREL, gMonShinyPalette_followerwattrel),
    SPECIES_PAL(KILOWATTREL, gMonShinyPalette_followerkilowattrel),
    SPECIES_PAL(MASCHIFF, gMonShinyPalette_followermaschiff),
    SPECIES_PAL(MABOSSTIFF, gMonShinyPalette_followermabosstiff),
    SPECIES_PAL(SHROODLE, gMonShinyPalette_followershroodle),
    SPECIES_PAL(GRAFAIAI, gMonShinyPalette_followergrafaiai),
    SPECIES_PAL(BRAMBLIN, gMonShinyPalette_followerbramblin),
    SPECIES_PAL(BRAMBLEGHAST, gMonShinyPalette_followerbrambleghast),
    SPECIES_PAL(TOEDSCOOL, gMonShinyPalette_followertoedscool),
    SPECIES_PAL(TOEDSCRUEL, gMonShinyPalette_followertoedscruel),
    SPECIES_PAL(KLAWF, gMonShinyPalette_followerklawf),
    SPECIES_PAL(CAPSAKID, gMonShinyPalette_followercapsakid),
    SPECIES_PAL(SCOVILLAIN, gMonShinyPalette_followerscovillain),
    SPECIES_PAL(RELLOR, gMonShinyPalette_followerrellor),
    SPECIES_PAL(RABSCA, gMonShinyPalette_followerrabsca),
    SPECIES_PAL(FLITTLE, gMonShinyPalette_followerflittle),
    SPECIES_PAL(ESPATHRA, gMonShinyPalette_followerespathra),
    SPECIES_PAL(TINKATINK, gMonShinyPalette_followertinkatink),
    SPECIES_PAL(TINKATUFF, gMonShinyPalette_followertinkatuff),
    SPECIES_PAL(TINKATON, gMonShinyPalette_followertinkaton),
    SPECIES_PAL(WIGLETT, gMonShinyPalette_followerwiglett),
    SPECIES_PAL(WUGTRIO, gMonShinyPalette_followerwugtrio),
    SPECIES_PAL(BOMBIRDIER, gMonShinyPalette_followerbombirdier),
    SPECIES_PAL(FINIZEN, gMonShinyPalette_followerfinizen),
    SPECIES_PAL(PALAFIN, gMonShinyPalette_followerpalafin),
    SPECIES_PAL(VAROOM, gMonShinyPalette_followervaroom),
    SPECIES_PAL(REVAVROOM, gMonShinyPalette_followerrevavroom),
    SPECIES_PAL(CYCLIZAR, gMonShinyPalette_followercyclizar),
    SPECIES_PAL(ORTHWORM, gMonShinyPalette_followerorthworm),
    SPECIES_PAL(GLIMMET, gMonShinyPalette_followerglimmet),
    SPECIES_PAL(GLIMMORA, gMonShinyPalette_followerglimmora),
    SPECIES_PAL(GREAVARD, gMonShinyPalette_followergreavard),
    SPECIES_PAL(HOUNDSTONE, gMonShinyPalette_followerhoundstone),
    SPECIES_PAL(FLAMIGO, gMonShinyPalette_followerflamigo),
    SPECIES_PAL(CETODDLE, gMonShinyPalette_followercetoddle),
    SPECIES_PAL(CETITAN, gMonShinyPalette_followercetitan),
    SPECIES_PAL(VELUZA, gMonShinyPalette_followerveluza),
    SPECIES_PAL(DONDOZO, gMonShinyPalette_followerdondozo),
    SPECIES_PAL(TATSUGIRI, gMonShinyPalette_followertatsugiri),
    SPECIES_PAL(ANNIHILAPE, gMonShinyPalette_followerannihilape),
    // SPECIES_PAL(CLODSIRE, gMonShinyPalette_followerclodsire),
    SPECIES_PAL(FARIGIRAF, gMonShinyPalette_followerfarigiraf),
    SPECIES_PAL(DUDUNSPARCE, gMonShinyPalette_followerdudunsparce),
    SPECIES_PAL(KINGAMBIT, gMonShinyPalette_followerkingambit),
    SPECIES_PAL(GREAT_TUSK, gMonShinyPalette_followergreat_tusk),
    SPECIES_PAL(SCREAM_TAIL, gMonShinyPalette_followerscream_tail),
    SPECIES_PAL(BRUTE_BONNET, gMonShinyPalette_followerbrute_bonnet),
    SPECIES_PAL(FLUTTER_MANE, gMonShinyPalette_followerflutter_mane),
    SPECIES_PAL(SLITHER_WING, gMonShinyPalette_followerslither_wing),
    SPECIES_PAL(SANDY_SHOCKS, gMonShinyPalette_followersandy_shocks),
    SPECIES_PAL(IRON_TREADS, gMonShinyPalette_followeriron_treads),
    SPECIES_PAL(IRON_BUNDLE, gMonShinyPalette_followeriron_bundle),
    SPECIES_PAL(IRON_HANDS, gMonShinyPalette_followeriron_hands),
    SPECIES_PAL(IRON_JUGULIS, gMonShinyPalette_followeriron_jugulis),
    SPECIES_PAL(IRON_MOTH, gMonShinyPalette_followeriron_moth),
    SPECIES_PAL(IRON_THORNS, gMonShinyPalette_followeriron_thorns),
    SPECIES_PAL(FRIGIBAX, gMonShinyPalette_followerfrigibax),
    SPECIES_PAL(ARCTIBAX, gMonShinyPalette_followerarctibax),
    SPECIES_PAL(BAXCALIBUR, gMonShinyPalette_followerbaxcalibur),
    SPECIES_PAL(GIMMIGHOUL, gMonShinyPalette_followergimmighoul),
    SPECIES_PAL(GHOLDENGO, gMonShinyPalette_followergholdengo),
    SPECIES_PAL(WO_CHIEN, gMonShinyPalette_followerwo_chien),
    SPECIES_PAL(CHIEN_PAO, gMonShinyPalette_followerchien_pao),
    SPECIES_PAL(TING_LU, gMonShinyPalette_followerting_lu),
    SPECIES_PAL(CHI_YU, gMonShinyPalette_followerchi_yu),
    SPECIES_PAL(ROARING_MOON, gMonShinyPalette_followerroaring_moon),
    SPECIES_PAL(IRON_VALIANT, gMonShinyPalette_followeriron_valiant),
    SPECIES_PAL(KORAIDON, gMonShinyPalette_followerkoraidon),
    SPECIES_PAL(MIRAIDON, gMonShinyPalette_followermiraidon),
    SPECIES_PAL(WALKING_WAKE, gMonShinyPalette_followerwalking_wake),
    SPECIES_PAL(IRON_LEAVES, gMonShinyPalette_followeriron_leaves),
    SPECIES_PAL(OINKOLOGNE_FEMALE, gMonShinyPalette_followeroinkologne_female),
    SPECIES_PAL(SQUAWKABILLY_BLUE_PLUMAGE, gMonShinyPalette_followersquawkabilly_blue_plumage),
    SPECIES_PAL(SQUAWKABILLY_YELLOW_PLUMAGE, gMonShinyPalette_followersquawkabilly_yellow_plumage),
    SPECIES_PAL(SQUAWKABILLY_WHITE_PLUMAGE, gMonShinyPalette_followersquawkabilly_white_plumage),
    SPECIES_PAL(PALAFIN_HERO, gMonShinyPalette_followerpalafin_hero),
    SPECIES_PAL(TATSUGIRI_DROOPY, gMonShinyPalette_followertatsugiri_droopy),
    SPECIES_PAL(TATSUGIRI_STRETCHY, gMonShinyPalette_followertatsugiri_stretchy),
    SPECIES_PAL(TAUROS_PALDEAN_BLAZE_BREED, gMonShinyPalette_followertauros_paldean_blaze_breed),
    SPECIES_PAL(TAUROS_PALDEAN_AQUA_BREED, gMonShinyPalette_followertauros_paldean_aqua_breed),
    SPECIES_PAL(DIPPLIN, gMonShinyPalette_followerdipplin),
    SPECIES_PAL(POLTCHAGEIST_COUNTERFEIT, gMonShinyPalette_followerpoltchageist_counterfeit),
    SPECIES_PAL(POLTCHAGEIST_ARTISAN, gMonShinyPalette_followerpoltchageist_artisan),
    SPECIES_PAL(SINISTCHA_UNREMARKABLE, gMonShinyPalette_followersinistcha_unremarkable),
    SPECIES_PAL(SINISTCHA_MASTERPIECE, gMonShinyPalette_followersinistcha_masterpiece),
    SPECIES_PAL(OKIDOGI, gMonShinyPalette_followerokidogi),
    SPECIES_PAL(MUNKIDORI, gMonShinyPalette_followermunkidori),
    SPECIES_PAL(FEZANDIPITI, gMonShinyPalette_followerfezandipiti),
    SPECIES_PAL(OGERPON, gMonShinyPalette_followerogerpon),
    SPECIES_PAL(OGERPON_WELLSPRING, gMonShinyPalette_followerogerpon_wellspring),
    SPECIES_PAL(OGERPON_HEARTHFLAME, gMonShinyPalette_followerogerpon_hearthflame),
    SPECIES_PAL(OGERPON_CORNERSTONE, gMonShinyPalette_followerogerpon_cornerstone),
    SPECIES_PAL(ARCHALUDON, gMonShinyPalette_followerarchaludon),
    SPECIES_PAL(HYDRAPPLE, gMonShinyPalette_followerhydrapple),
    SPECIES_PAL(GOUGING_FIRE, gMonShinyPalette_followergouging_fire),
    SPECIES_PAL(RAGING_BOLT, gMonShinyPalette_followerraging_bolt),
    SPECIES_PAL(IRON_BOULDER, gMonShinyPalette_followeriron_boulder),
    SPECIES_PAL(IRON_CROWN, gMonShinyPalette_followeriron_crown),
    SPECIES_PAL(TERAPAGOS, gMonShinyPalette_followerterapagos),
    SPECIES_PAL(PECHARUNT, gMonShinyPalette_followerpecharunt),
