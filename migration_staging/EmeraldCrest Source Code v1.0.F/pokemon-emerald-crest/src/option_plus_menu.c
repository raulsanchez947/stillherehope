...
enum
{
    ...
    MENUITEM_CUSTOM_TYPE_TEXT_EFFECTIVENESS,
    MENUITEM_CUSTOM_EXP_SHARE,
    MENUITEM_CUSTOM_EXP_MULTIPLIER,
    MENUITEM_CUSTOM_MEGA_EVOLUTION,
    MENUITEM_CUSTOM_FOLLOWER,
    MENUITEM_CUSTOM_SEASONS,
    MENUITEM_CUSTOM_SEASONAL_ENCOUNTERS,
    MENUITEM_CUSTOM_SEASONAL_EVOLUTIONS,
...
static void DrawChoices_ExpShare(int selection, int y);
static void DrawChoices_Type_Text_Effectiveness(int selection, int y);
static void DrawChoices_Follower(int selection, int y);
static void DrawChoices_Seasons(int selection, int y);
static void DrawChoices_SeasonalEncounters(int selection, int y);
static void DrawChoices_SeasonalEvolutions(int selection, int y);
...
} static const sItemFunctionsCustom[MENUITEM_CUSTOM_COUNT] =
{
    ...
    [MENUITEM_CUSTOM_TYPE_TEXT_EFFECTIVENESS] = {DrawChoices_Type_Text_Effectiveness,     ProcessInput_Options_Two},    
    [MENUITEM_CUSTOM_EXP_SHARE]               = {DrawChoices_ExpShare,                    ProcessInput_Options_Two},
    [MENUITEM_CUSTOM_EXP_MULTIPLIER]          = {DrawChoices_Challenges_ExpMultiplier,    ProcessInput_Options_Four},
    [MENUITEM_CUSTOM_MEGA_EVOLUTION]          = {DrawChoices_Challenges_MegaEvo,          ProcessInput_Options_Two},
    [MENUITEM_CUSTOM_FOLLOWER]                = {DrawChoices_Follower,                    ProcessInput_Options_Two},
    [MENUITEM_CUSTOM_SEASONS]                 = {DrawChoices_Seasons,                     ProcessInput_Options_Four},
    [MENUITEM_CUSTOM_SEASONAL_ENCOUNTERS]      = {DrawChoices_SeasonalEncounters,          ProcessInput_Options_Two},
    [MENUITEM_CUSTOM_SEASONAL_EVOLUTIONS]      = {DrawChoices_SeasonalEvolutions,          ProcessInput_Options_Two},
...
static const u8 gText_AutoRun[]     = _("AUTO RUN");
static const u8 gText_Type_Text_Effectiveness[] = _("COLOURED TEXT");
static const u8 gText_OptionExpShare[] = _("EXP SHARE");
static const u8 gText_OptionExpMultiplier[] = _("EXP MULTIPLIER");
static const u8 gText_MegaEvolution[] = _("MEGA EVOLUTION");
static const u8 sText_Follower[] = _("FOLLOWER");
static const u8 sText_Seasons[] = _("SEASON");
static const u8 sText_SeasonalEncounters[] = _("ENCOUNTERS");
static const u8 sText_SeasonalEvolutions[] = _("EVOLUTIONS");
...
static const u8 *const sOptionMenuItemsNamesMain[MENUITEM_MAIN_COUNT] =
{
    ...
    [MENUITEM_MAIN_CANCEL]      = gText_OptionMenuNext,
};
...
static const u8 *const sOptionMenuItemsNamesCustom[MENUITEM_CUSTOM_COUNT] =
{
    ...
    [MENUITEM_CUSTOM_AUTORUN]     = gText_AutoRun,
    [MENUITEM_CUSTOM_TYPE_TEXT_EFFECTIVENESS] = gText_Type_Text_Effectiveness,
    [MENUITEM_CUSTOM_EXP_SHARE]   = gText_OptionExpShare,
    [MENUITEM_CUSTOM_EXP_MULTIPLIER] = gText_OptionExpMultiplier,
    [MENUITEM_CUSTOM_MEGA_EVOLUTION] = gText_MegaEvolution,
    [MENUITEM_CUSTOM_FOLLOWER]    = sText_Follower,
    [MENUITEM_CUSTOM_SEASONS]     = sText_Seasons,
    [MENUITEM_CUSTOM_SEASONAL_ENCOUNTERS] = sText_SeasonalEncounters,
    [MENUITEM_CUSTOM_SEASONAL_EVOLUTIONS] = sText_SeasonalEvolutions,
...
static bool8 CheckConditions(int selection)
{
    ...
    case MENU_CUSTOM:
        ...
        case MENUITEM_CUSTOM_AUTORUN:
         if (!FlagGet(FLAG_SYS_B_DASH))         
          return FALSE;
         else 
          return TRUE;
        case MENUITEM_CUSTOM_TYPE_TEXT_EFFECTIVENESS:  return TRUE;
        case MENUITEM_CUSTOM_EXP_SHARE: 
            if (!FlagGet(FLAG_RECEIVED_EXP_SHARE))
                return FALSE;
            else
                return TRUE;
        case MENUITEM_CUSTOM_EXP_MULTIPLIER:  return TRUE; 
        case MENUITEM_CUSTOM_MEGA_EVOLUTION:  return TRUE;
        case MENUITEM_CUSTOM_FOLLOWER:        return TRUE;
        case MENUITEM_CUSTOM_SEASONS:         return TRUE;
        case MENUITEM_CUSTOM_SEASONAL_ENCOUNTERS:
            if (gSaveBlock2Ptr->seasons == 1) // If seasons are ON
                return TRUE;
            else
                return FALSE;
        case MENUITEM_CUSTOM_SEASONAL_EVOLUTIONS:
            if (gSaveBlock2Ptr->seasons == 1) // If seasons are ON
                return TRUE;
            else
                return FALSE;
...
static const u8 sText_Desc_Next[]               = _("Go to the next page.");
...
static const u8 sText_Desc_AutoRunOff[]         = _("Auto Run {COLOR RED}Disabled{COLOR DARK_GRAY}.");
static const u8 sText_Desc_AutoRunOn[]          = _("Auto Run {COLOR GREEN}Enabled{COLOR DARK_GRAY}.");
static const u8 sText_Desc_Type_Text_EffectivenessOn[] = _("Moves with type effectiveness are\nhighlighted.");
static const u8 sText_Desc_Type_Text_EffectivenessOff[] = _("Moves with type effectiveness are\nnot highlighted.");
static const u8 sText_Desc_ExpShareOff[]        = _("EXP SHARE {COLOR RED}Disabled{COLOR DARK_GRAY}.");
static const u8 sText_ExpShareOn[]              = _("EXP SHARE {COLOR GREEN}Enabled{COLOR DARK_GRAY}.");
static const u8 sText_Desc_FrameType[]          = _("Choose the frame surrounding the\nwindows.");
static const u8 sText_Desc_SeasonalEncountersOff[] = _("Wild POKéMON remain the same\nregardless of season.");
static const u8 sText_Desc_SeasonalEncountersOn[] = _("Seasonal POKéMON will appear\nbased on the current season.");
static const u8 sText_Desc_SeasonalEvolutionsOff[] = _("POKéMON evolve normally\nregardless of season.");
static const u8 sText_Desc_SeasonalEvolutionsOn[] = _("Some POKéMON will evolve based on\nthe current season.");
static const u8 *const sOptionMenuItemDescriptionsMain[MENUITEM_MAIN_COUNT][3] =
{
    ...
    [MENUITEM_MAIN_CANCEL]      = {sText_Desc_Next,                 sText_Empty,                sText_Empty},
};
...
static const u8 sText_Description_Custom_ExpMultiplier_1_0[]        = _("POKéMON gain normal EXP. Points.");
static const u8 sText_Description_Custom_ExpMultiplier_1_5[]        = _("POKéMON 50 percent more EXP. Points!");
static const u8 sText_Description_Custom_ExpMultiplier_2_0[]        = _("POKéMON gain double EXP. Points!");
static const u8 sText_Description_Custom_ExpMultiplier_0_0[]        = _("POKéMON gain {COLOR 7}{COLOR 8}ZERO EXP. Points!!!");
static const u8 sText_Desc_MegaEvolutionOff[]   = _("Static encounters will not remain\nmega evolved.");
static const u8 sText_Desc_MegaEvolutionOn[]    = _("Static encounters will remain mega\nevolved.");
static const u8 sText_Desc_FollowerOff[]        = _("Disables Following POKéMON");
static const u8 sText_Desc_FollowerOn[]         = _("Enables Following POKéMON");
static const u8 sText_Desc_TwoDays[]            = _("Season changes every 2 days.");
static const u8 sText_Desc_SevenDays[]          = _("Season changes every week.");
static const u8 sText_Desc_Auto[]               = _("Season changes based on real timing");
static const u8 sText_Desc_Off[]                = _("Deafults to Summer season");
static const u8 *const sOptionMenuItemDescriptionsCustom[MENUITEM_CUSTOM_COUNT][4] =
{
    [MENUITEM_CUSTOM_HP_BAR]      = {sText_Desc_BattleHPBar, sText_Empty, sText_Empty, sText_Empty},
    [MENUITEM_CUSTOM_EXP_BAR]     = {sText_Desc_BattleExpBar, sText_Empty,sText_Empty, sText_Empty},
    [MENUITEM_CUSTOM_FONT]        = {sText_Desc_FontType, sText_Desc_FontType, sText_Empty, sText_Empty},
    [MENUITEM_CUSTOM_MATCHCALL]   = {sText_Desc_OverworldCallsOn, sText_Desc_OverworldCallsOff, sText_Empty, sText_Empty},
    [MENUITEM_CUSTOM_AUTORUN]     = {sText_Desc_AutoRunOff, sText_Desc_AutoRunOn, sText_Empty, sText_Empty},    
    [MENUITEM_CUSTOM_TYPE_TEXT_EFFECTIVENESS] = {sText_Desc_Type_Text_EffectivenessOff, sText_Desc_Type_Text_EffectivenessOn, sText_Empty, sText_Empty},
    [MENUITEM_CUSTOM_EXP_SHARE]   = {sText_Desc_ExpShareOff, sText_ExpShareOn, sText_Empty, sText_Empty},
    [MENUITEM_CUSTOM_EXP_MULTIPLIER]  = {sText_Description_Custom_ExpMultiplier_1_0,  sText_Description_Custom_ExpMultiplier_1_5, sText_Description_Custom_ExpMultiplier_2_0, sText_Description_Custom_ExpMultiplier_0_0},
    [MENUITEM_CUSTOM_MEGA_EVOLUTION] = {sText_Desc_MegaEvolutionOff, sText_Desc_MegaEvolutionOn, sText_Empty, sText_Empty},
    [MENUITEM_CUSTOM_FOLLOWER]    = {sText_Desc_FollowerOff, sText_Desc_FollowerOn, sText_Empty, sText_Empty},
    [MENUITEM_CUSTOM_SEASONS]     = {sText_Desc_TwoDays, sText_Desc_SevenDays, sText_Desc_Auto, sText_Desc_Off},
    [MENUITEM_CUSTOM_SEASONAL_ENCOUNTERS] = {sText_Desc_SeasonalEncountersOff, sText_Desc_SeasonalEncountersOn, sText_Empty, sText_Empty},
    [MENUITEM_CUSTOM_SEASONAL_EVOLUTIONS] = {sText_Desc_SeasonalEvolutionsOff, sText_Desc_SeasonalEvolutionsOn, sText_Empty, sText_Empty},
...
static const u8 sText_Desc_Disabled_AutoRun[]       = _("Unlock Running Shoes first.");
static const u8 sText_Desc_Disabled_ExpShare[]      = _("Unlock EXP Share first.");
static const u8 sText_Desc_Disabled_SeasonalEncounters[] = _("Enable seasons first to use this\nfeature.");
static const u8 sText_Desc_Disabled_SeasonalEvolutions[] = _("Enable seasons first to use this\nfeature.");
static const u8 *const sOptionMenuItemDescriptionsDisabledCustom[MENUITEM_CUSTOM_COUNT] =
{
    ...
    [MENUITEM_CUSTOM_AUTORUN]     = sText_Desc_Disabled_AutoRun,
    [MENUITEM_CUSTOM_TYPE_TEXT_EFFECTIVENESS] = sText_Empty,
    [MENUITEM_CUSTOM_EXP_SHARE]   = sText_Desc_Disabled_ExpShare,
    [MENUITEM_CUSTOM_EXP_MULTIPLIER] = sText_Empty,
    [MENUITEM_CUSTOM_MEGA_EVOLUTION] = sText_Empty,
    [MENUITEM_CUSTOM_FOLLOWER] = sText_Empty,
    [MENUITEM_CUSTOM_SEASONS] = sText_Empty,
    [MENUITEM_CUSTOM_SEASONAL_ENCOUNTERS] = sText_Desc_Disabled_SeasonalEncounters,
    [MENUITEM_CUSTOM_SEASONAL_EVOLUTIONS] = sText_Desc_Disabled_SeasonalEvolutions,
...
static const u8 sText_TopBar_Main_Right[]   = _("{R_BUTTON} NEXT");
static const u8 sText_TopBar_Custom[]       = _("MORE");
...
void CB2_InitOptionPlusMenu(void)
{
    ...
    case 6:
        ...
        sOptions->sel_custom[MENUITEM_CUSTOM_AUTORUN]     = gSaveBlock2Ptr->autoRun;
        sOptions->sel_custom[MENUITEM_CUSTOM_TYPE_TEXT_EFFECTIVENESS] = gSaveBlock1Ptr->in_battle_type_effectiveness;
        sOptions->sel_custom[MENUITEM_CUSTOM_EXP_SHARE]   = gSaveBlock2Ptr->ExpShare;
        sOptions->sel_custom[MENUITEM_CUSTOM_EXP_MULTIPLIER] = gSaveBlock1Ptr->tx_Challenges_ExpMultiplier;
        sOptions->sel_custom[MENUITEM_CUSTOM_MEGA_EVOLUTION] = gSaveBlock1Ptr->tx_Challenges_MegaEvo;
        sOptions->sel_custom[MENUITEM_CUSTOM_FOLLOWER] = gSaveBlock2Ptr->follower;
        sOptions->sel_custom[MENUITEM_CUSTOM_SEASONS] = gSaveBlock2Ptr->seasons;
        sOptions->sel_custom[MENUITEM_CUSTOM_SEASONAL_ENCOUNTERS] = gSaveBlock2Ptr->seasonalEncounters;
        sOptions->sel_custom[MENUITEM_CUSTOM_SEASONAL_EVOLUTIONS] = gSaveBlock2Ptr->seasonalEvolutions;
...
static void Task_OptionMenuProcessInput(u8 taskId)
{
    ...
    if (JOY_NEW(A_BUTTON))
    {
        if (sOptions->menuCursor[sOptions->submenu] == MenuItemCancel() && sOptions->submenu != MENU_CUSTOM) {
            sOptions->submenu++;
            DrawTopBarText();
            ReDrawAll();
            HighlightOptionMenuItem();
        ...
        else if (sOptions->menuCursor[sOptions->submenu] == MenuItemCancel()) {
...
static void Task_OptionMenuSave(u8 taskId)
{
    ...
    gSaveBlock2Ptr->autoRun                 = sOptions->sel_custom[MENUITEM_CUSTOM_AUTORUN];    
    gSaveBlock1Ptr->in_battle_type_effectiveness = sOptions->sel_custom[MENUITEM_CUSTOM_TYPE_TEXT_EFFECTIVENESS];
    gSaveBlock2Ptr->ExpShare         = sOptions->sel_custom[MENUITEM_CUSTOM_EXP_SHARE];
    gSaveBlock1Ptr->tx_Challenges_ExpMultiplier = sOptions->sel_custom[MENUITEM_CUSTOM_EXP_MULTIPLIER];
    gSaveBlock1Ptr->tx_Challenges_MegaEvo = sOptions->sel_custom[MENUITEM_CUSTOM_MEGA_EVOLUTION];
    gSaveBlock2Ptr->follower = sOptions->sel_custom[MENUITEM_CUSTOM_FOLLOWER];
    gSaveBlock2Ptr->seasons = sOptions->sel_custom[MENUITEM_CUSTOM_SEASONS];
    gSaveBlock2Ptr->seasonalEncounters = sOptions->sel_custom[MENUITEM_CUSTOM_SEASONAL_ENCOUNTERS];
    gSaveBlock2Ptr->seasonalEvolutions = sOptions->sel_custom[MENUITEM_CUSTOM_SEASONAL_EVOLUTIONS];
...
static const u8 *const sText_On_Off_Strings[] = 
{
    gText_BattleSceneOn,
...
static void DrawChoices_AutoRun(int selection, int y)
{
    ...
    u8 n = selection;
    styles[selection] = 1;
    StringCopyPadded(gStringVar1, sText_On_Off_Strings[n], 0, 2);

    DrawOptionMenuChoice(gText_BattleSceneOn, 104, y, styles[1], active);
    DrawOptionMenuChoice(gText_BattleSceneOff, GetStringRightAlignXOffset(1, gText_BattleSceneOff, 198), y, styles[0], active);
    
    if (!StringCompare(gStringVar1, gText_BattleSceneOn)) {
...
static void DrawChoices_Type_Text_Effectiveness(int selection, int y)
{
    bool8 active = CheckConditions(MENUITEM_CUSTOM_TYPE_TEXT_EFFECTIVENESS);
    u8 styles[2] = {0};
    u8 n = selection;
    styles[selection] = 1;
    StringCopyPadded(gStringVar1, sText_On_Off_Strings[n], 0, 2);

    // For consistency with all the other on/off options...
    DrawOptionMenuChoice(gText_BattleSceneOn, 104, y, styles[1], active);
    DrawOptionMenuChoice(gText_BattleSceneOff, GetStringRightAlignXOffset(1, gText_BattleSceneOff, 198), y, styles[0], active);
    
    if (!StringCompare(gStringVar1, gText_BattleSceneOn)) {
        gSaveBlock1Ptr->in_battle_type_effectiveness = FALSE;
    }
    else {
        gSaveBlock1Ptr->in_battle_type_effectiveness = TRUE;
    }
}

static void DrawChoices_ExpShare(int selection, int y)
{
    bool8 active = CheckConditions(MENUITEM_CUSTOM_EXP_SHARE);
    u8 styles[2] = {0};
    u8 n = selection;
    styles[selection] = 1;
    StringCopyPadded(gStringVar1, sText_On_Off_Strings[n], 0, 2);
...
static const u8 sText_Seasons_2days[]   = _("2 DAYS");
static const u8 sText_Seasons_Week[]   = _("WEEK");
static const u8 sText_Seasons_Auto[]   = _("AUTO");
static const u8 sText_Seasons_Off[]   = _("OFF");
static const u8 *const sText_Seasons_Strings[] = {sText_Seasons_2days, sText_Seasons_Week, sText_Seasons_Auto, sText_Seasons_Off};
void DrawChoices_Seasons(int selection, int y)
{
    bool8 active = CheckConditions(MENUITEM_CUSTOM_SEASONS);
    DrawChoices_Options_Four(sText_Seasons_Strings, selection, y, active);

    if (!StringCompare(sText_Seasons_Strings[selection], sText_Seasons_Off)) {
        gSaveBlock2Ptr->seasons = 0;
        gSaveBlock2Ptr->seasonalEvolutions = 0;
        gSaveBlock2Ptr->seasonalEncounters = 0;
        FlagClear(FLAG_SEASONS);
    }
    else {
        gSaveBlock2Ptr->seasons = 1;
        FlagSet(FLAG_SEASONS);
    }

   // MgbaPrintf(MGBA_LOG_DEBUG, "seasons: %d", gSaveBlock2Ptr->seasons);
}

static void DrawChoices_SeasonalEncounters(int selection, int y)
{
    bool8 active = CheckConditions(MENUITEM_CUSTOM_SEASONAL_ENCOUNTERS);
    u8 styles[2] = {0};
    styles[selection] = 1;
    ...
    if (selection == 0)
        ...
        gSaveBlock2Ptr->seasonalEncounters = 1;

    //MgbaPrintf(MGBA_LOG_DEBUG, "seasonalEncounters: %d", gSaveBlock2Ptr->seasonalEncounters);
}

static void DrawChoices_SeasonalEvolutions(int selection, int y)
{
    bool8 active = CheckConditions(MENUITEM_CUSTOM_SEASONAL_EVOLUTIONS);
    u8 styles[2] = {0};
    styles[selection] = 1;
    ...
    if (selection == 0)
        ...
        gSaveBlock2Ptr->seasonalEvolutions = 1;

    //MgbaPrintf(MGBA_LOG_DEBUG, "seasonalEvolutions: %d", gSaveBlock2Ptr->seasonalEvolutions);
}
