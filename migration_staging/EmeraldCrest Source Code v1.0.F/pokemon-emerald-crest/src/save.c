...
u8 HandleSavingData(u8 saveType)
{
    ...
    case SAVE_HALL_OF_FAME:
        ...
        gSaveBlock2Ptr->playerRank += 10;
            #ifndef NDEBUG
            MgbaPrintf(MGBA_LOG_DEBUG, "entered HOF +10:%d", gSaveBlock2Ptr->playerRank);
            #endif
...
#include "data/old_saves/save.v2.h"
#include "data/old_saves/save.v3.h"
#include "data/old_saves/save.v4.h"
#include "data/old_saves/save.v5.h"
...
bool8 UpdateSaveFile(void)
{
    ...
    switch (version)
    {
        case 0: // Upgrading from version 0 to version 6
            result = UpdateSave_v0_v6(gRamSaveSectorLocations);
            break;
        case 1: // Upgrading from version 1 to version 6
            result = UpdateSave_v1_v6(gRamSaveSectorLocations);
            break;
        case 2: // Upgrading from version 2 to version 6
            result = UpdateSave_v2_v6(gRamSaveSectorLocations);
            break;
        case 3: // Upgrading from version 3 to version 6
            result = UpdateSave_v3_v6(gRamSaveSectorLocations);
            break;
        case 4: // Upgrading from version 4 to version 6
            result = UpdateSave_v4_v6(gRamSaveSectorLocations);
            break;
        case 5: // Upgrading from version 5 to version 6
            result = UpdateSave_v5_v6(gRamSaveSectorLocations);
            break;
