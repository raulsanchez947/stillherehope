...
void MoveOutOfSecretBase(void)
{
    ...
    #ifndef NDEBUG
    MgbaPrintf(MGBA_LOG_DEBUG, "move secret base +2:%d", gSaveBlock2Ptr->playerRank);
    #endif
...
void MoveOutOfSecretBaseFromOutside(void)
{
    ...
    gSaveBlock2Ptr->playerRank += 2;
    #ifndef NDEBUG
    MgbaPrintf(MGBA_LOG_DEBUG, "move out of secret base from outside +2:%d", gSaveBlock2Ptr->playerRank);
    #endif
