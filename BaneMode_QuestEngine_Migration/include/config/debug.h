...
// Overworld Debug
#define DEBUG_OVERWORLD_MENU            1              // Enables an overworld debug menu to change flags, variables, giving pokemon and more, accessed by holding R and pressing START while in the overworld by default.
#define DEBUG_OVERWORLD_HELD_KEYS       (A_BUTTON)          // The keys required to be held to open the debug menu.
...
#define DEBUG_OVERWORLD_IN_MENU         0               // Replaces the overworld debug menu button combination with a start menu entry (above Pokédex).
...
// Pokémon Debug
#define DEBUG_POKEMON_MENU              0   // Enables a debug menu for pokemon sprites and icons, accessed by pressing SELECT in the summary screen.
