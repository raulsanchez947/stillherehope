...
#define MOVE_RESULT_FIGHTING_SPIRIT       (1 << 10)
...
#define B_WIN_ZMOVE              24
// For the coloured battle text
#define B_WIN_SUPER_EFFECTIVE         25
#define B_WIN_NOT_VERY_EFFECTIVE      26
#define B_WIN_NO_EFFECT               27
