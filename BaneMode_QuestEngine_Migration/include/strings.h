...
extern const u8 gText_UnitSystemMetric[];   //optionsPlus
extern const u8 gText_UnitSystemImperial[]; //optionsPlus
...
extern const u8 gText_Font[];               //optionsPlus
extern const u8 gText_OptionFontFireRed[];  //optionsPlus
extern const u8 gText_OptionFontEmerald[];  //optionsPlus
extern const u8 gText_OptionMatchCalls[];   //optionsPlus
...
extern const u8 gText_MainMenuContinue1[];
...
extern const u8 gText_BirchInOP[];
...
extern const u8 gText_EVO_SEASONAL[];
...
extern const u8 gText_WonderTrade[];
extern const u8 gText_About[];
...
extern const u8 gText_EXPS[];
extern const u8 gText_EXPM[];
extern const u8 gText_EXPL[];
extern const u8 gText_EXPXL[];
...
extern const u8 gText_EnterSpotlightTicket[];
...
extern const u8 gText_MenuBox[];

// Teleport Service
extern const u8 gText_TPLittleroot[];
extern const u8 gText_TPOldale[];
extern const u8 gText_TPPetalburg[];
extern const u8 gText_TPRustboro[];
extern const u8 gText_TPDewford[];
extern const u8 gText_TPSlateport[];
extern const u8 gText_TPMauville[];
extern const u8 gText_TPFortree[];
extern const u8 gText_TPLilycove[];
extern const u8 gText_TPMossdeep[];
extern const u8 gText_TPSootopolis[];
extern const u8 gText_TPLavaridge[];
extern const u8 gText_TPPacifidlog[];
extern const u8 gText_TPEvergrande[];
extern const u8 gText_TPVerdanturf[];
extern const u8 gText_TPFallarbor[];
