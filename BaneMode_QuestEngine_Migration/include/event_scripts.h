...
extern const u8 EventScript_FollowerMsg[];
...
extern const u8 EventScript_CheckDewfordBadge[];
extern const u8 EventScript_UpdateMessage[];
extern const u8 EventScript_AboutMessage[];
extern const u8 EventScript_clearflag[];
extern const u8 EventScript_MaxStats[];

// Follower Pokemon
extern const u8 EventScript_PkmnDoesntWantToComeOut[];
...
extern const u8 EventScript_Box[];
extern const u8 EventScript_TestSignpostMsg[];
...
// Spotlight
extern const u8 EventScript_Spotlight[];

extern const u8 EventScript_Softlock[];
