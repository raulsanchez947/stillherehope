...
SRC = Path("/Users/ivan/Downloads/Paul Sprite.png")
CLEAN = ROOT / "paul_clean.png"
INDEXED = ROOT / "paul_indexed.png"
FINAL = ROOT / "paul_final.png"
DEST = ROOT / "graphics/object_events/pics/people/paul.png"
...
def main() -> None:
    ...
    # Row order in Paul's sheet (same layout as custom character sheet):
    # row 0 = east, row 1 = west, row 2 = front/south, row 3 = back/north
    ordered_rows = [
        rows[2],  # walk south
        rows[3],  # walk north
        rows[1],  # walk west
    ...
    print(f"paul_clean={CLEAN}")
    print(f"paul_indexed={INDEXED}")
    print(f"paul_final={FINAL}")
    print(f"paul_dest={DEST}")
