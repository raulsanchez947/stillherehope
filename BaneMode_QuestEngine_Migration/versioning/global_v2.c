...
#line 1058 "include/constants/pokedex.h"
enum {
    HOENN_DEX_NONE,
    HOENN_DEX_TREECKO,
    HOENN_DEX_GROVYLE,
...
#line 278 "include/global.fieldmap.h"
enum
{
    ACRO_BIKE_NORMAL,
    ACRO_BIKE_TURNING,
...
extern const struct Fusion *const gFusionTablePointers[1010 + 360 + 1];
...
extern const u16 *const gFormSpeciesIdTables[1010 + 360 + 1];
extern const struct FormChange *const gFormChangeTablePointers[1010 + 360 + 1];
extern const u32 sExpCandyExperienceTable[];
extern const u16 gEvolutionLines[1010 + 360 + 1][22];
...
struct SaveBlock1
{
      ...
      u8 dexSeen[((((NATIONAL_DEX_OGERPON + 1)) / (8)) + ((((NATIONAL_DEX_OGERPON + 1)) % (8)) ? 1 : 0))];
      u8 dexCaught[((((NATIONAL_DEX_OGERPON + 1)) / (8)) + ((((NATIONAL_DEX_OGERPON + 1)) % (8)) ? 1 : 0))];
      ...
      struct WaldaPhrase waldaPhrase;
               u8 dexNavSearchLevels[1010 + 360 + 1];
               u8 dexNavChain;
