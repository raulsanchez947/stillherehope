...
static void AddBaneModeItemRange(u16 firstItem, u16 lastItem, u16 count);
static void AddBaneModeFreshGameBundle(void);
...
static void AddBaneModeItemRange(u16 firstItem, u16 lastItem, u16 count)
{
    ...
    for (itemId = firstItem; itemId <= lastItem; itemId++)
...
static void AddBaneModeFreshGameBundle(void)
{
    ...
    AddBagItem(ITEM_ABILITY_CAPSULE, 99);
    AddBagItem(ITEM_ABILITY_PATCH, 99);
    AddBagItem(ITEM_GALARICA_CUFF, 99);
    AddBagItem(ITEM_GALARICA_WREATH, 99);
    AddBagItem(ITEM_LINKING_CORD, 99);
    AddBagItem(ITEM_BLACK_AUGURITE, 99);
    AddBagItem(ITEM_METAL_COAT, 99);
    AddBagItem(ITEM_KINGS_ROCK, 99);
    AddBagItem(ITEM_DRAGON_SCALE, 99);
    AddBagItem(ITEM_PROTECTOR, 99);
    ...
    AddBagItem(ITEM_PRISM_SCALE, 99);
    ...
    AddBagItem(ITEM_PEAT_BLOCK, 99);
    AddBagItem(ITEM_SWEET_APPLE, 99);
    AddBagItem(ITEM_TART_APPLE, 99);
    AddBagItem(ITEM_SYRUPY_APPLE, 99);
    AddBagItem(ITEM_CRACKED_POT, 99);
    AddBagItem(ITEM_CHIPPED_POT, 99);
    AddBagItem(ITEM_UNREMARKABLE_TEACUP, 99);
    AddBagItem(ITEM_MASTERPIECE_TEACUP, 99);
    AddBagItem(ITEM_AUSPICIOUS_ARMOR, 99);
    AddBagItem(ITEM_MALICIOUS_ARMOR, 99);
    AddBagItem(ITEM_LEADERS_CREST, 99);
    AddBagItem(ITEM_SCROLL_OF_DARKNESS, 99);
    AddBagItem(ITEM_SCROLL_OF_WATERS, 99);

    AddBagItem(ITEM_POKE_BALL, 99);
    AddBagItem(ITEM_GREAT_BALL, 99);
    AddBagItem(ITEM_ULTRA_BALL, 99);
    AddBagItem(ITEM_REPEAT_BALL, 99);
    AddBagItem(ITEM_QUICK_BALL, 99);
    AddBagItem(ITEM_DUSK_BALL, 99);
    AddBagItem(ITEM_TIMER_BALL, 99);
    AddBagItem(ITEM_LUXURY_BALL, 99);
    AddBagItem(ITEM_HEAL_BALL, 99);
    AddBagItem(ITEM_DIVE_BALL, 99);
    AddBagItem(ITEM_NEST_BALL, 99);
    AddBagItem(ITEM_NET_BALL, 99);

    AddBaneModeItemRange(FIRST_BERRY_INDEX, LAST_BERRY_INDEX, 99);
    AddBaneModeItemRange(ITEM_HP_UP, ITEM_PP_MAX, 99);
    AddBaneModeItemRange(ITEM_HEALTH_FEATHER, ITEM_SWIFT_FEATHER, 99);

    AddBagItem(ITEM_LONELY_MINT, 99);
    AddBagItem(ITEM_ADAMANT_MINT, 99);
    AddBagItem(ITEM_MODEST_MINT, 99);
    AddBagItem(ITEM_JOLLY_MINT, 99);
    AddBagItem(ITEM_TIMID_MINT, 99);
    AddBagItem(ITEM_BOLD_MINT, 99);
    AddBagItem(ITEM_CALM_MINT, 99);
    AddBagItem(ITEM_IMPISH_MINT, 99);
    AddBagItem(ITEM_CAREFUL_MINT, 99);
    AddBagItem(ITEM_SERIOUS_MINT, 99);
    ...
    AddBagItem(ITEM_LIFE_ORB, 99);
    AddBagItem(ITEM_FOCUS_SASH, 99);
    AddBagItem(ITEM_BLACK_SLUDGE, 99);
    AddBagItem(ITEM_EVIOLITE, 99);
    AddBagItem(ITEM_ASSAULT_VEST, 99);
    AddBagItem(ITEM_SAFETY_GOGGLES, 99);
    AddBagItem(ITEM_PROTECTIVE_PADS, 99);
