...
extern const u8 MtChimney_EventScript_GiovanniTrainer[];
extern const u8 MtChimney_EventScript_RocketAdminTrainer[];
...
const u16 gBattleFrontierHeldItems[] =
{
    ...
    [BATTLE_FRONTIER_ITEM_DRAGON_GEM]    = ITEM_DRAGON_GEM,
    [BATTLE_FRONTIER_ITEM_NORMAL_GEM]    = ITEM_NORMAL_GEM,
    [BATTLE_FRONTIER_ITEM_FIRE_GEM]      = ITEM_FIRE_GEM,
    [BATTLE_FRONTIER_ITEM_WATER_GEM]     = ITEM_WATER_GEM,
    [BATTLE_FRONTIER_ITEM_ELECTRIC_GEM]  = ITEM_ELECTRIC_GEM,
    [BATTLE_FRONTIER_ITEM_GRASS_GEM]     = ITEM_GRASS_GEM,
    [BATTLE_FRONTIER_ITEM_ICE_GEM]       = ITEM_ICE_GEM,
    [BATTLE_FRONTIER_ITEM_FIGHTING_GEM]  = ITEM_FIGHTING_GEM,
    [BATTLE_FRONTIER_ITEM_POISON_GEM]    = ITEM_POISON_GEM,
    [BATTLE_FRONTIER_ITEM_GROUND_GEM]    = ITEM_GROUND_GEM,
    [BATTLE_FRONTIER_ITEM_FLYING_GEM]    = ITEM_FLYING_GEM,
    [BATTLE_FRONTIER_ITEM_PSYCHIC_GEM]   = ITEM_PSYCHIC_GEM,
    [BATTLE_FRONTIER_ITEM_BUG_GEM]       = ITEM_BUG_GEM,
    [BATTLE_FRONTIER_ITEM_ROCK_GEM]      = ITEM_ROCK_GEM,
    [BATTLE_FRONTIER_ITEM_GHOST_GEM]     = ITEM_GHOST_GEM,
    [BATTLE_FRONTIER_ITEM_DARK_GEM]      = ITEM_DARK_GEM,
    [BATTLE_FRONTIER_ITEM_STEEL_GEM]     = ITEM_STEEL_GEM,
...
void DoSpecialTrainerBattle(void)
{
    ...
    case SPECIAL_BATTLE_STEVEN:
        ...
        break;
    case SPECIAL_BATTLE_MT_CHIMNEY_STEVEN:
        gBattleTypeFlags = BATTLE_TYPE_TRAINER | BATTLE_TYPE_DOUBLE | BATTLE_TYPE_TWO_OPPONENTS | BATTLE_TYPE_MULTI | BATTLE_TYPE_INGAME_PARTNER;
        FillPartnerParty(TRAINER_STEVEN_PARTNER);
        gApproachingTrainerId = 0;
        BattleSetup_ConfigureTrainerBattle(MtChimney_EventScript_GiovanniTrainer + 1);
        gApproachingTrainerId = 1;
        BattleSetup_ConfigureTrainerBattle(MtChimney_EventScript_RocketAdminTrainer + 1);
        gPartnerTrainerId = TRAINER_STEVEN_PARTNER;
        CreateTask(Task_StartBattleAfterTransition, 1);
        PlayMapChosenOrBattleBGM(0);
        BattleTransition_StartOnField(B_TRANSITION_MAGMA);
...
static void AwardBattleTowerRibbons(void)
{
    ...
    if (gSpecialVar_Result)
    {
        ...
        #ifndef NDEBUG
        MgbaPrintf(MGBA_LOG_DEBUG, "ribbon recived +5:%d", gSaveBlock2Ptr->playerRank);
        #endif
