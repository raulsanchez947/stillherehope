...
void GetCurrentDateAndTime(void)
{
    ...
    VarSet(VAR_UNUSED_0x40FC, day);
    VarSet(VAR_UNUSED_0x40FE, month);
    VarSet(VAR_UNUSED_0x40FF, year);
    VarSet(VAR_GIFT_UNUSED_7, hours);
...
u16 ReturnSpotlightMonIndex(void)
{
    ...
    DAY = VarGet(VAR_UNUSED_0x40FC);
    MONTH = VarGet(VAR_UNUSED_0x40FE);
    YEAR = VarGet(VAR_UNUSED_0x40FF) - 2000;
    HOUR = VarGet(VAR_GIFT_UNUSED_7);
