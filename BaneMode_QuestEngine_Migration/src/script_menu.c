...
static void CreatePCMultichoice(void)
{
    static const u8 sText_BaneModePC[] = _("Bane Mode");
    u8 x = 8;
    u32 pixelWidth = 0;
    u8 width;
    u8 numChoices;
    ...
    pixelWidth = DisplayTextAndGetWidth(sText_BaneModePC, pixelWidth);
    ...
    if (FlagGet(FLAG_SYS_GAME_CLEAR))
    {
        ...
        SetStandardWindowBorderStyle(windowId, FALSE);
        AddTextPrinterParameterized(windowId, FONT_NORMAL, sText_BaneModePC, x, 33, TEXT_SKIP_DRAW, NULL);
...
static const struct ListMenuItem sSet1[] =
{
    {gText_Exit, 0},
    {gText_TPFallarbor, 1},
    {gText_TPVerdanturf, 2},
    {gText_TPEvergrande, 3},
    {gText_TPPacifidlog, 4},
    {gText_TPSootopolis, 5},
    {gText_TPMossdeep, 6},
    {gText_TPLilycove, 7},
    {gText_TPFortree, 8},
    {gText_TPLavaridge, 9},
    {gText_TPMauville, 10},
    {gText_TPSlateport, 11},
    {gText_TPDewford, 12},
    {gText_TPRustboro, 13},
    {gText_TPPetalburg, 14},
    {gText_TPOldale, 15},
    {gText_TPLittleroot, 16},
};

static const struct ListMenuItem sSet2[] = 
{
    {gText_TPLittleroot, 0},
    {gText_TPOldale, 1},
    {gText_TPPetalburg, 2},
    {gText_TPRustboro, 3},
    {gText_TPDewford, 4},
    ...
    {gText_TPLilycove, 9},
    {gText_TPMossdeep, 10},
    {gText_TPSootopolis, 11},
    {gText_TPPacifidlog, 12},
    {gText_TPEvergrande, 13},
    {gText_TPVerdanturf, 14},
    {gText_TPFallarbor, 15},
    {gText_Exit, 16},
};
...
static const struct ListMenuItem sSet3[] =
{
    {gText_Exit, 0},
    {gText_OldAmber, 1},
    {gText_FossilizedDrake, 2},
    {gText_FossilizedDino, 3},
    {gText_SkullFossil, 4},
    {gText_SailFossil, 5},
    {gText_PlumeFossil, 6},
    {gText_JawFossil, 7},
    {gText_DomeFossil, 8},
    {gText_CoverFossil, 9},
    {gText_ArmorFossil, 10},
    {gText_HelixFossil, 11},
    {gText_RootFossil, 12},
    {gText_ClawFossil, 13},
};
...
static const struct ListMenuItem sSet4[] =
{
    ...
    {gText_SailFossil, 8},
    {gText_SkullFossil, 9},
    {gText_FossilizedDino, 10},
    {gText_FossilizedDrake, 11},
    {gText_OldAmber, 12},
    {gText_Exit, 13},
};
