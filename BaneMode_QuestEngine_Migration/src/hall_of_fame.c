...
static const u8 sText_Normal[]  = _("{COLOR BLUE}NORMAL");
static const u8 sText_Hard[]    = _("{COLOR LIGHT_RED}HARD");
static const u8 sText_Easy[]    = _("{COLOR GREEN}EASY");
static const u8 sText_Extreme[]    = _("{COLOR RED}EXTREME");
static const u8 gText_Diff[] = _("Difficulty");
static const u8 gText_GameMode[] = _("Mode");
const u8 sText_OpenWorld[] = _("{COLOR GREEN}OPEN WORLD");
const u8 sText_StoryMode[] = _("{COLOR GREEN}STORY MODE");
static const u8 sText_Rank[] = _("Rank");
static const u8 sText_RankPoints[] = _("");
static const u8 sText_LevelCap[] = _("Level Cap");
static const u8 sText_Off[] =_("OFF");
static const u8 sText_Nuzlocke[] = _("Nuzlocke");
static const u8 sText_Quest[] =_("{COLOR RED}METRONOME ONLY MODE");
static const u8 sText_Btotatl[] = _("Total Battles");
static const u8 sText_Bwon[] = _("Battles Won");
static void HallOfFame_PrintPlayerInfo(u8 unused1, u8 unused2)
{
    u8 text[20];
    u32 width;
    u16 trainerId;
    unused1 = GetGameDifficulty();
    unused2 = CheckPlayerRank();
    ...
    if (FlagGet(FLAG_OPEN_WORLD)) {
        AddTextPrinterParameterized3(1, FONT_NORMAL, 0, 0x21, sPlayerInfoTextColors, TEXT_SKIP_DRAW, gText_GameMode);

        width = GetStringRightAlignXOffset(FONT_NORMAL, sText_OpenWorld, 0x70);
        AddTextPrinterParameterized3(1, FONT_NORMAL, width, 0x21, sPlayerInfoTextColors, TEXT_SKIP_DRAW, sText_OpenWorld);
    } else {
        AddTextPrinterParameterized3(1, FONT_NORMAL, 0, 0x21, sPlayerInfoTextColors, TEXT_SKIP_DRAW, gText_GameMode);

        width = GetStringRightAlignXOffset(FONT_NORMAL, sText_StoryMode, 0x70);
        AddTextPrinterParameterized3(1, FONT_NORMAL, width, 0x21, sPlayerInfoTextColors, TEXT_SKIP_DRAW, sText_StoryMode);
    }
    if (unused1 == NORMAL) {
        AddTextPrinterParameterized3(1, FONT_NORMAL, 0, 0x31, sPlayerInfoTextColors, TEXT_SKIP_DRAW, gText_Diff);

        width = GetStringRightAlignXOffset(FONT_NORMAL, sText_Normal, 0x70);
        AddTextPrinterParameterized3(1, FONT_NORMAL, width, 0x31, sPlayerInfoTextColors, TEXT_SKIP_DRAW, sText_Normal);
    }
    else if (unused1 == HARD) {
        AddTextPrinterParameterized3(1, FONT_NORMAL, 0, 0x31, sPlayerInfoTextColors, TEXT_SKIP_DRAW, gText_Diff);

        width = GetStringRightAlignXOffset(FONT_NORMAL, sText_Hard, 0x70);
        AddTextPrinterParameterized3(1, FONT_NORMAL, width, 0x31, sPlayerInfoTextColors, TEXT_SKIP_DRAW, sText_Hard);
    }
    else if (unused1 == EASY) {
        AddTextPrinterParameterized3(1, FONT_NORMAL, 0, 0x31, sPlayerInfoTextColors, TEXT_SKIP_DRAW, gText_Diff);
        width = GetStringRightAlignXOffset(FONT_NORMAL, sText_Easy, 0x70);
        AddTextPrinterParameterized3(1, FONT_NORMAL, width, 0x31, sPlayerInfoTextColors, TEXT_SKIP_DRAW, sText_Easy);
    }
    else if (unused1 == EXTREME) {
        AddTextPrinterParameterized3(1, FONT_NORMAL, 0, 0x31, sPlayerInfoTextColors, TEXT_SKIP_DRAW, gText_Diff);
        width = GetStringRightAlignXOffset(FONT_NORMAL, sText_Extreme, 0x70);
        AddTextPrinterParameterized3(1, FONT_NORMAL, width, 0x31, sPlayerInfoTextColors, TEXT_SKIP_DRAW, sText_Extreme);
    }

    if (unused2 == ROOKIE) {
        AddTextPrinterParameterized3(1, FONT_NORMAL, 0, 0x41, sPlayerInfoTextColors, TEXT_SKIP_DRAW, sText_Rank);
        width = GetStringRightAlignXOffset(FONT_NORMAL, gText_Rookie, 0x70);
        AddTextPrinterParameterized3(1, FONT_NORMAL, width, 0x41, sPlayerInfoTextColors, TEXT_SKIP_DRAW, gText_Rookie);     
    }
    else if (unused2 == ADVENTURER) {
        AddTextPrinterParameterized3(1, FONT_NORMAL, 0, 0x41, sPlayerInfoTextColors, TEXT_SKIP_DRAW, sText_Rank);
        width = GetStringRightAlignXOffset(FONT_NORMAL, gText_Adventurer, 0x70);
        AddTextPrinterParameterized3(1, FONT_NORMAL, width, 0x41, sPlayerInfoTextColors, TEXT_SKIP_DRAW, gText_Adventurer);
    } 
    else if (unused2 == ELITE) {
        AddTextPrinterParameterized3(1, FONT_NORMAL, 0, 0x41, sPlayerInfoTextColors, TEXT_SKIP_DRAW, sText_Rank);
        width = GetStringRightAlignXOffset(FONT_NORMAL, gText_Elite, 0x70);
        AddTextPrinterParameterized3(1, FONT_NORMAL, width, 0x41, sPlayerInfoTextColors, TEXT_SKIP_DRAW, gText_Elite);
    }
    else if (unused2 == CHAMPION) {
        AddTextPrinterParameterized3(1, FONT_NORMAL, 0, 0x41, sPlayerInfoTextColors, TEXT_SKIP_DRAW, sText_Rank);
        width = GetStringRightAlignXOffset(FONT_NORMAL, gText_Champion, 0x70);
        AddTextPrinterParameterized3(1, FONT_NORMAL, width, 0x41, sPlayerInfoTextColors, TEXT_SKIP_DRAW, gText_Champion);
    }
    else if (unused2 == MASTER) {
        AddTextPrinterParameterized3(1, FONT_NORMAL, 0, 0x41, sPlayerInfoTextColors, TEXT_SKIP_DRAW, sText_Rank);
        width = GetStringRightAlignXOffset(FONT_NORMAL, gText_Master, 0x70);
        AddTextPrinterParameterized3(1, FONT_NORMAL, width, 0x41, sPlayerInfoTextColors, TEXT_SKIP_DRAW, gText_Master);
    }
    else if (unused2 == LEGEND) {
        AddTextPrinterParameterized3(1, FONT_NORMAL, 0, 0x41, sPlayerInfoTextColors, TEXT_SKIP_DRAW, sText_Rank);
        width = GetStringRightAlignXOffset(FONT_NORMAL, gText_Legend, 0x70);
        AddTextPrinterParameterized3(1, FONT_NORMAL, width, 0x41, sPlayerInfoTextColors, TEXT_SKIP_DRAW, gText_Legend);
    }

    if (gSaveBlock1Ptr->MeteronomeOnlyMode == 1) {
        AddTextPrinterParameterized3(1, FONT_NORMAL, 120, 0x1, sPlayerInfoTextColors, TEXT_SKIP_DRAW, sText_RankPoints);
        width = GetStringRightAlignXOffset(FONT_NORMAL, sText_Quest, 224);
        AddTextPrinterParameterized3(1, FONT_NORMAL, width, 0x1, sPlayerInfoTextColors, TEXT_SKIP_DRAW, sText_Quest);
    }

    if (gSaveBlock1Ptr->tx_Challenges_LevelCap == 0) {
        AddTextPrinterParameterized3(1, FONT_NORMAL, 120, 0x11, sPlayerInfoTextColors, TEXT_SKIP_DRAW, sText_LevelCap);
        width = GetStringRightAlignXOffset(FONT_NORMAL, sText_Off, 224);
        AddTextPrinterParameterized3(1, FONT_NORMAL, width, 0x11, sPlayerInfoTextColors, TEXT_SKIP_DRAW, sText_Off);
    } else if (gSaveBlock1Ptr->tx_Challenges_LevelCap == 1) {
        AddTextPrinterParameterized3(1, FONT_NORMAL, 120, 0x11, sPlayerInfoTextColors, TEXT_SKIP_DRAW, sText_LevelCap);
        width = GetStringRightAlignXOffset(FONT_NORMAL, sText_Normal, 224);
        AddTextPrinterParameterized3(1, FONT_NORMAL, width, 0x11, sPlayerInfoTextColors, TEXT_SKIP_DRAW, sText_Normal);
    } else if (gSaveBlock1Ptr->tx_Challenges_LevelCap == 2) {
        AddTextPrinterParameterized3(1, FONT_NORMAL, 120, 0x11, sPlayerInfoTextColors, TEXT_SKIP_DRAW, sText_LevelCap);
        width = GetStringRightAlignXOffset(FONT_NORMAL, sText_Hard, 224);
        AddTextPrinterParameterized3(1, FONT_NORMAL, width, 0x11, sPlayerInfoTextColors, TEXT_SKIP_DRAW, sText_Hard);
    }
    
    if (gSaveBlock1Ptr->tx_Challenges_NuzlockeHardcore) {
        AddTextPrinterParameterized3(1, FONT_NORMAL, 120, 0x21, sPlayerInfoTextColors, TEXT_SKIP_DRAW, sText_Nuzlocke);
        width = GetStringRightAlignXOffset(FONT_NORMAL, sText_Hard, 224);
        AddTextPrinterParameterized3(1, FONT_NORMAL, width, 0x21, sPlayerInfoTextColors, TEXT_SKIP_DRAW, sText_Hard);
    } else if (gSaveBlock1Ptr->tx_Challenges_Nuzlocke) {
        AddTextPrinterParameterized3(1, FONT_NORMAL, 120, 0x21, sPlayerInfoTextColors, TEXT_SKIP_DRAW, sText_Nuzlocke);
        width = GetStringRightAlignXOffset(FONT_NORMAL, sText_Normal, 224);
        AddTextPrinterParameterized3(1, FONT_NORMAL, width, 0x21, sPlayerInfoTextColors, TEXT_SKIP_DRAW, sText_Normal);
    }
    
    gSpecialVar_0x8000 = GetGameStat(GAME_STAT_TRAINER_BATTLES);
    ConvertIntToDecimalStringN(gStringVar3, gSpecialVar_0x8000, STR_CONV_MODE_RIGHT_ALIGN,  10);
    AddTextPrinterParameterized3(1, FONT_NORMAL, 120, 0x31, sPlayerInfoTextColors, TEXT_SKIP_DRAW, sText_Btotatl);
    width = GetStringRightAlignXOffset(FONT_NORMAL, gStringVar3, 224);
    AddTextPrinterParameterized3(1, FONT_NORMAL, width, 0x31, sPlayerInfoTextColors, TEXT_SKIP_DRAW, gStringVar3);
    
    gSpecialVar_0x8000 -= gSaveBlock2Ptr->Blost; 
    AddTextPrinterParameterized3(1, FONT_NORMAL, 120, 0x41, sPlayerInfoTextColors, TEXT_SKIP_DRAW, sText_Bwon);
    ConvertIntToDecimalStringN(gStringVar2, gSpecialVar_0x8000, STR_CONV_MODE_RIGHT_ALIGN, 5);
    width = GetStringRightAlignXOffset(FONT_NORMAL, gStringVar2, 224);
    AddTextPrinterParameterized3(1, FONT_NORMAL, width, 0x41, sPlayerInfoTextColors, TEXT_SKIP_DRAW, gStringVar2);

    AddTextPrinterParameterized3(1, FONT_NORMAL, 120, 0x51, sPlayerInfoTextColors, TEXT_SKIP_DRAW, gText_Blost);
    ConvertIntToDecimalStringN(gStringVar1, gSaveBlock2Ptr->Blost, STR_CONV_MODE_RIGHT_ALIGN, 5);
    width = GetStringRightAlignXOffset(FONT_NORMAL, gStringVar1, 224);
    AddTextPrinterParameterized3(1, FONT_NORMAL, width, 0x51, sPlayerInfoTextColors, TEXT_SKIP_DRAW, gStringVar1);

    AddTextPrinterParameterized3(1, FONT_NORMAL, 0, 0x51, sPlayerInfoTextColors, TEXT_SKIP_DRAW, gText_Time);
    ...
    width = GetStringRightAlignXOffset(FONT_NORMAL, text, 0x70);
    AddTextPrinterParameterized3(1, FONT_NORMAL, width, 0x51, sPlayerInfoTextColors, TEXT_SKIP_DRAW, text);
