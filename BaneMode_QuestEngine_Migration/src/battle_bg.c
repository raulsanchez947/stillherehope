...
static const struct WindowTemplate sStandardBattleWindowTemplates[] =
{
    ...
    [B_WIN_MOVE_NAME_1] = {
        ...
        .tilemapLeft = 2,
        .tilemapTop = 55,
        .width = 8,    //It "overflows" into B_WIN_MOVE_NAME_2 hence the occasional flickering with the original width of 16
        .height = 2,
        .paletteNum = 5,
        .baseBlock = 0x0300,
    },
    ...
    [B_WIN_ZMOVE] = {       // New window for Z-moves
        .bg = 0,
        .tilemapLeft = 2,
        .tilemapTop = 55,
        .width = 16,
...
const struct BattleBackground sBattleTerrainTable[] =
{
    [BATTLE_TERRAIN_GRASS] =
    {
        ...
        .palette_fall = gBattleTerrainPalette_TallGrass_Fall,
        .palette_winter = gBattleTerrainPalette_TallGrass_Winter,
        .palette_spring = gBattleTerrainPalette_TallGrass_Spring,
    },
    ...
    [BATTLE_TERRAIN_LONG_GRASS] =
    {
        ...
        .palette_fall = gBattleTerrainPalette_LongGrass_Fall,
        .palette_winter = gBattleTerrainPalette_LongGrass_Winter,
        .palette_spring = gBattleTerrainPalette_LongGrass_Spring,
    },
...
static const u32 *GetSeasonalBattleTerrainPalette(void)
{
    if (!FlagGet(FLAG_SEASONS) || (gBattleTerrain != BATTLE_TERRAIN_GRASS && gBattleTerrain != BATTLE_TERRAIN_LONG_GRASS && gBattleTerrain != BATTLE_TERRAIN_PLAIN))
    ...
    case 0:
        return sBattleTerrainTable[gBattleTerrain].palette;
    case 1:
        return sBattleTerrainTable[gBattleTerrain].palette_fall;
    case 2:
        return sBattleTerrainTable[gBattleTerrain].palette_winter;
    case 3:
        return sBattleTerrainTable[gBattleTerrain].palette_spring;
    default:
        return sBattleTerrainTable[gBattleTerrain].palette;
    }
}
...
void DrawMainBattleBackground(void)
{
    ...
    else
    {
        ...
        case MAP_BATTLE_SCENE_NORMAL:
            ...
            GetCurrentSeason();
            LoadCompressedPalette(GetSeasonalBattleTerrainPalette(), BG_PLTT_ID(2), 3 * PLTT_SIZE_4BPP);
            break;
