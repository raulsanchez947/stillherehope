...
const u8 gText_MainMenuContinue[] = _("CONTINUE                                  {COLOR GREEN}STORY MODE");
const u8 gText_MainMenuContinue1[] = _("CONTINUE                                 {COLOR GREEN}OPEN WORLD");
...
const u8 gText_ZCrystalsPocket[] = _("Battle Gear");
...
const u8 gText_WonderTrade[] = _("WONDER TRADE");
const u8 gText_About[] =_("VERSION 1.0.F");
...
const u8 gText_EXPS[] = _("Exp.Candy S   500 COINS");
const u8 gText_EXPM[] = _("Exp.Candy M   1,500 COINS");
const u8 gText_EXPL[] = _("Exp.Candy L   2,000 COINS");
const u8 gText_EXPXL[] = _("Exp.Candy XL 3,500 COINS");
...
const u8 gText_ZCrystals[] = _("Battle Gear");
...
const u8 gText_CallRegisteredTrainer[] = _("Check the BURNER.");
const u8 gText_CheckObtainedRibbons[] = _("Check obtained RIBBONS.");
const u8 gText_PutAwayPokenav[] = _("Put away the BURNER.");
...
const u8 gText_ReturnToPokenavMenu[] = _("Return to the BURNER menu.");
...
const u8 gText_NumberRegistered[] = _("Blocked nos.");
const u8 gText_NumberOfBattles[] = _("Street beefs");
...
const u8 gText_TrainerCloseBy[] = _("This number is blocked!");
...
const u8 gText_Var1sTrainerCard[] = _("Difficulty: {STR_VAR_2}");
...
const u8 gText_Font[] = _("FONT");  //optionsPlus
const u8 gText_OptionMatchCalls[] = _("OVERWORLD CALLS");    //optionsPlus
...
const u8 gText_UnitSystemMetric[] = _("METRIC");       //optionsPlus
const u8 gText_UnitSystemImperial[] = _("IMPERIAL");   //optionsPlus
const u8 gText_OptionFontEmerald[] = _("EMERALD");    //optionsPlus
const u8 gText_OptionFontFireRed[] = _("FRLG");        //optionsPlus
...
const u8 gText_MenuPokenav[] = _("BURNER");
...
const u8 gText_NumberBlocked[] = _("This number is blocked!");
...
const u8 gText_EnterCode[] = _("Enter Mystery Gift Code");
const u8 gText_EnterSeed[] = _("Enter Multi-Player Seed");
const u8 gText_EnterSpotlightTicket[] = _("Enter Ticket Id");
...
const u8 gText_ScottMatchCallDesc[] = _("BKLYN WATCH");
const u8 gText_ScottMatchCallName[] = _("BRENDAN");
...
const u8 gText_EVO_SEASONAL[] = _("{LV}{UP_ARROW}, during {STR_VAR_2} season");
...
//// side quest data
//generic strings
const u8 gText_QuestAnnounce[] = _("The quest {COLOR DARK_GRAY}'{STR_VAR_1}'\nis now {STR_VAR_2}.");
const u8 gText_QuestComplete[] =_("complete");
const u8 gText_QuestActive[] =_("active");

//names
const u8 gText_SideQuestName_1[] = _("{COLOR BLUE}The Rare POKéMON{COLOR DARK_GRAY}");
const u8 gText_SideQuestName_2[] = _("{COLOR BLUE}The Berry Hunt{COLOR DARK_GRAY}");
const u8 gText_SideQuestName_3[] = _("{COLOR BLUE}Catch 'Em All{COLOR DARK_GRAY}");
const u8 gText_SideQuestName_4[] = _("{COLOR BLUE}The Looming Crisis{COLOR DARK_GRAY}");
const u8 gText_SideQuestName_5[] = _("{COLOR BLUE} Soar Through The Skies");
...
//descriptions
const u8 gText_SideQuestDesc_1[] = _("Catch a MUDKIP which can\nbe found lurking on route 103.");
const u8 gText_SideQuestDesc_2[] = _("Find the Lum Berry to cure SKITTY.");
const u8 gText_SideQuestDesc_3[] = _("Catch 90 Pokemon to complete\nMr. Sea's challenge.");
const u8 gText_SideQuestDesc_4[] = _("Defeat the Pokemon causing trouble\ninside the safri zone.");
const u8 gText_SideQuestDesc_5[] = _("Find/Catch a Hisuian Braviary.");
...
const u8 gText_SideQuestDoneDesc_1[] = _("You found the rare POKéMON.");
const u8 gText_SideQuestDoneDesc_2[] = _("SKITTY is all cured thanks to you.");
const u8 gText_SideQuestDoneDesc_3[] = _("You completed Mr. Sea's challenge.");
const u8 gText_SideQuestDoneDesc_4[] = _("You defeated the wild Pokemon.");
const u8 gText_SideQuestDoneDesc_5[] = _("You can now soar through the skies.");
...
//map
const u8 gText_SideQuestMap1[] = _("Oldale Town");
const u8 gText_SideQuestMap2[] = _("Pretty Petal Flower Shop");
const u8 gText_SideQuestMap3[] = _("Seashore House");
const u8 gText_SideQuestMap4[] = _("Safari Zone");
const u8 gText_SideQuestMap5[] = _("Lilycove City");
...
const u8 gText_SubQuest1_Desc1[] = _("Desctiption sub 1");
...
// Teleport Service
const u8 gText_TPLittleroot[] =_("Littleroot Town");
const u8 gText_TPOldale[] =_("Oldale Town");
const u8 gText_TPPetalburg[] =_("Petalburg City");
const u8 gText_TPRustboro[] =_("Rustboro City");
const u8 gText_TPDewford[] =_("Dewford Town");
const u8 gText_TPSlateport[] =_("Slateport City");
const u8 gText_TPMauville[] =_("Mauville City");
const u8 gText_TPFortree[] =_("Fortree City");
const u8 gText_TPMossdeep[] =_("Mossdeep City");
const u8 gText_TPLilycove[] =_("Lilycove City");
const u8 gText_TPSootopolis[] =_("Sootopolis City");
const u8 gText_TPLavaridge[] =_("Lavaridge Town");
const u8 gText_TPEvergrande[] =_("EverGrande City");
const u8 gText_TPPacifidlog[] =_("Pacifidlog Town");
const u8 gText_TPVerdanturf[] =_("Verdanturf Town");
const u8 gText_TPFallarbor[] =_("Fallarbor Town");
...
const u8 gText_GoldBottleCap[] = _("GOLD BOTTLE CAP");
...
const u8 gText_SaveFileOldUpdated[] = _("Update Successful!\pversion: 1.0.F");
const u8 gText_SaveFileOldErrored[] = _("Update Failed!\pyour save file is outdated!");
const u8 gText_SaveFileTooNew[] = _("Update Failed!\pyour save file is for a newer version.");
