...
static const u16 sRotatingBallFemale_Pal[] = INCBIN_U16("graphics/bag/rotating_ball_female.gbapal");
...
static const union AnimCmd *const sBagSpriteAnimTable[] =
{
    ...
    [POCKET_Z_CRYSTALS]   = sSpriteAnim_Bag_BattleItems,
...
static const struct SpritePalette sRotatingBallPaletteTableFemale =
{
    sRotatingBallFemale_Pal, TAG_ROTATING_BALL_GFX
};
...
void AddSwitchPocketRotatingBallSprite(s16 rotationDirection)
{
    ...
    LoadSpritePalette(&sRotatingBallPaletteTable);
        ...
        LoadSpritePalette(&sRotatingBallPaletteTableFemale);
    }
