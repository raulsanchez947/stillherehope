...
struct PokedexView
{
    ...
    u8 splitIconSpriteId;  //HGSS_Ui Physical/Special Split
...
//HGSS_UI Physical Special Split icon
...
static void PrintMonInfo(u32 num, u32 value, u32 owned, u32 newEntry)
{
    ...
    PrintInfoScreenTextWhite(name, 160, 17); //HGSS_Ui
    if (owned)
    {
    ...
    for (i = 0; i < times; i++)
    {
        ...
        case EVO_BEAUTY:
            ...
            case EVO_ITEM_HOLD:
                ...
                break;
            case EVO_SEASONAL:
                StringCopy(gStringVar2, gSeasonNames[gEvolutionTable[species][i].param]);
                StringExpandPlaceholders(gStringVar4, gText_EVO_SEASONAL);
                break;
        default:
