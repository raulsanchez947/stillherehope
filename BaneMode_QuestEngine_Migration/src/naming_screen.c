...
static void NamingScreen_CreateGiftManIcon(void);
static void NamingScreen_CreateProfIcon(void);
static void NamingScreen_CreateSafariIcon(void);
...
static void (*const sIconFunctions[])(void) =
{
    ...
    NamingScreen_CreateGiftManIcon,
    NamingScreen_CreateProfIcon,
    NamingScreen_CreateSafariIcon,
};
...
static void NamingScreen_CreateProfIcon(void)
{
    ...
    spriteId = CreateObjectGraphicsSprite(OBJ_EVENT_GFX_PROF_BIRCH, SpriteCallbackDummy, 56, 37, 0);
    gSprites[spriteId].oam.priority = 3;
    StartSpriteAnim(&gSprites[spriteId], ANIM_STD_GO_SOUTH);
}
...
static void NamingScreen_CreateSafariIcon(void)
{
    ...
    spriteId = CreateObjectGraphicsSprite(OBJ_EVENT_GFX_CAMPER, SpriteCallbackDummy, 56, 37, 0);
    gSprites[spriteId].oam.priority = 3;
    StartSpriteAnim(&gSprites[spriteId], ANIM_STD_GO_SOUTH);
}
...
static bool8 KeyboardKeyHandler_Character(u8 input)
{
    ...
    if (input == INPUT_A_BUTTON)
    {
        ...
        if (sNamingScreen ->currentPage == KBPAGE_LETTERS_UPPER && GetTextEntryPosition() == 1) //Make the keyboard auto-switch to lowercase after the first character
            MainState_StartPageSwap();
...
static void (*const sDrawTextEntryBoxFuncs[])(void) =
{
    ...
    [NAMING_SCREEN_GIFT]       = DrawNormalTextEntryBox,
    [NAMING_SCREEN_SEED]       = DrawNormalTextEntryBox,
    [NAMING_SCREEN_SPOTLIGHT]  = DrawNormalTextEntryBox,
};
...
static const struct NamingScreenTemplate sGiftCodeScreenTemplate =
{
    .copyExistingString = FALSE,
    .maxChars = 7,
    .iconFunction = 5,
...
static const struct NamingScreenTemplate sSpotlightScreenTemplate =
{
    .copyExistingString = FALSE,
    .maxChars = 5,
    .iconFunction = 7,
    ...
    .initialPage = KBPAGE_SYMBOLS,
    .unused = 11,
    .title = gText_EnterSpotlightTicket,
};
...
static const struct NamingScreenTemplate *const sNamingScreenTemplates[] =
{
    ...
    [NAMING_SCREEN_GIFT]       = &sGiftCodeScreenTemplate, 
    [NAMING_SCREEN_SEED]       = &sSeedScreenTemplate,
    [NAMING_SCREEN_SPOTLIGHT]  = &sSpotlightScreenTemplate
};
