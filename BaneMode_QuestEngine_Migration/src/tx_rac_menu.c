...
{
    MENUITEM_GAMEMODE,
    MENUITEM_GAMEMODE_STARTLOC,
    MENUITEM_GAMEMODE_DIFFICULTY,
    MENUITEM_GAMEMODE_GEN,
    MENUITEM_GAMEMODE_NEXT,
    MENUITEM_GAMEMODE_COUNT,
};
enum
{
...
enum
{
    ...
    MENUITEM_DIFFICULTY_PERFECT_IVS,
...
enum
{
    ...
    MENUITEM_CHALLENGES_MEGA_EVO,
    MENUITEM_CHALLENGES_ONE_TYPE_CHALLENGE,
    MENUITEM_CHALLENGES_METRONOME_MODE,
...
{
    u8 submenu;
    u8 sel_gamemode[MENUITEM_GAMEMODE_COUNT];
...
static int ProcessInput_Options_Nine(int selectiom);
static int ProcessInput_Options_Eight(int selection);
static int ProcessInput_Options_Ten(int selection);
static int ProcessInput_Options_Eleven(int selection);
static int ProcessInput_OPtions_16(int selection);
...
static void DrawChoices_Gen(int selection, int y);
...
static void DrawChoices_Random_Maps(int selection, int y);
...
static void DrawChoices_Challenges_Perfect_IVs(int selection, int y);

static void DrawChoices_OpenWorld(int selection, int y);
static void DrawChoices_StartLoc(int selection, int y);
static void DrawChoices_Difficulty(int selection, int y);
static void DrawChoices_Starter_Gen(int selection, int y);
static void DrawChoices_Challenges_Gym(int selection, int y);
...
static void DrawChoices_Challenges_MetronomeMode(int selection, int y);
...
static const u16 sOptionMenuBg_Pal[] = {RGB2GBA(114, 189, 125)};
...
struct // MENU_GAMEMODE
{
    void (*drawChoices)(int selection, int y);
    int (*processInput)(int selection);
} static const sItemFunctionsGameMode[MENUITEM_GAMEMODE_COUNT] =
{
    [MENUITEM_GAMEMODE]                         = {DrawChoices_OpenWorld,               ProcessInput_Options_Two},
    [MENUITEM_GAMEMODE_STARTLOC]                = {DrawChoices_StartLoc,                ProcessInput_OPtions_16},
    [MENUITEM_GAMEMODE_DIFFICULTY]              = {DrawChoices_Difficulty,              ProcessInput_Options_Three},
    [MENUITEM_GAMEMODE_GEN]                     = {DrawChoices_Gen,                     ProcessInput_Options_Nine},
    [MENUITEM_GAMEMODE_NEXT]                    = {NULL, NULL},
};
...
} static const sItemFunctionsRandom[MENUITEM_RANDOM_COUNT] =
{
    ...
    [MENUITEM_RANDOM_STARTER]                   = {DrawChoices_Starter_Gen,             ProcessInput_Options_Eleven},
    ...
    [MENUITEM_RANDOM_MAPS]                      = {DrawChoices_Random_Maps,             ProcessInput_Options_Two},
...
} static const sItemFunctionsDifficulty[MENUITEM_DIFFICULTY_COUNT] =
{
    ...
    [MENUITEM_DIFFICULTY_GYM]                   = {DrawChoices_Challenges_Gym,              ProcessInput_Options_Two},
    ...
    [MENUITEM_DIFFICULTY_PERFECT_IVS]           = {DrawChoices_Challenges_Perfect_IVs,       ProcessInput_Options_Two},
...
} static const sItemFunctionsChallenges[MENUITEM_CHALLENGES_COUNT] =
{
    ...
    [MENUITEM_CHALLENGES_MEGA_EVO]              = {DrawChoices_Challenges_MegaEvo,              ProcessInput_Options_Two},
    [MENUITEM_CHALLENGES_ONE_TYPE_CHALLENGE]    = {DrawChoices_Challenges_OneTypeChallenge,     ProcessInput_Options_OneTypeChallenge},
    [MENUITEM_CHALLENGES_METRONOME_MODE]        = {DrawChoices_Challenges_MetronomeMode,        ProcessInput_Options_Two},
...
static const u8 sText_OpenWorld[]           = _("GAME MODE");
static const u8 sText_StartLoc[]            = _("START LOCATION");
static const u8 sText_Difficulty[]          = _("DIFFICULTY");
static const u8 sText_Gen[]                 = _("GENRATION");
static const u8 sText_Next[]                = _("NEXT");
static const u8 *const sOptionMenuItemsNamesGameMode[MENUITEM_GAMEMODE_COUNT] =
{
    [MENUITEM_GAMEMODE]            = sText_OpenWorld,
    [MENUITEM_GAMEMODE_STARTLOC]   = sText_StartLoc,
    [MENUITEM_GAMEMODE_DIFFICULTY] = sText_Difficulty,
    [MENUITEM_GAMEMODE_GEN]          = sText_Gen,
    [MENUITEM_GAMEMODE_NEXT]       = sText_Next,
};
...
static const u8 *const sOptionMenuItemsNamesRandom[MENUITEM_RANDOM_COUNT] =
{
    ...
    [MENUITEM_RANDOM_MAPS]                      = sText_Maps,
...
static const u8 sText_Gym[]                 = _("GYM LIMIT");
...
static const u8 sText_MaxIVs[]              = _("PLAYER IVs");
static const u8 *const sOptionMenuItemsNamesDifficulty[MENUITEM_DIFFICULTY_COUNT] =
{
    ...
    [MENUITEM_DIFFICULTY_GYM]                   = sText_Gym,
    ...
    [MENUITEM_DIFFICULTY_PERFECT_IVS]           = sText_MaxIVs,
...
static const u8 sText_MegaEvo[]             = _("MEGA EVOLUTIONS");
static const u8 sText_OneTypeChallenge[]    = _("ONE TYPE ONLY");
static const u8 sText_MetronomeMode[]       = _("METRONOME ONLY");
...
static const u8 *const sOptionMenuItemsNamesChallenges[MENUITEM_CHALLENGES_COUNT] =
{
    ...
    [MENUITEM_CHALLENGES_MEGA_EVO]              = sText_MegaEvo,
    [MENUITEM_CHALLENGES_ONE_TYPE_CHALLENGE]    = sText_OneTypeChallenge,
    [MENUITEM_CHALLENGES_METRONOME_MODE]        = sText_MetronomeMode,
...
static const u8 *const OptionTextRight(u8 menuItem)
{
    ...
    {
    case MENU_GAMEMODE:         return sOptionMenuItemsNamesGameMode[menuItem];
...
static bool8 CheckConditions(int selection)
{
    ...
    case MENU_GAMEMODE:
        switch (selection)
        {
        case MENUITEM_GAMEMODE_STARTLOC:     return sOptions->sel_gamemode[MENUITEM_GAMEMODE];
        default:                                        return TRUE;
        }
    case MENU_RANDOMIZER:
        switch(selection)
        {
            ...
            case MENUITEM_RANDOM_MAPS:                      return sOptions->sel_gamemode[MENUITEM_GAMEMODE];
    ...
    case MENU_DIFFICULTY:
        switch(selection)
        {
        case MENUITEM_DIFFICULTY_PERFECT_IVS: 
        if (gSaveBlock1Ptr->tx_Difficulty == 2)
            return FALSE;
...
static const u8 sText_Description_Challenges_StoryMode[]                = _("Play in STORY MODE settings.");
static const u8 sText_Description_Challenges_StartLoc[]                 = _("Choose a starting location");
static const u8 sText_Description_Challenges_OpenWorld[]                = _("Play in {COLOR 7}{COLOR 8}OPEN WORLD{COLOR 1}{COLOR 2} settings.");
static const u8 sText_Description_GameMode_Next[]                     = _("Continue to Random options.");
static const u8 sText_Description_Gen_Base_1[]           = _("All POKéMON from GEN 1-9 will be used.");
static const u8 sText_Description_Gen_1_1[]              = _("Only POKéMON from GEN 1 will be used.");
static const u8 sText_Description_Gen_2_1[]              = _("Only POKéMON from GEN 1-2 will be used.");
static const u8 sText_Description_Gen_3_1[]              = _("Only POKéMON from GEN 1-3 will be used.");
static const u8 sText_Description_Gen_4_1[]              = _("Only POKéMON from GEN 1-4 will be used.");
static const u8 sText_Description_Gen_5_1[]              = _("Only POKéMON from GEN 1-5 will be used.");
static const u8 sText_Description_Gen_6_1[]              = _("Only POKéMON from GEN 1-6 will be used.");
static const u8 sText_Description_Gen_7_1[]              = _("Only POKéMON from GEN 1-7 will be used.");
static const u8 sText_Description_Gen_8_1[]              = _("Only POKéMON from GEN 1-8 will be used.");
static const u8 sText_Description_Easy[] =_("EASY MODE, easy/custom difficulty.");
static const u8 sText_Description_Normal[] =_("NORMAL MODE, default difficulty.");
static const u8 sText_Description_Hard[] =_("HARD MODE, extreme difficulty");
static const u8 *const sOptionMenuItemDescriptionsGameMode[MENUITEM_GAMEMODE_COUNT][3] =
{
    [MENUITEM_GAMEMODE] = {sText_Description_Challenges_StoryMode, sText_Description_Challenges_OpenWorld, sText_Empty},
    [MENUITEM_GAMEMODE_DIFFICULTY] = {sText_Description_Easy, sText_Description_Normal, sText_Description_Hard},
    [MENUITEM_GAMEMODE_NEXT] = {sText_Description_GameMode_Next, sText_Empty, sText_Empty},

};
static const u8 *const sOptionMenuItemDescriptionsGameModeStartloc[MENUITEM_GAMEMODE_COUNT][16] =
{
    [MENUITEM_GAMEMODE_STARTLOC]             = {sText_Description_Challenges_StartLoc, sText_Description_Challenges_StartLoc, sText_Description_Challenges_StartLoc,  sText_Description_Challenges_StartLoc,  sText_Description_Challenges_StartLoc,  sText_Description_Challenges_StartLoc,  sText_Description_Challenges_StartLoc,  sText_Description_Challenges_StartLoc,  sText_Description_Challenges_StartLoc,  sText_Description_Challenges_StartLoc,  sText_Description_Challenges_StartLoc,  sText_Description_Challenges_StartLoc,  sText_Description_Challenges_StartLoc,  sText_Description_Challenges_StartLoc,  sText_Description_Challenges_StartLoc,  sText_Description_Challenges_StartLoc},
};
static const u8 *const MenuItemDescriptionGameModeGen[MENUITEM_GAMEMODE_COUNT][10] =
{
    [MENUITEM_GAMEMODE_GEN]  = {sText_Description_Gen_Base_1, sText_Description_Gen_1_1, sText_Description_Gen_2_1, sText_Description_Gen_3_1, sText_Description_Gen_4_1, sText_Description_Gen_5_1, sText_Description_Gen_6_1, sText_Description_Gen_7_1, sText_Description_Gen_8_1},
};
...
static const u8 sText_Description_Random_Effectiveness_On[]         = _("Type effectiveness will be Inversed.\nFor eg, FIRE > WATER.");
static const u8 sText_Description_Random_Items_Off[]                = _("All found or recieved items are the\nsame as in the base game.");
static const u8 sText_Description_Random_Items_On[]                 = _("Randomize found, hidden and recieved\nitems. KEY-ITEMS are excluded!");
static const u8 sText_Description_Random_Maps_On[]                 = _("Randomize all map warps!");
static const u8 sText_Description_Random_Maps_Off[]                 = _("Map warps won't be randomized");
...
static const u8 sText_Description_Gen_Base[]             = _("Crest starter POKéMON");
static const u8 sText_Description_Gen_1[]                = _("1st GEN starter POKéMON");
static const u8 sText_Description_Gen_2[]                = _("2nd GEN starter POKéMON");
static const u8 sText_Description_Gen_3[]                = _("3rd GEN starter POKéMON");
static const u8 sText_Description_Gen_4[]                = _("4th GEN starter POKéMON");
static const u8 sText_Description_Gen_5[]                = _("5th GEN starter POKéMON");
static const u8 sText_Description_Gen_6[]                = _("6th GEN starter POKéMON");
static const u8 sText_Description_Gen_7[]                = _("7th GEN starter POKéMON");
static const u8 sText_Description_Gen_8[]                = _("8th GEN starter POKéMON");
static const u8 sText_Description_Gen_9[]                = _("9th GEN starter POKéMON");
static const u8 *const sOptionMenuItemDescriptionsRandomizer[MENUITEM_RANDOM_COUNT][2] =
{
    ...
    [MENUITEM_RANDOM_MAPS]                      = {sText_Description_Random_Maps_Off,             sText_Description_Random_Maps_On},
...
static const u8 *const MenuItemDescription[MENUITEM_RANDOM_COUNT][11] =
{
    [MENUITEM_RANDOM_STARTER]  = {sText_Description_Gen_Base, sText_Description_Random_Starter_On, sText_Description_Gen_1, sText_Description_Gen_2, sText_Description_Gen_3, sText_Description_Gen_4, sText_Description_Gen_5, sText_Description_Gen_6, sText_Description_Gen_7, sText_Description_Gen_8, sText_Description_Gen_9},
};
...
static const u8 sText_Description_Difficulty_Gym_Default[]              = _("Gym leaders will have the default\namount of POKéMON in their party.");
static const u8 sText_Description_Difficulty_Gym_Random[]               = _("All the Gym Leaders will have a full\nteam of 6 POKéMON.");
...
static const u8 sText_Description_Difficulty_NoEVs[]                = _("The trainers POKéMON do {COLOR 7}{COLOR 8}NOT{COLOR 1}{COLOR 2} gain\nany effort values!");
...
static const u8 sText_Description_Difficulty_Perfect_IVs_Off[]          = _("The players POKéMON have the\nexpected IVs.");
static const u8 sText_Description_Difficulty_Perfect_IVS_On[]           = _("All the players POKéMON will have\n6 Perfect IVs.");
...
static const u8 *const sOptionMenuItemDescriptionsDifficulty[MENUITEM_DIFFICULTY_COUNT][4] =
{
    ...
    [MENUITEM_DIFFICULTY_GYM]                   = {sText_Description_Difficulty_Gym_Default,        sText_Description_Difficulty_Gym_Random,        sText_Empty,                                sText_Empty},
    ...
    [MENUITEM_DIFFICULTY_PERFECT_IVS]           = {sText_Description_Difficulty_Perfect_IVs_Off,    sText_Description_Difficulty_Perfect_IVS_On,        sText_Empty,                                    sText_Empty},
    ...
    [MENUITEM_DIFFICULTY_SCALING_EVS]           = {sText_Description_Difficulty_ScalingEVs_Off,     sText_Description_Difficulty_ScalingEVs_Scaling,    sText_Description_Difficulty_ScalingEVs_Extreme,   sText_Description_Difficulty_NoEVs},
...
static const u8 sText_Description_Challenges_Mega_Evo_On[]              = _("Static encounters will remain mega evolved");
static const u8 sText_Description_Challenges_Mega_Evo_Off[]             = _("Static encounters will not remain\nmega evolved.");
...
static const u8 sText_Description_Challenges_MetronomeMode[]            = _("Every move is replaced with the\nmove METRONOME.");
...
static const u8 *const sOptionMenuItemDescriptionsChallenges[MENUITEM_CHALLENGES_COUNT][4] =
{
    ...
    [MENUITEM_CHALLENGES_MEGA_EVO]              = {sText_Description_Challenges_Mega_Evo_Off,            sText_Description_Challenges_Mega_Evo_On,          sText_Empty,                                        sText_Empty},
    [MENUITEM_CHALLENGES_ONE_TYPE_CHALLENGE]    = {sText_Description_Challenges_OneTypeChallenge,       sText_Empty,                                        sText_Empty,                                        sText_Empty},
    [MENUITEM_CHALLENGES_METRONOME_MODE]        = {sText_Description_Challenges_MetronomeMode,          sText_Empty,                                        sText_Empty,                                        sText_Empty},
...
static const u8 sText_Description_Disabled_Challenges_StartLoc[]       = _("Only usable with Open World mode!");
static const u8 *const sOptionMenuItemDescriptionsDisabledGameMode[MENUITEM_CHALLENGES_COUNT] =
{
    [MENUITEM_GAMEMODE]            = sText_Empty,
    [MENUITEM_GAMEMODE_STARTLOC]   = sText_Description_Disabled_Challenges_StartLoc,
    [MENUITEM_GAMEMODE_DIFFICULTY] = sText_Empty,
    [MENUITEM_GAMEMODE_GEN]        = sText_Empty,
    [MENUITEM_GAMEMODE_NEXT] = sText_Empty,
};
...
static const u8 *const sOptionMenuItemDescriptionsDisabledRandomizer[MENUITEM_RANDOM_COUNT] =
{
    ...
    [MENUITEM_RANDOM_MAPS]                      = sText_Description_Disabled_Challenges_StartLoc,
...
static const u8 *const sOptionMenuItemDescriptionsDisabledDifficulty[MENUITEM_DIFFICULTY_COUNT] =
{
    ...
    [MENUITEM_DIFFICULTY_GYM]                   = sText_Empty,
    ...
    [MENUITEM_DIFFICULTY_PERFECT_IVS]           = sText_Empty,
...
static const u8 *const sOptionMenuItemDescriptionsDisabledChallenges[MENUITEM_CHALLENGES_COUNT] =
{
    ...
    [MENUITEM_CHALLENGES_MEGA_EVO]              = sText_Empty,
    [MENUITEM_CHALLENGES_ONE_TYPE_CHALLENGE]    = sText_Empty,
    [MENUITEM_CHALLENGES_METRONOME_MODE]        = sText_Empty,
...
static const u8 *const OptionTextDescription(void)
{
    ...
    {
    case MENU_GAMEMODE:
        if (!CheckConditions(menuItem) && sOptionMenuItemDescriptionsDisabledGameMode[menuItem] != sText_Empty)
            return sOptionMenuItemDescriptionsDisabledGameMode[menuItem];
        selection = sOptions->sel_gamemode[menuItem];
        if (sOptions->menuCursor[MENU_GAMEMODE] == MENUITEM_GAMEMODE_STARTLOC)
            return sOptionMenuItemDescriptionsGameModeStartloc[menuItem][selection];
        else if (sOptions->menuCursor[MENU_GAMEMODE] == MENUITEM_GAMEMODE_GEN)
            return MenuItemDescriptionGameModeGen[menuItem][selection];
        else    
            return sOptionMenuItemDescriptionsGameMode[menuItem][selection];        
    case MENU_RANDOMIZER:
        ...
        if (sOptions->menuCursor[MENU_RANDOMIZER] == MENUITEM_RANDOM_STARTER)
            return MenuItemDescription[menuItem][selection];
        else
    ...
    case MENU_CHALLENGES:
        ...
        if (sOptions->menuCursor[MENU_CHALLENGES] == MENUITEM_CHALLENGES_METRONOME_MODE)
            return sOptionMenuItemDescriptionsChallenges[menuItem][0];
        else    
...
static u8 MenuItemCount(void)
{
    switch (sOptions->submenu)
    {
    case MENU_GAMEMODE:     return MENUITEM_GAMEMODE_COUNT;
...
static u8 MenuItemCancel(void)
{
    switch (sOptions->submenu)
    {
    case MENU_GAMEMODE:     return MENUITEM_GAMEMODE_NEXT;    
...
static const u8 sText_TopBar_GameMode[]         = _("GAME MODE");
static void DrawTopBarText(void)
{
    ...
    {
        case MENU_GAMEMODE:
            width = GetStringWidth(FONT_SMALL, sText_TopBar_GameMode, 0) / 2;
            AddTextPrinterParameterized3(WIN_TOPBAR, FONT_SMALL, 120-width, 1, color, 0, sText_TopBar_GameMode);
...
static void DrawChoices(u32 id, int y) //right side draw function
{
    ...
    {
        case MENU_GAMEMODE:
            if (sItemFunctionsGameMode[id].drawChoices != NULL)
                sItemFunctionsGameMode[id].drawChoices(sOptions->sel_gamemode[id], y);
            break;            
        case MENU_RANDOMIZER:
...
void CB2_InitTxRandomizerChallengesMenu(void)
{
    ...
    case 6:
        ...
        gSaveBlock1Ptr->MeteronomeOnlyMode                  = TX_CHALLENGE_METRONOME_ONLY;
        ...
        sOptions->sel_randomizer[MENUITEM_RANDOM_MAPS]                       = gSaveBlock1Ptr->randomMap;
        ...
        sOptions->sel_challenges[MENUITEM_DIFFICULTY_GYM]            = gSaveBlock1Ptr->tx_Challenges_Gym;    
        ...
        sOptions->sel_difficulty[MENUITEM_DIFFICULTY_PERFECT_IVS]    = gSaveBlock1Ptr->tx_Challenges_PerfectIVs;
        ...
        sOptions->sel_challenges[MENUITEM_CHALLENGES_MEGA_EVO]               = gSaveBlock1Ptr->tx_Challenges_MegaEvo;
        sOptions->sel_challenges[MENUITEM_CHALLENGES_ONE_TYPE_CHALLENGE]     = gSaveBlock1Ptr->tx_Challenges_OneTypeChallenge;
        sOptions->sel_challenges[MENUITEM_CHALLENGES_METRONOME_MODE]         = gSaveBlock1Ptr->MeteronomeOnlyMode;
        ...
        sOptions->submenu = MENU_GAMEMODE;
    ...
    case 10:
        ...
        sOptions->arrowTaskId = AddScrollIndicatorArrowPairParameterized(SCROLL_ARROW_UP, 240 / 2, 20, 110, MENUITEM_GAMEMODE_COUNT - 1, 110, 110, 0);
...
static void Task_OptionMenuProcessInput(u8 taskId)
{
    ...
    {
        if (sOptions->submenu == MENU_GAMEMODE)
        {
            int cursor = sOptions->menuCursor[sOptions->submenu];
            u8 previousOption = sOptions->sel_gamemode[cursor];
            if (CheckConditions(cursor))
            {
                if (sItemFunctionsGameMode[cursor].processInput != NULL)
                {
                    sOptions->sel_gamemode[cursor] = sItemFunctionsGameMode[cursor].processInput(previousOption);
                    ReDrawAll();
                    DrawDescriptionText();
                }

                if (previousOption != sOptions->sel_gamemode[cursor])
...
void SaveData_TxRandomizerAndChallenges(void)
{
    ...
    // MENU_RANDOMIZER
    gSaveBlock1Ptr->tx_Challenges_OpenWorld            = sOptions->sel_gamemode[MENUITEM_GAMEMODE];
    gSaveBlock1Ptr->tx_Challenges_StartLoc             = sOptions->sel_gamemode[MENUITEM_GAMEMODE_STARTLOC];
    gSaveBlock1Ptr->tx_Difficulty                      = sOptions->sel_gamemode[MENUITEM_GAMEMODE_DIFFICULTY];
    gSaveBlock1Ptr->tx_Random_Gen                      = sOptions->sel_gamemode[MENUITEM_GAMEMODE_GEN];
    ...
    if (sOptions->sel_randomizer[MENUITEM_RANDOM_OFF_ON] == TRUE)
    {
        ...
        gSaveBlock1Ptr->randomMap                    = sOptions->sel_randomizer[MENUITEM_RANDOM_MAPS];
        gSaveBlock1Ptr->tx_Random_Chaos              = sOptions->sel_randomizer[MENUITEM_RANDOM_CHAOS];
    }
    else
    {
        gSaveBlock1Ptr->tx_Random_Gen                = FALSE;
    ...
    // MENU_DIFFICULTY
    if (sOptions->sel_gamemode[MENUITEM_GAMEMODE_DIFFICULTY] == 2) {
    ...
    } else if (sOptions->sel_gamemode[MENUITEM_GAMEMODE_DIFFICULTY] == 1) {
        gSaveBlock1Ptr->tx_Challenges_PartyLimit    = sOptions->sel_difficulty[MENUITEM_DIFFICULTY_PARTY_LIMIT];
        gSaveBlock1Ptr->tx_Challenges_Gym           = sOptions->sel_difficulty[MENUITEM_DIFFICULTY_GYM];
        gSaveBlock1Ptr->tx_Challenges_LevelCap      = 1;
        gSaveBlock1Ptr->tx_Challenges_ExpMultiplier = sOptions->sel_difficulty[MENUITEM_DIFFICULTY_EXP_MULTIPLIER];
        ...
        gSaveBlock1Ptr->tx_Challenges_PerfectIVs            = sOptions->sel_difficulty[MENUITEM_DIFFICULTY_PERFECT_IVS];
        gSaveBlock1Ptr->tx_Challenges_TrainerScalingIVs     = 1;
    ...
    gSaveBlock1Ptr->tx_Challenges_MegaEvo               = sOptions->sel_challenges[MENUITEM_CHALLENGES_MEGA_EVO];
    ...
    gSaveBlock1Ptr->MeteronomeOnlyMode                 = sOptions->sel_challenges[MENUITEM_CHALLENGES_METRONOME_MODE];
...
static int ProcessInput_Options_Eight(int selection)
{
    return XOptions_ProcessInput(8, selection);
}

static int ProcessInput_Options_Nine(int selection)
{
    return XOptions_ProcessInput(9, selection);
}
...
static const u8 sText_Inverse[]  = _("INVERSE");
static void DrawChoices_Random_OffInverse(int selection, int y, bool8 active)
{
    u8 styles[2] = {0};
    styles[selection] = 1;

    DrawOptionMenuChoice(sText_Off, 104, y, styles[0], active);   
    DrawOptionMenuChoice(sText_Inverse, GetStringRightAlignXOffset(1, sText_Inverse, 202), y, styles[1], active);
}
...
static const u8 sText_Gen1[]                            = _("GEN 1");
static const u8 sText_Gen2[]                            = _("GEN 2");
static const u8 sText_Gen3[]                            = _("GEN 3");
static const u8 sText_Gen4[]                            = _("GEN 4");
static const u8 sText_Gen5[]                            = _("GEN 5");
static const u8 sText_Gen6[]                            = _("GEN 6");
static const u8 sText_Gen7[]                            = _("GEN 7");
static const u8 sText_Gen8[]                            = _("GEN 8");
static const u8 sText_Gen9[]                            = _("GEN 9");
static const u8 *const sText_Challenges_Gen_Strings[] = {sText_Default, sText_Random, sText_Gen1, sText_Gen2, sText_Gen3, sText_Gen4, sText_Gen5, sText_Gen6, sText_Gen7, sText_Gen8, sText_Gen9};
static const u8 *const sText_Random_Gen_Strings[] = {sText_Default, sText_Gen1, sText_Gen2, sText_Gen3, sText_Gen4, sText_Gen5, sText_Gen6, sText_Gen7, sText_Gen8, sText_Gen9};
static void DrawChoices_Random_Starter(int selection, int y)
{
...
static void DrawChoices_Gen(int selection, int y)
{
    bool8 active = CheckConditions(MENUITEM_GAMEMODE_GEN);
    u8 n = selection;

    StringCopyPadded(gStringVar1, sText_Random_Gen_Strings[n], 0, 10);

    DrawOptionMenuChoice(gStringVar1, 104, y, 1, active);
    
    
    if (!StringCompare(gStringVar1, sText_Default))
    {
        gSaveBlock1Ptr->tx_Random_Gen = 0;
    }
    else if (!StringCompare(gStringVar2, sText_Gen1))
    {
        gSaveBlock1Ptr->tx_Random_Gen = 1;
    }
    else if (!StringCompare(gStringVar2, sText_Gen2))
    {
        gSaveBlock1Ptr->tx_Random_Gen = 2;
    }
    else if (!StringCompare(gStringVar2, sText_Gen3))
    {
        gSaveBlock1Ptr->tx_Random_Gen = 3;
    }
    else if (!StringCompare(gStringVar2, sText_Gen4))
    {
        gSaveBlock1Ptr->tx_Random_Gen = 4;
    }
    else if (!StringCompare(gStringVar2, sText_Gen5))
    {
        gSaveBlock1Ptr->tx_Random_Gen = 5;
    }
    else if (!StringCompare(gStringVar2, sText_Gen6))
    {
        gSaveBlock1Ptr->tx_Random_Gen = 6;
    }
    else if (!StringCompare(gStringVar2, sText_Gen7))
    {
        gSaveBlock1Ptr->tx_Random_Gen = 7;
    }
    else if (!StringCompare(gStringVar2, sText_Gen8))
    {
        gSaveBlock1Ptr->tx_Random_Gen = 8;
    }
}
...
static void DrawChoices_Starter_Gen(int selection, int y)
{
    ...
    StringCopyPadded(gStringVar1, sText_Challenges_Gen_Strings[n], 0, 11);
    ...
    if (!StringCompare(gStringVar1, sText_Default))
    {
        gSaveBlock1Ptr->tx_Random_Starter = 0;
    }
    else if (!StringCompare(gStringVar2, sText_Random))
    {
        gSaveBlock1Ptr->tx_Random_Starter = 1;
    }
    else if (!StringCompare(gStringVar2, sText_Gen1))
    {
        gSaveBlock1Ptr->tx_Random_Starter = 2;
    }
    else if (!StringCompare(gStringVar2, sText_Gen2))
    {
        gSaveBlock1Ptr->tx_Random_Starter = 3;
    }
    else if (!StringCompare(gStringVar2, sText_Gen3))
    {
        gSaveBlock1Ptr->tx_Random_Starter = 4;
    }
    else if (!StringCompare(gStringVar2, sText_Gen4))
    {
        gSaveBlock1Ptr->tx_Random_Starter = 5;
    }
    else if (!StringCompare(gStringVar2, sText_Gen5))
    {
        gSaveBlock1Ptr->tx_Random_Starter = 6;
    }
    else if (!StringCompare(gStringVar2, sText_Gen6))
    {
        gSaveBlock1Ptr->tx_Random_Starter = 7;
    }
    else if (!StringCompare(gStringVar2, sText_Gen7))
    {
        gSaveBlock1Ptr->tx_Random_Starter = 8;
    }
    else if (!StringCompare(gStringVar2, sText_Gen8))
    {
        gSaveBlock1Ptr->tx_Random_Starter = 9;
    }
    else if (!StringCompare(gStringVar2, sText_Gen9))
    {
        gSaveBlock1Ptr->tx_Random_Starter = 10;
    }
}
static void DrawChoices_Random_WildPkmn(int selection, int y)
{
...
static void DrawChoices_Random_TypeEffect(int selection, int y)
{
    ...
    DrawChoices_Random_OffInverse(selection, y, active);
}
static void DrawChoices_Random_Items(int selection, int y)
{
...
static void DrawChoices_Random_Maps(int selection, int y)
{
    bool8 active = CheckConditions(MENUITEM_RANDOM_MAPS);
    DrawChoices_Random_OffRandom(selection, y, active);
}
...
static const u8 *const sText_PerfectIVs[] = {sText_Default, sText_Perfect};
static void DrawChoices_Challenges_Perfect_IVs(int selection, int y)
{
    bool8 active = CheckConditions(MENUITEM_DIFFICULTY_PERFECT_IVS);
    u8 n = selection;

    StringCopyPadded(gStringVar1, sText_PerfectIVs[n], 0, 2);
    DrawOptionMenuChoice(gStringVar1, 104, y, 1, active);

    if (!StringCompare(gStringVar1, sText_Perfect))
    {
        gSaveBlock1Ptr->tx_Challenges_PerfectIVs = 1;
    }
    else
    {
        gSaveBlock1Ptr->tx_Challenges_PerfectIVs = 0;
...
static void DrawChoices_Challenges_ScalingIVs(int selection, int y)
{
    ...
    u8 styles[3] = {0};
    int xMid = GetMiddleX(sText_On, sText_ScalingIVsEVs_Scaling, sText_ScalingIVsEVs_Hard);
    styles[selection] = 1;
...
static const u8 *const sText_ScalingEVs_Strings[] = {sText_On, sText_ScalingIVsEVs_Scaling, sText_ScalingIVsEVs_Extrem, sText_Off};
static void DrawChoices_Challenges_ScalingEVs(int selection, int y)
{
...
void DrawChoices_Challenges_ExpMultiplier(int selection, int y)
{
...
static const u8 sText_storymode[] = _("STORY MODE");
static const u8 sText_openworld[] = _("OPEN WORLD");
static const u8 sText_Full[] = _("FULL");
static const u8 sText_Easy[] = _("EASY/CUSTOM");
static const u8 *const sText_Challenges_Game_Mode_Strings[] = {sText_storymode, sText_openworld};
static const u8 *const sText_Challenges_Start_Loc_Strings[] = {gText_TPLittleroot, gText_TPOldale, gText_TPPetalburg, gText_TPRustboro, gText_TPDewford, gText_TPSlateport, gText_TPMauville, gText_TPVerdanturf, gText_TPLavaridge, gText_TPFallarbor, gText_TPFortree, gText_TPLilycove, gText_TPMossdeep, gText_TPSootopolis, gText_TPPacifidlog, sText_Random}; 
static const u8 *const sText_Challenges_Gym[] = {sText_Default, sText_Full};
static const u8 *const sText_GameMode_Diff[] = {sText_Easy, sText_Challenges_Nuzlocke_Normal, sText_Challenges_Nuzlocke_Hardcore};
static void DrawChoices_OpenWorld(int selection, int y)
{
    bool8 active = CheckConditions(MENUITEM_GAMEMODE);
    u8 n = selection;

    StringCopyPadded(gStringVar1, sText_Challenges_Game_Mode_Strings[n], 0, 2);

    DrawOptionMenuChoice(gStringVar1, 104, y, 1, active);

    if (!StringCompare(gStringVar1, sText_openworld))
    {
        gSaveBlock1Ptr->tx_Challenges_OpenWorld = 1;
    }
    else
    {
        gSaveBlock1Ptr->tx_Challenges_OpenWorld = 0;
    }
    if (selection == 0) {
        sOptions->sel_gamemode[MENUITEM_GAMEMODE_STARTLOC] = 0;
        sOptions->sel_randomizer[MENUITEM_RANDOM_MAPS] = 0;
    }
...
static void DrawChoices_Challenges_Gym(int selection, int y)
{
    bool8 active = CheckConditions(MENUITEM_DIFFICULTY_GYM);
    u8 n = selection;

    StringCopyPadded(gStringVar1, sText_Challenges_Gym[n], 0, 2);

    DrawOptionMenuChoice(gStringVar1, 104, y, 1, active);

    if (!StringCompare(gStringVar1, sText_Full))
    {
        gSaveBlock1Ptr->tx_Challenges_Gym = 1;
    }
    else
    {
        gSaveBlock1Ptr->tx_Challenges_Gym = 0;
    }
...
static void DrawChoices_StartLoc(int selection, int y)
{
    bool8 active = CheckConditions(MENUITEM_GAMEMODE_STARTLOC);
    u8 n = selection;

    StringCopyPadded(gStringVar1, sText_Challenges_Start_Loc_Strings[n], 0, 16);

    DrawOptionMenuChoice(gStringVar1, 104, y, 1, active);

    if (!StringCompare(gStringVar1, gText_TPLittleroot))
    {
        FlagSet(FLAG_START_LOC_LITTLEROOT); // Huh, isn't this also set in new_game.c
        gSaveBlock1Ptr->tx_Challenges_StartLoc = START_LOC_LITTLEROOT;
    }
    else if (!StringCompare(gStringVar1, gText_TPOldale))
    {
        FlagSet(FLAG_START_LOC_OLDALE);
        gSaveBlock1Ptr->tx_Challenges_StartLoc = START_LOC_OLDALE;
    }
    else if (!StringCompare(gStringVar1, gText_TPPetalburg))
    {
        FlagSet(FLAG_START_LOC_PETALBURG);
        gSaveBlock1Ptr->tx_Challenges_StartLoc = START_LOC_PETALBURG;
    }
    else if (!StringCompare(gStringVar1, gText_TPRustboro))
    {
        FlagSet(FLAG_START_LOC_RUSTBORO);
        gSaveBlock1Ptr->tx_Challenges_StartLoc = START_LOC_RUSTBORO;
    }
    else if (!StringCompare(gStringVar1, gText_TPDewford))
    {
        FlagSet(FLAG_START_LOC_DEWFORD);
        gSaveBlock1Ptr->tx_Challenges_StartLoc = START_LOC_DEWFORD;
    }
    else if (!StringCompare(gStringVar1, gText_TPSlateport))
    {
        FlagSet(FLAG_START_LOC_SLATEPORT);
        gSaveBlock1Ptr->tx_Challenges_StartLoc = START_LOC_SLATEPORT;
    }
    else if (!StringCompare(gStringVar1, gText_TPMauville))
    {
        FlagSet(FLAG_START_LOC_MAUVILLE);
        gSaveBlock1Ptr->tx_Challenges_StartLoc = START_LOC_MAUVILLE;
    }
    else if (!StringCompare(gStringVar1, gText_TPVerdanturf))
    {
        FlagSet(FLAG_START_LOC_VERDANTURF);
        gSaveBlock1Ptr->tx_Challenges_StartLoc = START_LOC_VERDANTURF;
    }
    else if (!StringCompare(gStringVar1, gText_TPLavaridge))
    {
        FlagSet(FLAG_START_LOC_LAVARIDGE);
        gSaveBlock1Ptr->tx_Challenges_StartLoc = START_LOC_LAVARIDGE;
    }
    else if (!StringCompare(gStringVar1, gText_TPFallarbor))
    {
        FlagSet(FLAG_START_LOC_FALLARBOR);
        gSaveBlock1Ptr->tx_Challenges_StartLoc = START_LOC_FALLARBOR;
    }
    else if (!StringCompare(gStringVar1, gText_TPFortree))
    {
        FlagSet(FLAG_START_LOC_FORTREE);
        gSaveBlock1Ptr->tx_Challenges_StartLoc = START_LOC_FORTREE;
    }
    else if (!StringCompare(gStringVar1, gText_TPLilycove))
    {
        FlagSet(FLAG_START_LOC_LILYCOVE);
        gSaveBlock1Ptr->tx_Challenges_StartLoc = START_LOC_LILYCOVE;
    }
    else if (!StringCompare(gStringVar1, gText_TPMossdeep))
    {
        FlagSet(FLAG_START_LOC_MOSSDEEP);
        gSaveBlock1Ptr->tx_Challenges_StartLoc = START_LOC_MOSSDEEP;
    }
    else if (!StringCompare(gStringVar1, gText_TPSootopolis))
    {
        FlagSet(FLAG_START_LOC_SOOTOPOLIS);
        gSaveBlock1Ptr->tx_Challenges_StartLoc = START_LOC_SOOTOPOLIS;
    }
    else if (!StringCompare(gStringVar1, gText_TPPacifidlog))
    {
        FlagSet(FLAG_START_LOC_PACIFIDLOG);
        gSaveBlock1Ptr->tx_Challenges_StartLoc = START_LOC_PACIFIDLOG;
    }
    else if (!StringCompare(gStringVar1, sText_Random))
    { 
        FlagSet(FLAG_START_LOC_RANDOM);
        gSaveBlock1Ptr->tx_Challenges_StartLoc = START_LOC_RANDOM;
    }
}
...
static const u8 sText_Permanent[] = _("PERMANENT");

void DrawChoices_Challenges_MegaEvo(int selection, int y)
{
    bool8 active = CheckConditions(MENUITEM_CHALLENGES_MEGA_EVO);
    u8 styles[2] = {0};
    styles[selection] = 1;

    DrawOptionMenuChoice(sText_Off, 104, y, styles[0], active);
    DrawOptionMenuChoice(sText_Permanent, GetStringRightAlignXOffset(1, sText_Permanent, 198), y, styles[1], active);
}
...
static void DrawChoices_Challenges_MetronomeMode(int selection, int y)
{
    bool8 active = CheckConditions(MENUITEM_CHALLENGES_METRONOME_MODE);
    u8 styles[2] = {0};
    styles[selection] = 1;
