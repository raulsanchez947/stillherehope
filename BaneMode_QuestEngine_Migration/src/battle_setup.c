...
static void DoStandardWildBattle(bool32 isDouble)
{
    ...
    #ifndef NDEBUG
    MgbaPrintf(MGBA_LOG_DEBUG, "wild +2:%d", gSaveBlock2Ptr->playerRank);
    #endif
...
void BattleSetup_StartRoamerBattle(void)
{
    ...
    IncrementGameStat(GAME_STAT_TOTAL_BATTLES);
    IncrementGameStat(GAME_STAT_WILD_BATTLES);
    gSaveBlock2Ptr->playerRank += 12;
    #ifndef NDEBUG
    MgbaPrintf(MGBA_LOG_DEBUG, "romer +2:%d", gSaveBlock2Ptr->playerRank);
    #endif
    IncrementDailyWildBattles();
    TryUpdateGymLeaderRematchFromWild();
}
...
static void DoBattlePikeWildBattle(void)
{
    ...
    gSaveBlock2Ptr->playerRank += 2;
    #ifndef NDEBUG
    MgbaPrintf(MGBA_LOG_DEBUG, "pike +2:%d", gSaveBlock2Ptr->playerRank);
    #endif
    IncrementDailyWildBattles();
    TryUpdateGymLeaderRematchFromWild();
}
...
static void DoTrainerBattle(void)
{
    ...
    #ifndef NDEBUG
    MgbaPrintf(MGBA_LOG_DEBUG, "trainer +5:%d", gSaveBlock2Ptr->playerRank);
    #endif
...
static void DoBattlePyramidTrainerHillBattle(void)
{
    ...
    gSaveBlock2Ptr->playerRank += 5;
    #ifndef NDEBUG
    MgbaPrintf(MGBA_LOG_DEBUG, "pyramidtrainerhill +5:%d", gSaveBlock2Ptr->playerRank);
    #endif
    TryUpdateGymLeaderRematchFromTrainer();
}
...
void BattleSetup_StartScriptedWildBattle(void)
{
    ...
    gSaveBlock2Ptr->playerRank += 2;
    #ifndef NDEBUG
    MgbaPrintf(MGBA_LOG_DEBUG, "scripted wild +2:%d", gSaveBlock2Ptr->playerRank);
    #endif
    IncrementDailyWildBattles();
    TryUpdateGymLeaderRematchFromWild();
}
...
void BattleSetup_StartScriptedDoubleWildBattle(void)
{
    ...
    gSaveBlock2Ptr->playerRank += 2;
    #ifndef NDEBUG
    MgbaPrintf(MGBA_LOG_DEBUG, "scripted double wild +2:%d", gSaveBlock2Ptr->playerRank);
    #endif
    IncrementDailyWildBattles();
    TryUpdateGymLeaderRematchFromWild();
}
...
void BattleSetup_StartLatiBattle(void)
{
    ...
    gSaveBlock2Ptr->playerRank += 12;
    #ifndef NDEBUG
    MgbaPrintf(MGBA_LOG_DEBUG, "lati battle +2:%d", gSaveBlock2Ptr->playerRank);
    #endif
    IncrementDailyWildBattles();
    TryUpdateGymLeaderRematchFromWild();
}
...
void BattleSetup_StartLegendaryBattle(void)
{
    ...
    gSaveBlock2Ptr->playerRank += 2;
    #ifndef NDEBUG
    MgbaPrintf(MGBA_LOG_DEBUG, "legend battle +2:%d", gSaveBlock2Ptr->playerRank);
    #endif
    IncrementDailyWildBattles();
    TryUpdateGymLeaderRematchFromWild();
}
...
void StartGroudonKyogreBattle(void)
{
    ...
    gSaveBlock2Ptr->playerRank += 12;
    #ifndef NDEBUG
    MgbaPrintf(MGBA_LOG_DEBUG, "groudon kyogre battle +2:%d", gSaveBlock2Ptr->playerRank);
    #endif
    IncrementDailyWildBattles();
    TryUpdateGymLeaderRematchFromWild();
}
...
void StartRegiBattle(void)
{
    ...
    gSaveBlock2Ptr->playerRank += 2;
    #ifndef NDEBUG
    MgbaPrintf(MGBA_LOG_DEBUG, "regi battle +2:%d", gSaveBlock2Ptr->playerRank);
    #endif
    IncrementDailyWildBattles();
    TryUpdateGymLeaderRematchFromWild();
}
...
static void CB2_EndStarterChoose(void)
{
    UpdatePaletteFade();
    RunTasks();
...
static void CB2_GiveStarter(void)
{
    ...
    if (FlagGet(FLAG_OPEN_WORLD))
    {
        *GetVarPointer(VAR_STARTER_MON) = gSpecialVar_Result;
        ...
        if (VarGet(VAR_TEMP_6) == starterMon && FlagGet(FLAG_SHINY_STARTER))
            FlagSet(FLAG_SHINY_CREATION);
        ScriptGiveMon(starterMon, 10, ITEM_NONE, 0, 0, 0);
        ResetTasks();
        SetMainCallback2(CB2_EndStarterChoose);
...
static void CB2_StartFirstBattle(void)
{
    ...
    if (IsBattleTransitionDone() == TRUE)
    {
        ...
        gSaveBlock2Ptr->playerRank += 2;
        #ifndef NDEBUG
        MgbaPrintf(MGBA_LOG_DEBUG, "first battle +2:%d", gSaveBlock2Ptr->playerRank);
        #endif
        IncrementDailyWildBattles();
        TryUpdateGymLeaderRematchFromWild();
    }
