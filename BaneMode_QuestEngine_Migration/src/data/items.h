...
// Mints
    ...
    [ITEM_LONELY_MINT] =
    {
        ...
        .pocket = POCKET_POWER_UP,
        .type = ITEM_USE_PARTY_MENU,
        .fieldUseFunc = ItemUseOutOfBattle_NatureMint, // Todo
        .flingPower = 10,
    },
...
// Encounter Modifiers
    ...
    [ITEM_REPEL] =
    {
        ...
        .price = 0,
        .holdEffectParam = 100,
        .description = sRaidDesc,
        .importance = 1,
        .pocket = POCKET_KEY_ITEMS,
        .type = ITEM_USE_FIELD,
        .fieldUseFunc = ItemUseOutOfBattle_Raid,
        .flingPower = 30,
    },
...
// Colored Orbs
    ...
    {
        .name = _("Tempest Orb"),
        .itemId = ITEM_TEMPEST_ORB,
        .price = 0,
        .holdEffect = HOLD_EFFECT_PRIMAL_ORB,
        .description = sTempestOrbDesc,
        .pocket = POCKET_Z_CRYSTALS,
        .type = ITEM_USE_BAG_MENU,
        .fieldUseFunc = ItemUseOutOfBattle_CannotUse,
    },
    ...
    {
        .name = _("Psychic Orb"),
        .itemId = ITEM_PSYCHIC_ORB,
        .price = 0,
        .holdEffect = HOLD_EFFECT_PRIMAL_ORB,
        .description = sPsychicOrbDesc,
        .pocket = POCKET_Z_CRYSTALS,
        .type = ITEM_USE_BAG_MENU,
        .fieldUseFunc = ItemUseOutOfBattle_CannotUse,
    },
...
// TMs/HMs. They don't have a set flingPower, as that's handled by GetFlingPowerFromItemId.
    ...
    [ITEM_TM51_ICICLE_SPEAR] =
    {
        .name = _("TM051 Sandstorm"),
        .itemId = ITEM_TM51,
        .price = 3000,
    ...
    [ITEM_TM54_ROCK_BLAST] =
    {
        .name = _("TM054 Psyshock"),
        .itemId = ITEM_TM54,
        .price = 3000,
    ...
    [ITEM_TM61_GUARD_SWAP] =
    {
        .name = _("TM061 ShadowCla"),
        .itemId = ITEM_TM61,
        .price = 3000,
    ...
    [ITEM_TM62_SPEED_SWAP] =
    {
        .name = _("TM062 FoulPlay"),
        .itemId = ITEM_TM62,
        .price = 3000,
    ...
    [ITEM_TM63_DRAIN_PUNCH] =
    {
        .name = _("TM063 PsychicFa"),
        .itemId = ITEM_TM63,
        .price = 3000,
    ...
    [ITEM_TM66_THUNDER_FANG] =
    {
        .name = _("TM066 BodySlam"),
        .itemId = ITEM_TM66,
        .price = 3000,
    ...
    [ITEM_TM69_PSYCHO_CUT] =
    {
        .name = _("TM069 IcePunch"),
        .itemId = ITEM_TM69,
        .price = 3000,
    ...
    [ITEM_TM70_TRICK_ROOM] =
    {
        .name = _("TM070 SleepTalk"),
        .itemId = ITEM_TM70,
        .price = 3000,
    ...
    [ITEM_TM71_WONDER_ROOM] =
    {
        .name = _("TM071 SeedBomb"),
        .itemId = ITEM_TM71,
        .price = 3000,
    ...
    [ITEM_TM72_MAGIC_ROOM] =
    {
        .name = _("TM072 ElectroBa"),
        .itemId = ITEM_TM72,
        .price = 3000,
    ...
    [ITEM_TM73_CROSS_POISON] =
    {
        .name = _("TM073 DrainPunc"),
        .itemId = ITEM_TM73,
        .price = 3000,
    ...
    [ITEM_TM78_ACROBATICS] =
    {
        .name = _("TM078 DragonCla"),
        .itemId = ITEM_TM78,
        .price = 3000,
    ...
    [ITEM_TM80_VOLT_SWITCH] =
    {
        .name = _("TM080 Metronome"),
        .itemId = ITEM_TM80,
        .price = 3000,
    ...
    [ITEM_TM82_ELECTROWEB] =
    {
        .name = _("TM082 ThunderWa"),
        .itemId = ITEM_TM82,
        .price = 3000,
    ...
    [ITEM_TM83_RAZOR_SHELL] =
    {
        .name = _("TM083 PoisonJab"),
        .itemId = ITEM_TM83,
        .price = 3000,
    ...
    [ITEM_TM86_PHANTOM_FORCE] =
    {
        .name = _("TM086 RockSlide"),
        .itemId = ITEM_TM86,
        .price = 3000,
    ...
    [ITEM_TM88_GRASSY_TERRAIN] =
    {
        .name = _("TM088 SwordsDan"),
        .itemId = ITEM_TM88,
        .price = 3000,
    ...
    [ITEM_TM89_MISTY_TERRAIN] =
    {
        .name = _("TM089 BodyPress"),
        .itemId = ITEM_TM89,
        .price = 3000,
    ...
    [ITEM_TM91_PSYCHIC_TERRAIN] =
    {
        .name = _("TM091 ToxicSpik"),
        .itemId = ITEM_TM91,
        .price = 3000,
    ...
    [ITEM_TM92_MYSTICAL_FIRE] =
    {
        .name = _("TM092 Imprison"),
        .itemId = ITEM_TM92,
        .price = 3000,
    ...
    [ITEM_TM93_EERIE_IMPULSE] =
    {
        .name = _("TM093 FlashCann"),
        .itemId = ITEM_TM93,
        .price = 3000,
    ...
    [ITEM_TM94_FALSE_SWIPE] =
    {
        .name = _("TM094 DarkPulse"),
        .itemId = ITEM_TM94,
        .price = 3000,
    ...
    [ITEM_TM96_SMART_STRIKE] =
    {
        .name = _("TM096 EerieImpu"),
        .itemId = ITEM_TM96,
        .price = 3000,
    ...
    [ITEM_TM98_STOMPING_TANTRUM] =
    {
        .name = _("TM098 SkillSwap"),
        .itemId = ITEM_TM98,
        .price = 3000,
    ...
    [ITEM_TM99_BREAKING_SWIPE] =
    {
        .name = _("TM099 IronHead"),
        .itemId = ITEM_TM99,
        .price = 3000,
    ...
    [ITEM_TM100_MEGA_PUNCH] =
    {
        .name = _("TM100 DragonDan"),
        .itemId = ITEM_TM100,
        .price = 3000,
...
// Misc. Key Items
    ...
    // Repurposed TM Case slot: infinite-use Escape Rope key item.
    [ITEM_TM_CASE] =
    {
        .name = _("SafetyLine"),
        .itemId = ITEM_TM_CASE,
        .price = 0,
        .description = sSafetyLineDesc,
        .importance = 1,
        .pocket = POCKET_KEY_ITEMS,
        .type = ITEM_USE_FIELD,
        .fieldUseFunc = ItemUseOutOfBattle_EscapeRope,
...
// Story Key Items
    ...
    {
        .name = _("Rage Orb"),
        .itemId = ITEM_RAGE_ORB,
        .price = 0,
        .description = sRageOrbDesc,
        .importance = 1,
        .registrability = TRUE,
        .pocket = POCKET_KEY_ITEMS,
        .type = ITEM_USE_BAG_MENU,
    ...
    {
        .name = _("Celestica Flute"),
        .itemId = ITEM_CELESTICA_FLUTE,
        .price = 0,
        .description = sCelesticaFluteDesc,
		.importance = 1,
        .pocket = POCKET_KEY_ITEMS,
        .type = 2,
        .fieldUseFunc = ItemUseOutOfBattle_CelesticaFlute,
    },
