...
static const u8 sRaidDesc[] = _(
    "A permanent field\n"
    "tool that keeps wild\n"
    "Pokémon away.");

static const u8 sPortablePCDesc[] = _(
    "A field terminal\n"
    "for accessing Pokémon\n"
    "Storage anywhere.");
...
static const u8 sHolyBluntDesc[] = _(
    "Fully heals one\n"
    "partner and raises it\n"
    "to the level cap.");
...
static const u8 sRageOrbDesc[] = _(
    "A mysterious orb\n"
    "that awakens\n"
    "dormant Pokémon.");

static const u8 sCelesticaFluteDesc[] = _(
   "A flute that can\n"
   "summon a Hisuian\n"
   "Braviary.");
