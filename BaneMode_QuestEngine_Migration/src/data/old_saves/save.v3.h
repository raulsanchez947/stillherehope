...
bool8 UpdateSave_v3_v6(const struct SaveSectorLocation *locations)
{
    const struct SaveBlock2_v3* sOldSaveBlock2Ptr = (struct SaveBlock2_v3*)(locations[0].data); // SECTOR_ID_SAVEBLOCK2
