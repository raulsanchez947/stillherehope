...
// This file contains the backups for the save file of v4.
...
bool8 UpdateSave_v4_v6(const struct SaveSectorLocation *locations)
{
    const struct SaveBlock2_v4* sOldSaveBlock2Ptr = (struct SaveBlock2_v4*)(locations[0].data); // SECTOR_ID_SAVEBLOCK2
    const struct SaveBlock1_v4* sOldSaveBlock1Ptr = (struct SaveBlock1_v4*)(locations[1].data); // SECTOR_ID_SAVEBLOCK1_START
    ...
    for(i = 0; i < min(ARRAY_COUNT(gSaveBlock2Ptr->SpecialMysteryGifts), ARRAY_COUNT(sOldSaveBlock2Ptr->SpecialMysteryGifts)); i++) gSaveBlock2Ptr->SpecialMysteryGifts[i] = sOldSaveBlock2Ptr->SpecialMysteryGifts[i];
    gSaveBlock2Ptr->specialMysteryGiftCount = sOldSaveBlock2Ptr->specialMysteryGiftCount;
    gSaveBlock2Ptr->seasons = sOldSaveBlock2Ptr->seasons;
