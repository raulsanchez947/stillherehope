const struct LevelUpMove *const gLevelUpLearnsets[NUM_SPECIES] =
{
    ...
    [SPECIES_OGERPON_TEAL_TERA] = sOgerponLevelUpLearnset,
    [SPECIES_OGERPON_WELLSPRING_TERA] = sOgerponLevelUpLearnset,
    [SPECIES_OGERPON_HEARTHFLAME_TERA] = sOgerponLevelUpLearnset,
    [SPECIES_OGERPON_CORNERSTONE_TERA] = sOgerponLevelUpLearnset,
