...
static const struct TrainerMonNoItemCustomMoves sParty_Dusty1[] = {
    ...
    .moves = {MOVE_DIG, MOVE_SLASH, MOVE_SAND_ATTACK, MOVE_METAL_CLAW}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Chip[] = {
    ...
    .moves = {MOVE_SLUDGE_BOMB, MOVE_STRANGE_STEAM, MOVE_FIRE_BLAST, MOVE_THUNDERBOLT}
    },
    {
    .iv = 50,
    .lvl = 27,
...
static const struct TrainerMonNoItemCustomMoves sParty_Foster[] = {
    ...
    .moves = {MOVE_FLAME_CHARGE, MOVE_ANCIENT_POWER, MOVE_ROCK_POLISH, MOVE_SMOKESCREEN}
    },
    {
    .iv = 100,
    .lvl = 25,
    .species = SPECIES_GRAVELER_ALOLAN,
    .moves = {MOVE_ROCK_THROW, MOVE_THUNDER_PUNCH, MOVE_SELF_DESTRUCT, MOVE_SMACK_DOWN}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Randall[] = {
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_REVENGE, MOVE_HORN_ATTACK, MOVE_SCARY_FACE, MOVE_NONE}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Parker[] = {
    ...
    .moves = {MOVE_VENOM_DRENCH, MOVE_NIGHT_SHADE, MOVE_SCARY_FACE, MOVE_NONE}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_George[] = {
    ...
    .moves = {MOVE_SWIFT, MOVE_SING, MOVE_ENCORE, MOVE_NONE}
    }
};
...
static const struct TrainerMonNoItemDefaultMoves sParty_Samuel[] = {
    ...
    .iv = 100,
    .lvl = 49,
    .species = SPECIES_TAUROS_PALDEAN,
    },
    {
    .iv = 100,
    .lvl = 50,
...
static const struct TrainerMonItemCustomMoves sParty_Mary[] = {
    ...
    .heldItem = ITEM_NORMALIUM_Z,
    .moves = {MOVE_FEINT_ATTACK, MOVE_TAUNT, MOVE_NONE, MOVE_NONE}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Jody[] = {
    ...
    .moves = {MOVE_PIN_MISSILE, MOVE_LEECH_SEED, MOVE_ROLLOUT, MOVE_BITE}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Daphne[] = {
    ...
    .moves = {MOVE_ICY_WIND, MOVE_ENDURE, MOVE_ICE_FANG, MOVE_ANCIENT_POWER},
...
static const struct TrainerMonNoItemCustomMoves sParty_Drew[] = {
    ...
    .moves = {MOVE_DIG, MOVE_SAND_ATTACK, MOVE_BITE, MOVE_SCARY_FACE}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Beau[] = {
    ...
    .moves = {MOVE_CRUNCH, MOVE_DIG, MOVE_SAND_ATTACK, MOVE_YAWN}
    },
    {
    .iv = 0,
    .lvl = 21,
    .species = SPECIES_DIGLETT_ALOLAN,
    .moves = {MOVE_SUCKER_PUNCH, MOVE_SAND_ATTACK, MOVE_BULLDOZE, MOVE_METAL_CLAW}
    },
    {
    .iv = 0,
    .lvl = 21,
...
static const struct TrainerMonNoItemCustomMoves sParty_Edward[] = {
    ...
    .moves = {MOVE_HIDDEN_POWER, MOVE_CONFUSION, MOVE_PSYBEAM, MOVE_PLAY_NICE}
    }
};
...
static const struct TrainerMonCustomized sParty_Sidney[] = {
    { .iv = 255, .lvl = 100, .species = SPECIES_PIKACHU,   .heldItem = ITEM_LIGHT_BALL,       .ability = ABILITY_STATIC,      .moves = {MOVE_VOLT_TACKLE, MOVE_THUNDERBOLT, MOVE_IRON_TAIL, MOVE_FAKE_OUT} },
    { .iv = 255, .lvl = 100, .species = SPECIES_DRAGONITE, .heldItem = ITEM_HEAVY_DUTY_BOOTS, .ability = ABILITY_MULTISCALE,  .moves = {MOVE_DRAGON_DANCE, MOVE_DUAL_WINGBEAT, MOVE_EARTHQUAKE, MOVE_EXTREME_SPEED} },
    { .iv = 255, .lvl = 100, .species = SPECIES_GENGAR,    .heldItem = ITEM_GENGARITE,        .ability = ABILITY_CURSED_BODY, .moves = {MOVE_NASTY_PLOT, MOVE_SHADOW_BALL, MOVE_SLUDGE_WAVE, MOVE_FOCUS_BLAST} },
    { .iv = 255, .lvl = 100, .species = SPECIES_LUCARIO,   .heldItem = ITEM_LIFE_ORB,         .ability = ABILITY_INNER_FOCUS, .moves = {MOVE_SWORDS_DANCE, MOVE_CLOSE_COMBAT, MOVE_METEOR_MASH, MOVE_EXTREME_SPEED} },
    { .iv = 255, .lvl = 100, .species = SPECIES_SIRFETCHD, .heldItem = ITEM_LEEK,             .ability = ABILITY_SCRAPPY,     .moves = {MOVE_CLOSE_COMBAT, MOVE_LEAF_BLADE, MOVE_KNOCK_OFF, MOVE_FIRST_IMPRESSION} },
    { .iv = 255, .lvl = 100, .species = SPECIES_DRACOVISH, .heldItem = ITEM_CHOICE_SCARF,     .ability = ABILITY_STRONG_JAW,  .moves = {MOVE_FISHIOUS_REND, MOVE_CRUNCH, MOVE_PSYCHIC_FANGS, MOVE_ICE_FANG} },
};

static const struct TrainerMonCustomized sParty_Phoebe[] = {
    { .iv = 255, .lvl = 100, .species = SPECIES_CHESNAUGHT, .heldItem = ITEM_LEFTOVERS,        .ability = ABILITY_BULLETPROOF, .moves = {MOVE_SPIKES, MOVE_WOOD_HAMMER, MOVE_DRAIN_PUNCH, MOVE_SYNTHESIS} },
    { .iv = 255, .lvl = 100, .species = SPECIES_BISHARP,    .heldItem = ITEM_BLACK_GLASSES,    .ability = ABILITY_DEFIANT,     .moves = {MOVE_SWORDS_DANCE, MOVE_KOWTOW_CLEAVE, MOVE_IRON_HEAD, MOVE_SUCKER_PUNCH} },
    { .iv = 255, .lvl = 100, .species = SPECIES_WEAVILE,    .heldItem = ITEM_HEAVY_DUTY_BOOTS, .ability = ABILITY_PRESSURE,    .moves = {MOVE_TRIPLE_AXEL, MOVE_KNOCK_OFF, MOVE_ICE_SHARD, MOVE_LOW_KICK} },
    { .iv = 255, .lvl = 100, .species = SPECIES_TYRANITAR,  .heldItem = ITEM_SMOOTH_ROCK,      .ability = ABILITY_SAND_STREAM, .moves = {MOVE_STEALTH_ROCK, MOVE_STONE_EDGE, MOVE_CRUNCH, MOVE_THUNDER_WAVE} },
    { .iv = 255, .lvl = 100, .species = SPECIES_METAGROSS,  .heldItem = ITEM_ASSAULT_VEST,     .ability = ABILITY_CLEAR_BODY,  .moves = {MOVE_METEOR_MASH, MOVE_EARTHQUAKE, MOVE_ZEN_HEADBUTT, MOVE_BULLET_PUNCH} },
    { .iv = 255, .lvl = 100, .species = SPECIES_CHARIZARD,  .heldItem = ITEM_CHARIZARDITE_X,   .ability = ABILITY_BLAZE,       .moves = {MOVE_DRAGON_DANCE, MOVE_FLARE_BLITZ, MOVE_DRAGON_CLAW, MOVE_EARTHQUAKE} },
};

static const struct TrainerMonCustomized sParty_Glacia[] = {
    { .iv = 255, .lvl = 100, .species = SPECIES_WEAVILE,    .heldItem = ITEM_HEAVY_DUTY_BOOTS, .ability = ABILITY_PRESSURE,    .moves = {MOVE_TRIPLE_AXEL, MOVE_KNOCK_OFF, MOVE_ICE_SHARD, MOVE_LOW_KICK} },
    { .iv = 255, .lvl = 100, .species = SPECIES_CROBAT,     .heldItem = ITEM_BLACK_SLUDGE,     .ability = ABILITY_INFILTRATOR, .moves = {MOVE_BRAVE_BIRD, MOVE_U_TURN, MOVE_TAUNT, MOVE_ROOST} },
    { .iv = 255, .lvl = 100, .species = SPECIES_ALAKAZAM,   .heldItem = ITEM_FOCUS_SASH,       .ability = ABILITY_MAGIC_GUARD, .moves = {MOVE_PSYSHOCK, MOVE_FOCUS_BLAST, MOVE_SHADOW_BALL, MOVE_ENCORE} },
    { .iv = 255, .lvl = 100, .species = SPECIES_GENGAR,     .heldItem = ITEM_LIFE_ORB,         .ability = ABILITY_CURSED_BODY, .moves = {MOVE_SHADOW_BALL, MOVE_SLUDGE_WAVE, MOVE_NASTY_PLOT, MOVE_FOCUS_BLAST} },
    { .iv = 255, .lvl = 100, .species = SPECIES_FERALIGATR, .heldItem = ITEM_MYSTIC_WATER,     .ability = ABILITY_SHEER_FORCE, .moves = {MOVE_DRAGON_DANCE, MOVE_LIQUIDATION, MOVE_CRUNCH, MOVE_ICE_PUNCH} },
    { .iv = 255, .lvl = 100, .species = SPECIES_GYARADOS,   .heldItem = ITEM_GYARADOSITE,      .ability = ABILITY_INTIMIDATE,  .moves = {MOVE_DRAGON_DANCE, MOVE_WATERFALL, MOVE_CRUNCH, MOVE_EARTHQUAKE} },
};

static const struct TrainerMonCustomized sParty_Drake[] = {
    { .iv = 255, .lvl = 100, .species = SPECIES_DRAGONITE,  .heldItem = ITEM_WEAKNESS_POLICY,  .ability = ABILITY_MULTISCALE,  .moves = {MOVE_DRAGON_DANCE, MOVE_DUAL_WINGBEAT, MOVE_EARTHQUAKE, MOVE_EXTREME_SPEED} },
    { .iv = 255, .lvl = 100, .species = SPECIES_GYARADOS,   .heldItem = ITEM_HEAVY_DUTY_BOOTS, .ability = ABILITY_INTIMIDATE,  .moves = {MOVE_DRAGON_DANCE, MOVE_WATERFALL, MOVE_CRUNCH, MOVE_TAUNT} },
    { .iv = 255, .lvl = 100, .species = SPECIES_AERODACTYL, .heldItem = ITEM_FOCUS_SASH,       .ability = ABILITY_PRESSURE,    .moves = {MOVE_STONE_EDGE, MOVE_DUAL_WINGBEAT, MOVE_EARTHQUAKE, MOVE_TAUNT} },
    { .iv = 255, .lvl = 100, .species = SPECIES_KINGDRA,    .heldItem = ITEM_SCOPE_LENS,       .ability = ABILITY_SNIPER,      .moves = {MOVE_DRACO_METEOR, MOVE_HYDRO_PUMP, MOVE_HURRICANE, MOVE_FOCUS_ENERGY} },
    { .iv = 255, .lvl = 100, .species = SPECIES_SALAMENCE,  .heldItem = ITEM_CHOICE_SCARF,     .ability = ABILITY_INTIMIDATE,  .moves = {MOVE_DRACO_METEOR, MOVE_FLAMETHROWER, MOVE_HYDRO_PUMP, MOVE_U_TURN} },
    { .iv = 255, .lvl = 100, .species = SPECIES_HYDREIGON,  .heldItem = ITEM_LIFE_ORB,         .ability = ABILITY_LEVITATE,    .moves = {MOVE_DRACO_METEOR, MOVE_DARK_PULSE, MOVE_FLAMETHROWER, MOVE_FLASH_CANNON} },
};
...
static const struct TrainerMonItemCustomMoves sParty_Roxanne1[] = {
    ...
    .moves = {MOVE_STEALTH_ROCK, MOVE_ROCK_BLAST, MOVE_CRUNCH, MOVE_ICE_PUNCH}
    },
    {
    .iv = 240,
    .lvl = 100,
    .species = SPECIES_GLIMMORA,
    .heldItem = ITEM_FOCUS_SASH,
    .moves = {MOVE_MORTAL_SPIN, MOVE_EARTH_POWER, MOVE_POWER_GEM, MOVE_SLUDGE_WAVE}
    },
    {
    .iv = 240,
    .lvl = 100,
    ...
    .moves = {MOVE_GIGA_DRAIN, MOVE_RECOVER, MOVE_ROCK_SLIDE, MOVE_TOXIC}
    },
    {
    .iv = 250,
    .lvl = 100,
    ...
    .moves = {MOVE_PROTECT, MOVE_MOONBLAST, MOVE_DIAMOND_STORM, MOVE_EARTH_POWER}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Brawly1[] = {
    ...
    .moves = {MOVE_LEECH_LIFE, MOVE_CLOSE_COMBAT, MOVE_FLARE_BLITZ, MOVE_MORNING_SUN}
    },
    {
    .iv = 230,
    .lvl = 50,
...
static const struct TrainerMonItemCustomMoves sParty_Wattson1[] = {
    ...
    .heldItem = ITEM_AIR_BALLOON,
    .moves = {MOVE_THUNDER_CAGE, MOVE_VOLT_SWITCH, MOVE_ELECTRO_BALL, MOVE_RAPID_SPIN}
    },
    {
    .iv = 255,
    .lvl = 100,
    ...
    .heldItem = ITEM_AIR_BALLOON,
    .moves = {MOVE_SWORDS_DANCE, MOVE_DRAIN_PUNCH, MOVE_WILD_CHARGE, MOVE_ICE_PUNCH}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Flannery1[] = {
    ...
    .moves = {MOVE_FLAMETHROWER, MOVE_THUNDER_PUNCH, MOVE_FOCUS_BLAST, MOVE_CLEAR_SMOG}
    },
    {
    .iv = 220,
    .lvl = 34,
    ...
    .heldItem = ITEM_HEAVY_DUTY_BOOTS,
    .moves = {MOVE_OVERHEAT, MOVE_VOLT_SWITCH, MOVE_WILL_O_WISP, MOVE_THUNDER_WAVE}
    },
    {
    .iv = 220,
    .lvl = 34,
    ...
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_FLARE_BLITZ, MOVE_EXTREME_SPEED, MOVE_WILL_O_WISP, MOVE_MORNING_SUN}
    },
    {
    .iv = 230,
    .lvl = 34,
    ...
    .moves = {MOVE_FLAMETHROWER, MOVE_SOLAR_BEAM, MOVE_HYPNOSIS, MOVE_NASTY_PLOT}
    },
    {
    .iv = 250,
    .lvl = 34,
...
static const struct TrainerMonItemCustomMoves sParty_Norman1[] = {
    ...
    .moves = {MOVE_VOLT_TACKLE, MOVE_EXTREME_SPEED, MOVE_KNOCK_OFF, MOVE_FAKE_OUT}
    },
    {
    .iv = 240,
    .lvl = 82,
    ...
    .heldItem = ITEM_BLACK_SLUDGE,
    .moves = {MOVE_SLEEP_POWDER, MOVE_GIGA_DRAIN, MOVE_SLUDGE_BOMB, MOVE_EARTH_POWER}
    },
    {
    .iv = 240,
    .lvl = 82,
...
static const struct TrainerMonItemCustomMoves sParty_Winona1[] = {
    ...
    .moves = {MOVE_EARTHQUAKE, MOVE_ACROBATICS, MOVE_PROTECT, MOVE_SWORDS_DANCE}
    },
    {
    .iv = 240,
    .lvl = 66,
...
static const struct TrainerMonItemCustomMoves sParty_TateAndLiza1[] = {
    ...
    .heldItem = ITEM_FOCUS_SASH,
    .moves = {MOVE_THUNDERBOLT, MOVE_VOLT_SWITCH, MOVE_HELPING_HAND, MOVE_PROTECT}
    },
    {
    .iv = 255,
    .lvl = 98,
    ...
    .species = SPECIES_BLASTOISE,
    .heldItem = ITEM_WHITE_HERB,
    .moves = {MOVE_SHELL_SMASH, MOVE_HYDRO_PUMP, MOVE_ICE_BEAM, MOVE_PROTECT}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Juan1[] = {
    ...
    .moves = {MOVE_SPIKES, MOVE_AQUA_JET, MOVE_POISON_STING, MOVE_TAUNT}
    },
    {
    .iv = 200,
    .lvl = 18,
    ...
    .heldItem = ITEM_ORAN_BERRY,
    .moves = {MOVE_MUD_SHOT, MOVE_WATER_PULSE, MOVE_PROTECT, MOVE_TICKLE}
    },
    {
    .iv = 200,
    .lvl = 18,
    ...
    .heldItem = ITEM_ORAN_BERRY,
    .moves = {MOVE_WATER_PULSE, MOVE_HYPNOSIS, MOVE_ICY_WIND, MOVE_PROTECT}
    },
    {
    .iv = 220,
    .lvl = 18,
    ...
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_SCALD, MOVE_ICY_WIND, MOVE_RAIN_DANCE, MOVE_PROTECT}
    },
    {
    .iv = 250,
    .lvl = 18,
    .species = SPECIES_GYARADOS,
    .heldItem = ITEM_GYARADOSITE,
    .moves = {MOVE_WATERFALL, MOVE_CRUNCH, MOVE_ICE_FANG, MOVE_TAUNT}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Paul[] = {
    ...
    .heldItem = ITEM_ORAN_BERRY,
    .moves = {MOVE_THUNDER_PUNCH, MOVE_LOW_KICK, MOVE_SWIFT, MOVE_LEER}
    },
    {
    .iv = 20,
    .lvl = 15,
    ...
    .heldItem = ITEM_ORAN_BERRY,
    .moves = {MOVE_EMBER, MOVE_MACH_PUNCH, MOVE_TAUNT, MOVE_SCRATCH}
    },
    {
    .iv = 20,
    .lvl = 15,
    ...
    .heldItem = ITEM_ORAN_BERRY,
    .moves = {MOVE_RAZOR_LEAF, MOVE_BITE, MOVE_REFLECT, MOVE_TACKLE}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_KateAndJoy[] = {
    ...
    .moves = {MOVE_MEGA_DRAIN, MOVE_LEECH_SEED, MOVE_FAIRY_WIND, MOVE_STUN_SPORE}
    },
    {
    .iv = 0,
    .lvl = 32,
    .species = SPECIES_YANMA,
    .moves = {MOVE_DETECT, MOVE_SONIC_BOOM, MOVE_PURSUIT, MOVE_FORESIGHT}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_AnnaAndMeg1[] = {
    ...
    .moves = {MOVE_GROWL, MOVE_YAWN, MOVE_CONFUSION, MOVE_LAST_RESORT}
    },
    {
    .iv = 0,
    .lvl = 17,
    .species = SPECIES_MURKROW,
    .moves = {MOVE_WING_ATTACK, MOVE_ASTONISH, MOVE_PURSUIT, MOVE_HAZE}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Josh[] = {
    ...
    .moves = {MOVE_TACKLE, MOVE_RAPID_SPIN, MOVE_SMACK_DOWN, MOVE_NONE}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Ben[] = {
    ...
    .moves = {MOVE_BITE, MOVE_SPARK, MOVE_NUZZLE, MOVE_THUNDERBOLT},
    .heldItem = ITEM_ELECTRIUM_Z
    },
    {
    .iv = 150,
...
static const struct TrainerMonNoItemCustomMoves sParty_Quincy[] = {
    ...
    .lvl = 43,
    .species = SPECIES_SANDSLASH_ALOLAN,
    .moves = {MOVE_METAL_CLAW, MOVE_ICE_BEAM, MOVE_ICICLE_CRASH, MOVE_DEFENSE_CURL}
    },
    {
    .iv = 100,
    .lvl = 43,
...
static const struct TrainerMonNoItemCustomMoves sParty_Katelynn[] = {
    ...
    .moves = {MOVE_PSYCHO_CUT, MOVE_CLOSE_COMBAT, MOVE_SWORDS_DANCE, MOVE_LEAF_BLADE}
    },
    {
    .iv = 100,
    .lvl = 51,
...
static const struct TrainerMonCustomized sParty_Wallace[] = {
    { .iv = 255, .lvl = 100, .species = SPECIES_ARCEUS_WATER,  .heldItem = ITEM_SPLASH_PLATE,     .ability = ABILITY_MULTITYPE,   .moves = {MOVE_CALM_MIND, MOVE_JUDGMENT, MOVE_ICE_BEAM, MOVE_RECOVER} },
    { .iv = 255, .lvl = 100, .species = SPECIES_DEOXYS_SPEED,  .heldItem = ITEM_FOCUS_SASH,       .ability = ABILITY_PRESSURE,    .moves = {MOVE_PSYCHO_BOOST, MOVE_ICE_BEAM, MOVE_SUPERPOWER, MOVE_STEALTH_ROCK} },
    { .iv = 255, .lvl = 100, .species = SPECIES_SCEPTILE,      .heldItem = ITEM_SCEPTILITE,       .ability = ABILITY_OVERGROW,    .moves = {MOVE_LEAF_STORM, MOVE_DRAGON_PULSE, MOVE_FOCUS_BLAST, MOVE_GIGA_DRAIN} },
    { .iv = 255, .lvl = 100, .species = SPECIES_CHARIZARD,     .heldItem = ITEM_HEAVY_DUTY_BOOTS, .ability = ABILITY_BLAZE,       .moves = {MOVE_FIRE_BLAST, MOVE_HURRICANE, MOVE_SCORCHING_SANDS, MOVE_ROOST} },
    { .iv = 255, .lvl = 100, .species = SPECIES_HOUNDOOM,      .heldItem = ITEM_CHOICE_SCARF,     .ability = ABILITY_FLASH_FIRE,  .moves = {MOVE_FLAMETHROWER, MOVE_DARK_PULSE, MOVE_NASTY_PLOT, MOVE_DESTINY_BOND} },
    { .iv = 255, .lvl = 100, .species = SPECIES_MEWTWO,        .heldItem = ITEM_MEWTWONITE_X,     .ability = ABILITY_PRESSURE,    .moves = {MOVE_BULK_UP, MOVE_DRAIN_PUNCH, MOVE_ZEN_HEADBUTT, MOVE_ICE_PUNCH} },
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Anthony2[] = {
    {
    .iv = 85,
    .lvl = 15,
    .species = SPECIES_PELIPPER,
    .moves = {MOVE_THUNDERBOLT, MOVE_FLAMETHROWER, MOVE_ABSORB, MOVE_WATER_PULSE}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Angelica[] = {
    ...
    .moves = {MOVE_RAZOR_LEAF, MOVE_MAGICAL_LEAF, MOVE_STOMP, MOVE_TEETER_DANCE}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Heidi[] = {
    ...
    .moves = {MOVE_NIGHT_SHADE, MOVE_POUND, MOVE_SHADOW_PUNCH, MOVE_IRON_DEFENSE}
    },
    {
    .iv = 0,
    .lvl = 22,
...
static const struct TrainerMonNoItemCustomMoves sParty_Becky[] = {
    ...
    .moves = {MOVE_STRENGTH, MOVE_BULLDOZE, MOVE_STOMP, MOVE_DOUBLE_KICK}
    },
    {
    .iv = 0,
    .lvl = 22,
    .species = SPECIES_SILICOBRA,
    .moves = {MOVE_SAND_ATTACK, MOVE_WRAP, MOVE_BRUTAL_SWING, MOVE_BULLDOZE}
    }
};
...
// Paul VR1 — Evergrande final team (first encounter on Victory Road)
static const struct TrainerMonItemCustomMoves sParty_WallyVR1[] = {
    ...
    .moves = {MOVE_IRON_TAIL, MOVE_STONE_EDGE, MOVE_EARTHQUAKE, MOVE_ICE_PUNCH}
    },
    {
    .iv = 255,
    .lvl = 54,
    .species = SPECIES_GASTRODON,
    .heldItem = ITEM_LEFTOVERS,
    .moves = {MOVE_SURF, MOVE_ICE_BEAM, MOVE_EARTHQUAKE, MOVE_RECOVER}
    },
    {
    .iv = 255,
    .lvl = 55,
    ...
    .moves = {MOVE_NIGHT_SLASH, MOVE_CRUNCH, MOVE_EARTHQUAKE, MOVE_X_SCISSOR}
    },
    {
    .iv = 255,
    .lvl = 54,
    ...
    .heldItem = ITEM_FOCUS_SASH,
    .moves = {MOVE_SHADOW_BALL, MOVE_ICE_BEAM, MOVE_SPIKES, MOVE_THUNDERBOLT}
    },
    {
    .iv = 255,
    .lvl = 55,
    ...
    .moves = {MOVE_THUNDER_PUNCH, MOVE_ICE_PUNCH, MOVE_FIRE_PUNCH, MOVE_LOW_KICK}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_BrendanRoute110Mudkip[] = {
    ...
    .species = SPECIES_SCYTHER,
    .heldItem = ITEM_LIFE_ORB,
    .moves = {MOVE_QUICK_ATTACK, MOVE_BUG_BITE, MOVE_PURSUIT, MOVE_AERIAL_ACE}
    },
    {
    .iv = 50,
    .lvl = 19,
    ...
    .moves = {MOVE_EMBER, MOVE_FLAME_CHARGE, MOVE_QUICK_ATTACK, MOVE_DOUBLE_KICK}
    },
    {
    .iv = 100,
    .lvl = 21,
    ...
    .moves = {MOVE_DRAGON_TAIL, MOVE_HEADBUTT, MOVE_PROTECT, MOVE_SCARY_FACE}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_BrendanRoute119Mudkip[] = {
    ...
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_PYRO_BALL, MOVE_ACROBATICS, MOVE_IRON_HEAD, MOVE_ZEN_HEADBUTT}
    },
    {
    .iv = 100,
    .lvl = 37,
    ...
    .heldItem = ITEM_FOCUS_SASH,
    .moves = {MOVE_BULLET_PUNCH, MOVE_DUAL_WINGBEAT, MOVE_X_SCISSOR, MOVE_U_TURN}
    },
    {
    .iv = 100,
    .lvl = 38,
    .species = SPECIES_GENGAR,
    .heldItem = ITEM_GENGARITE,
    .moves = {MOVE_SHADOW_BALL, MOVE_SLUDGE_BOMB, MOVE_ENERGY_BALL, MOVE_THUNDERBOLT}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_BrendanRoute110Treecko[] = {
    ...
    .species = SPECIES_GOOMY,
    .heldItem = ITEM_DRAGONIUM_Z,
    .moves = {MOVE_DRAGON_BREATH, MOVE_RAIN_DANCE, MOVE_PROTECT, MOVE_ABSORB}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_BrendanRoute110Torchic[] = {
    ...
    .species = SPECIES_BAGON,
    .heldItem = ITEM_DRAGONIUM_Z,
    .moves = {MOVE_DRAGON_BREATH, MOVE_BITE, MOVE_HEADBUTT, MOVE_EMBER}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_MayRoute110Mudkip[] = {
    ...
    .species = SPECIES_UXIE,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_CONFUSION, MOVE_THUNDER_WAVE, MOVE_REFLECT, MOVE_U_TURN}
    },
    {
    .iv = 24,
    .lvl = 20,
    .species = SPECIES_PELIPPER,
    .heldItem = ITEM_ORAN_BERRY,
    .moves = {MOVE_WING_ATTACK, MOVE_WATER_PULSE, MOVE_SUPERSONIC, MOVE_PROTECT}
    },
    {
    .iv = 22,
    .lvl = 20,
    .species = SPECIES_LAIRON,
    .heldItem = ITEM_ORAN_BERRY,
    .moves = {MOVE_METAL_CLAW, MOVE_ROCK_TOMB, MOVE_MUD_SLAP, MOVE_ROAR}
    },
    {
    .iv = 22,
    .lvl = 20,
    .species = SPECIES_KIRLIA,
    .heldItem = ITEM_ORAN_BERRY,
    .moves = {MOVE_PSYBEAM, MOVE_DRAINING_KISS, MOVE_CALM_MIND, MOVE_CHARGE_BEAM}
    },
    {
    .iv = 20,
    .lvl = 19,
    .species = SPECIES_NUMEL,
    .heldItem = ITEM_CHARCOAL,
    .moves = {MOVE_FLAME_CHARGE, MOVE_MUD_SHOT, MOVE_ROCK_TOMB, MOVE_YAWN}
    },
    {
    .iv = 20,
    .lvl = 19,
    .species = SPECIES_ROSELIA,
    .heldItem = ITEM_ORAN_BERRY,
    .moves = {MOVE_MAGICAL_LEAF, MOVE_GROWTH, MOVE_STUN_SPORE, MOVE_LEECH_SEED}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_MayRoute119Mudkip[] = {
    ...
    .species = SPECIES_UXIE,
    .heldItem = ITEM_LEFTOVERS,
    .moves = {MOVE_PSYCHIC, MOVE_THUNDER_WAVE, MOVE_STEALTH_ROCK, MOVE_U_TURN}
    },
    {
    .iv = 31,
    .lvl = 39,
    ...
    .heldItem = ITEM_EXPERT_BELT,
    .moves = {MOVE_PSYCHIC, MOVE_MOONBLAST, MOVE_THUNDERBOLT, MOVE_MYSTICAL_FIRE}
    },
    {
    .iv = 31,
    .lvl = 40,
    .species = SPECIES_ROSERADE,
    .heldItem = ITEM_BLACK_SLUDGE,
    .moves = {MOVE_LEAF_STORM, MOVE_SLUDGE_BOMB, MOVE_SLEEP_POWDER, MOVE_SPIKES}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_BrendanRustboroTreecko[] = {
    ...
    .moves = {MOVE_CONFUSION, MOVE_DISARMING_VOICE, MOVE_THUNDER_WAVE, MOVE_ENCORE}
    },
    {
    .iv = 31,
    .lvl = 15,
    .species = SPECIES_ARON,
    .heldItem = ITEM_ORAN_BERRY,
    .moves = {MOVE_ROCK_TOMB, MOVE_METAL_CLAW, MOVE_MUD_SLAP, MOVE_PROTECT}
    },
    {
    .iv = 31,
    .lvl = 15,
    ...
    .moves = {MOVE_MEGA_DRAIN, MOVE_STUN_SPORE, MOVE_LEECH_SEED, MOVE_HEADBUTT}
    },
    {
    .iv = 31,
    .lvl = 15,
    ...
    .heldItem = ITEM_FOCUS_SASH,
    .moves = {MOVE_ABSORB, MOVE_QUICK_ATTACK, MOVE_PURSUIT, MOVE_DETECT}
    },
    {
    .iv = 31,
    .lvl = 16,
    .species = SPECIES_GOOMY,
    .heldItem = ITEM_DRAGON_FANG,
    .moves = {MOVE_DRAGON_BREATH, MOVE_ABSORB, MOVE_PROTECT, MOVE_BIDE}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_BrendanRustboroMudkip[] = {
    ...
    .moves = {MOVE_WATER_GUN, MOVE_MUD_SLAP, MOVE_ROCK_SMASH, MOVE_PROTECT}
    },
    {
    .iv = 31,
    .lvl = 16,
    .species = SPECIES_JANGMO_O,
    .heldItem = ITEM_DRAGON_FANG,
    .moves = {MOVE_DRAGON_TAIL, MOVE_PROTECT, MOVE_BIDE, MOVE_LEER}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_BrendanRustboroTorchic[] = {
    ...
    .species = SPECIES_TORCHIC,
    .heldItem = ITEM_CHARCOAL,
    .moves = {MOVE_EMBER, MOVE_PECK, MOVE_QUICK_ATTACK, MOVE_PROTECT}
    },
    {
    .iv = 31,
    .lvl = 16,
    .species = SPECIES_BAGON,
    .heldItem = ITEM_DRAGON_FANG,
    .moves = {MOVE_BITE, MOVE_DRAGON_BREATH, MOVE_EMBER, MOVE_LEER}
    }
};

static const struct TrainerMonCustomized sParty_BrendanBoss[] = {
    { // Swampert — physically bulky lead with rocks
    ...
    { // Breloom — Poison Heal + Toxic Orb sweeper
    .iv = TRAINER_PARTY_IVS(31,31,31,31,31,31),
    ...
    { // Gliscor — Poison Heal + Toxic Orb bulky SD sweeper
    .iv = TRAINER_PARTY_IVS(31,31,31,31,31,31),
    .ev = TRAINER_PARTY_EVS(4, 252, 0, 252, 0, 0),
    .ability = ABILITY_POISON_HEAL,
    ...
    .species = SPECIES_GLISCOR,
    .heldItem = ITEM_TOXIC_ORB,
    .moves = {MOVE_EARTHQUAKE, MOVE_KNOCK_OFF, MOVE_ROOST, MOVE_SWORDS_DANCE}
    },
    ...
    .heldItem = ITEM_LUM_BERRY,
    .moves = {MOVE_DRAGON_DANCE, MOVE_DRAGON_CLAW, MOVE_EARTHQUAKE, MOVE_FIRE_FANG}
    }
};

static const struct TrainerMonCustomized sHardParty_BrendanBoss[] = {
    { // Swampert
    .iv = TRAINER_PARTY_IVS(31,31,31,31,31,31),
    .ev = TRAINER_PARTY_EVS(252, 252, 4, 0, 0, 0),
    .ability = ABILITY_TORRENT,
...
static const struct TrainerMonCustomized sParty_BrendanRoute119Popup[] = {
    { // May lead
    .iv = TRAINER_PARTY_IVS(31,31,31,31,31,31),
...
static const struct TrainerMonItemCustomMoves sParty_MayRustboroMudkip[] = {
    ...
    .species = SPECIES_UXIE,
    .heldItem = ITEM_ORAN_BERRY,
    .moves = {MOVE_CONFUSION, MOVE_THUNDER_WAVE, MOVE_REFLECT, MOVE_YAWN}
    },
    {
    .iv = 24,
    .lvl = 15,
    ...
    .heldItem = ITEM_ORAN_BERRY,
    .moves = {MOVE_VENOSHOCK, MOVE_FAKE_OUT, MOVE_MUD_SHOT, MOVE_PURSUIT}
    },
    {
    .iv = 22,
    .lvl = 14,
    .species = SPECIES_ROSELIA,
    .heldItem = ITEM_ORAN_BERRY,
    .moves = {MOVE_MAGICAL_LEAF, MOVE_STUN_SPORE, MOVE_LEECH_SEED, MOVE_MEGA_DRAIN}
    },
    {
    .iv = 20,
    .lvl = 13,
    ...
    .heldItem = ITEM_ORAN_BERRY,
    .moves = {MOVE_PSYBEAM, MOVE_ASTONISH, MOVE_CONFUSE_RAY, MOVE_PAIN_SPLIT}
    },
    {
    .iv = 20,
    .lvl = 13,
    .species = SPECIES_ELEKID,
    .heldItem = ITEM_ORAN_BERRY,
    .moves = {MOVE_THUNDER_SHOCK, MOVE_SWIFT, MOVE_LOW_KICK, MOVE_QUICK_ATTACK}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Gerald[] = {
    ...
    .lvl = 30,
    .species = SPECIES_CARKOL,
    .moves = {MOVE_FLAME_CHARGE, MOVE_ANCIENT_POWER, MOVE_RAPID_SPIN, MOVE_SMOKESCREEN}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Vivian[] = {
    ...
    .lvl = 20,
    .species = SPECIES_LUXIO,
    .moves = {MOVE_SPARK, MOVE_BITE, MOVE_TACKLE, MOVE_CHARGE}
    },
    {
    .iv = 100,
    .lvl = 19,
...
static const struct TrainerMonNoItemCustomMoves sParty_Danielle[] = {
    ...
    .lvl = 31,
    .species = SPECIES_FLAREON,
    .moves = {MOVE_BITE, MOVE_FLAMETHROWER, MOVE_QUICK_ATTACK, MOVE_SAND_ATTACK}
    }
};
...
// Paul Mauville — Pressure mechanic: every mon carries Focus Sash (no 1HKO)
static const struct TrainerMonCustomized sParty_WallyMauville[] = {
    {
    .iv = 30,
    .lvl = 26,
    .species = SPECIES_ELECTABUZZ,
    ...
    .moves = {MOVE_THUNDER_PUNCH, MOVE_LOW_KICK, MOVE_ICE_PUNCH, MOVE_QUICK_ATTACK}
    },
    {
    .iv = 30,
    .lvl = 27,
    ...
    .moves = {MOVE_WOOD_HAMMER, MOVE_EARTHQUAKE, MOVE_CRUNCH, MOVE_STONE_EDGE}
    },
    {
    .iv = 30,
    .lvl = 26,
    ...
    .moves = {MOVE_NIGHT_SLASH, MOVE_DRILL_PECK, MOVE_SUCKER_PUNCH, MOVE_SUPERPOWER}
    },
    {
    .iv = 30,
    .lvl = 25,
    ...
    .moves = {MOVE_ICE_PUNCH, MOVE_NIGHT_SLASH, MOVE_BRICK_BREAK, MOVE_AERIAL_ACE}
    },
    {
    .iv = 30,
    .lvl = 25,
    ...
    .moves = {MOVE_EARTHQUAKE, MOVE_SLASH, MOVE_BRICK_BREAK, MOVE_CRUNCH}
    },
    {
    .iv = 30,
    .lvl = 26,
    ...
    .heldItem = ITEM_TOXIC_ORB,
    .ability = ABILITY_POISON_HEAL,
    .moves = {MOVE_EARTHQUAKE, MOVE_X_SCISSOR, MOVE_STONE_EDGE, MOVE_AERIAL_ACE}
    }
};

// Paul VR2 — Evergrande rematch tier 2
...
// Paul VR3 — Evergrande rematch tier 3
...
// Paul VR4 — Evergrande rematch tier 4
...
// Paul VR5 — Evergrande rematch tier 5 (max)
...
static const struct TrainerMonItemCustomMoves sParty_BrendanLilycoveMudkip[] = {
  {
    ...
    .heldItem = ITEM_FOCUS_SASH,
    .moves = {MOVE_SHADOW_CLAW, MOVE_BITTER_BLADE, MOVE_LAVA_PLUME, MOVE_SWORDS_DANCE}
    },
    {
    .iv = 100,
    .lvl = 48,
    ...
    .heldItem = ITEM_DRAGONIUM_Z,
    .moves = {MOVE_DRAGON_CLAW, MOVE_CLANGING_SCALES, MOVE_SKY_UPPERCUT, MOVE_IRON_DEFENSE}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_BrendanLilycoveTreecko[] = {
    ...
    .heldItem = ITEM_DRAGONIUM_Z,
    .moves = {MOVE_POWER_WHIP, MOVE_DRAGON_PULSE, MOVE_MUDDY_WATER, MOVE_RAIN_DANCE}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_BrendanLilycoveTorchic[] = {
    ...
    .moves = {MOVE_DRAGON_CLAW, MOVE_FLAMETHROWER, MOVE_FLY, MOVE_THUNDER_FANG}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_MayLilycoveMudkip[] = {
  {
    ...
    .species = SPECIES_AGGRON,
    .heldItem = ITEM_LEFTOVERS,
    .moves = {MOVE_HEAD_SMASH, MOVE_HEAVY_SLAM, MOVE_EARTHQUAKE, MOVE_ICE_PUNCH}
    },
    {
    .iv = 31,
    .lvl = 79,
    ...
    .moves = {MOVE_EARTH_POWER, MOVE_FIRE_BLAST, MOVE_ANCIENT_POWER, MOVE_YAWN}
    },
    {
    .iv = 31,
    .lvl = 80,
...
static const struct TrainerMonNoItemCustomMoves sParty_MelAndPaul[] = {
    ...
    .moves = {MOVE_VENOM_DRENCH, MOVE_SHOCK_WAVE, MOVE_ACID_SPRAY, MOVE_TAUNT}
    },
    {
    .iv = 0,
    .lvl = 27,
    .species = SPECIES_TOXTRICITY,
    .moves = {MOVE_VENOSHOCK, MOVE_SWAGGER, MOVE_SHOCK_WAVE, MOVE_THUNDER_SHOCK}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_JohnAndJay1[] = {
    ...
    .moves = {MOVE_WORRY_SEED, MOVE_SOLAR_BEAM, MOVE_POISON_POWDER, MOVE_DOUBLE_EDGE}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Roxanne2[] = {
    ...
    .heldItem = ITEM_ROCKY_HELMET,
    .moves = {MOVE_SUCKER_PUNCH, MOVE_PAIN_SPLIT, MOVE_PROTECT, MOVE_WILL_O_WISP}
    },
    {
    .iv = 255,
    .lvl = 73,
    ...
    .moves = {MOVE_LEAF_STORM, MOVE_SLUDGE_BOMB, MOVE_SHADOW_BALL, MOVE_SLEEP_POWDER}
    },
    {
    .iv = 255,
    .lvl = 72,
    .species = SPECIES_TOGEKISS,
    .heldItem = ITEM_LEFTOVERS,
    .moves = {MOVE_AURA_SPHERE, MOVE_AIR_SLASH, MOVE_SHADOW_BALL, MOVE_GRASS_KNOT}
    },
    {
    .iv = 255,
    .lvl = 73,
    ...
    .moves = {MOVE_CLOSE_COMBAT, MOVE_DARK_PULSE, MOVE_STONE_EDGE, MOVE_EXTREME_SPEED}
    },
    {
    .iv = 255,
    .lvl = 72,
    ...
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_ICE_BEAM, MOVE_SHADOW_BALL, MOVE_WATER_PULSE, MOVE_SIGNAL_BEAM}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Roxanne3[] = {
    ...
    .species = SPECIES_SHARPEDO,
    .heldItem = ITEM_FOCUS_SASH,
    .moves = {MOVE_HYDRO_PUMP, MOVE_CRUNCH, MOVE_ZEN_HEADBUTT, MOVE_AQUA_JET}
    },
    {
    .iv = 255,
    .lvl = 73,
    ...
    .heldItem = ITEM_ICIUM_Z,
    .moves = {MOVE_BLIZZARD, MOVE_SHEER_COLD, MOVE_SURF, MOVE_YAWN}
    },
    {
    .iv = 255,
    .lvl = 72,
    .species = SPECIES_LUDICOLO,
    .heldItem = ITEM_LIFE_ORB,
    .moves = {MOVE_SURF, MOVE_FOCUS_BLAST, MOVE_GIGA_DRAIN, MOVE_RAIN_DANCE}
    },
    {
    .iv = 255,
    .lvl = 75,
    .species = SPECIES_SWAMPERT,
    .heldItem = ITEM_SWAMPERTITE,
    .moves = {MOVE_MUDDY_WATER, MOVE_EARTH_POWER, MOVE_FOCUS_BLAST, MOVE_ICE_BEAM}
    },
    {
    .iv = 255,
    .lvl = 73,
    .species = SPECIES_STARMIE,
    .heldItem = ITEM_EXPERT_BELT,
    .moves = {MOVE_SURF, MOVE_PSYCHIC, MOVE_THUNDERBOLT, MOVE_SIGNAL_BEAM}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Roxanne4[] = {
    ...
    .heldItem = ITEM_DRAGONIUM_Z,
    .moves = {MOVE_OUTRAGE, MOVE_EARTHQUAKE, MOVE_ROCK_SLIDE, MOVE_SUPERPOWER}
    },
    {
    .iv = 255,
    .lvl = 72,
...
static const struct TrainerMonItemCustomMoves sParty_Roxanne5[] = {
    ...
    .species = SPECIES_SALAMENCE,
    .heldItem = ITEM_LIFE_ORB,
    .moves = {MOVE_FIRE_BLAST, MOVE_DRACO_METEOR, MOVE_CRUNCH, MOVE_EARTHQUAKE}
    },
    {
    .iv = 255,
    .lvl = 73,
    ...
    .moves = {MOVE_EARTHQUAKE, MOVE_DOUBLE_EDGE, MOVE_AUTOTOMIZE, MOVE_HEAD_SMASH}
    },
    {
    .iv = 255,
    .lvl = 73,
    ...
    .moves = {MOVE_THUNDER, MOVE_SING, MOVE_BLIZZARD, MOVE_HYDRO_PUMP}
    },
    {
    .iv = 255,
    .lvl = 75,
...
static const struct TrainerMonItemCustomMoves sParty_Brawly2[] = {
    ...
    .species = SPECIES_IRON_HANDS,
    .heldItem = ITEM_BOOSTER_ENERGY,
    .moves = {MOVE_DRAIN_PUNCH, MOVE_WILD_CHARGE, MOVE_ICE_PUNCH, MOVE_SWORDS_DANCE}
    },
    {
    .iv = 255,
    .lvl = 73,
    .species = SPECIES_BRONZONG,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_EXTRASENSORY, MOVE_FLASH_CANNON, MOVE_CALM_MIND, MOVE_SHADOW_BALL}
    },
    {
    .iv = 255,
    .lvl = 72,
    ...
    .moves = {MOVE_X_SCISSOR, MOVE_BULLET_PUNCH, MOVE_WING_ATTACK, MOVE_DOUBLE_HIT}
    },
    {
    .iv = 255,
    .lvl = 75,
    ...
    .moves = {MOVE_BODY_PRESS, MOVE_STONE_EDGE, MOVE_CRUNCH, MOVE_IRON_HEAD}
    },
    {
    .iv = 255,
    .lvl = 73,
    ...
    .heldItem = ITEM_LEFTOVERS,
    .moves = {MOVE_HIGH_HORSEPOWER, MOVE_PLAY_ROUGH, MOVE_HEAVY_SLAM, MOVE_SUPERPOWER}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Brawly3[] = {
    ...
    .species = SPECIES_SLITHER_WING,
    .heldItem = ITEM_BOOSTER_ENERGY,
    .moves = {MOVE_FIRST_IMPRESSION, MOVE_CLOSE_COMBAT, MOVE_FLARE_BLITZ, MOVE_MORNING_SUN}
    },
    {
    .iv = 255,
    .lvl = 73,
    ...
    .heldItem = ITEM_ASSAULT_VEST,
    .moves = {MOVE_EARTHQUAKE, MOVE_STONE_EDGE, MOVE_AVALANCHE, MOVE_HAMMER_ARM}
    },
    {
    .iv = 255,
    .lvl = 72,
    .species = SPECIES_SEISMITOAD,
    .heldItem = ITEM_LIFE_ORB,
    .moves = {MOVE_LIQUIDATION, MOVE_POWER_WHIP, MOVE_EARTHQUAKE, MOVE_DRAIN_PUNCH}
    },
    {
    .iv = 255,
    .lvl = 73,
    .species = SPECIES_HAXORUS,
    .heldItem = ITEM_LIFE_ORB,
    .moves = {MOVE_FIRST_IMPRESSION, MOVE_DUAL_CHOP, MOVE_CLOSE_COMBAT, MOVE_POISON_JAB}
    },
    {
    .iv = 255,
    .lvl = 72,
    .species = SPECIES_CINDERACE,
    .heldItem = ITEM_LIFE_ORB,
    .moves = {MOVE_DOUBLE_EDGE, MOVE_HIGH_JUMP_KICK, MOVE_SUCKER_PUNCH, MOVE_PYRO_BALL}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Brawly4[] = {
    ...
    .species = SPECIES_ALAKAZAM,
    .heldItem = ITEM_LEFTOVERS,
    .moves = {MOVE_PSYCHIC, MOVE_FOCUS_BLAST, MOVE_DAZZLING_GLEAM, MOVE_TRICK}
    },
    {
    .iv = 255,
    .lvl = 72,
    ...
    .heldItem = ITEM_GRASSIUM_Z,
    .moves = {MOVE_LEAF_STORM, MOVE_PSYCHIC, MOVE_SLUDGE_BOMB, MOVE_GRASSY_TERRAIN}
    },
    {
    .iv = 255,
    .lvl = 73,
    .species = SPECIES_AERODACTYL,
    .heldItem = ITEM_LEFTOVERS,
    .moves = {MOVE_STONE_EDGE, MOVE_EARTHQUAKE, MOVE_AERIAL_ACE, MOVE_CRUNCH}
    },
    {
    .iv = 255,
    .lvl = 72,
    ...
    .moves = {MOVE_DRAGON_DANCE, MOVE_WATER_PULSE, MOVE_ICE_FANG, MOVE_EARTHQUAKE}
    },
    {
    .iv = 255,
    .lvl = 73,
...
static const struct TrainerMonItemCustomMoves sParty_Brawly5[] = {
    ...
    .species = SPECIES_MAWILE,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_PLAY_ROUGH, MOVE_IRON_HEAD, MOVE_FLASH_CANNON, MOVE_ICE_BEAM}
    },
    {
    .iv = 255,
    .lvl = 72,
    .species = SPECIES_PRIMARINA,
    .heldItem = ITEM_WATERIUM_Z,
    .moves = {MOVE_MOONBLAST, MOVE_SPARKLING_ARIA, MOVE_SING, MOVE_ICY_WIND}
    },
    {
    .iv = 255,
    .lvl = 73,
    ...
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_MOONBLAST, MOVE_ICE_BEAM, MOVE_THUNDERBOLT, MOVE_FLAMETHROWER}
    },
    {
    .iv = 255,
    .lvl = 73,
...
static const struct TrainerMonItemCustomMoves sParty_Wattson2[] = {
    ...
    .species = SPECIES_ZAPDOS,
    .heldItem = ITEM_HEAVY_DUTY_BOOTS,
    .moves = {MOVE_THUNDERBOLT, MOVE_HEAT_WAVE, MOVE_ROOST, MOVE_VOLT_SWITCH}
    },
    {
    .iv = 255,
    .lvl = 36,
...
static const struct TrainerMonItemCustomMoves sParty_Flannery5[] = {
    ...
    .species = SPECIES_TORKOAL,
    .heldItem = ITEM_HEAT_ROCK,
    .moves = {MOVE_ERUPTION, MOVE_EARTH_POWER, MOVE_YAWN, MOVE_PROTECT}
    },
    {
    .iv = 255,
    .lvl = 98,
    ...
    .heldItem = ITEM_FOCUS_SASH,
    .moves = {MOVE_SLEEP_POWDER, MOVE_AFTER_YOU, MOVE_LEAF_STORM, MOVE_CLOSE_COMBAT}
    },
    {
    .iv = 255,
    .lvl = 98,
    ...
    .moves = {MOVE_FLARE_BLITZ, MOVE_ROCK_SLIDE, MOVE_EXTREME_SPEED, MOVE_WILL_O_WISP}
    },
    {
    .iv = 255,
    .lvl = 98,
...
static const struct TrainerMonItemCustomMoves sParty_Norman2[] = {
    ...
    .species = SPECIES_SLAKING,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_DOUBLE_EDGE, MOVE_EARTHQUAKE, MOVE_FIRE_PUNCH, MOVE_YAWN}
    },
    {
    .iv = 255,
    .lvl = 43,
    ...
    .moves = {MOVE_FAKE_OUT, MOVE_RETURN, MOVE_SUCKER_PUNCH, MOVE_EARTHQUAKE}
    },
    {
    .iv = 255,
    .lvl = 44,
    ...
    .moves = {MOVE_GIGA_IMPACT, MOVE_NIGHT_SLASH, MOVE_FIRE_PUNCH, MOVE_REST}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Norman5[] = {
    ...
    .species = SPECIES_GARDEVOIR,
    .heldItem = ITEM_LIFE_ORB,
    .moves = {MOVE_MOONBLAST, MOVE_PSYCHIC, MOVE_MYSTICAL_FIRE, MOVE_FOCUS_BLAST}
    },
    {
    .iv = 255,
    .lvl = 100,
    .species = SPECIES_GALLADE,
    .heldItem = ITEM_LUM_BERRY,
    .moves = {MOVE_SWORDS_DANCE, MOVE_PSYCHO_CUT, MOVE_CLOSE_COMBAT, MOVE_SHADOW_SNEAK}
    },
    {
    .iv = 255,
    .lvl = 100,
    ...
    .heldItem = ITEM_ASSAULT_VEST,
    .moves = {MOVE_PSYCHIC, MOVE_DAZZLING_GLEAM, MOVE_MYSTICAL_FIRE, MOVE_GIGA_DRAIN}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Winona5[] = {
    ...
    .heldItem = ITEM_BLACK_SLUDGE,
    .moves = {MOVE_SPORE, MOVE_GIGA_DRAIN, MOVE_CLEAR_SMOG, MOVE_PROTECT}
    },
    {
    .iv = 255,
    .lvl = 98,
    .species = SPECIES_ROSERADE,
    .heldItem = ITEM_FOCUS_SASH,
    .moves = {MOVE_LEAF_STORM, MOVE_SLUDGE_BOMB, MOVE_SLEEP_POWDER, MOVE_PROTECT}
    },
    {
    .iv = 255,
    .lvl = 98,
    ...
    .heldItem = ITEM_LUM_BERRY,
    .moves = {MOVE_LEAF_BLADE, MOVE_X_SCISSOR, MOVE_SWORDS_DANCE, MOVE_PROTECT}
    }
};
...
static const struct TrainerMonCustomized sParty_Steven[] = {
    { .iv = 255, .lvl = 100, .species = SPECIES_ARTICUNO_GALARIAN, .heldItem = ITEM_BLUE_ORB,     .ability = ABILITY_COMPETITIVE, .moves = {MOVE_FREEZING_GLARE, MOVE_HURRICANE, MOVE_RECOVER, MOVE_CALM_MIND} },
    { .iv = 255, .lvl = 100, .species = SPECIES_MOLTRES_GALARIAN,  .heldItem = ITEM_RED_ORB,      .ability = ABILITY_BERSERK,     .moves = {MOVE_FIERY_WRATH, MOVE_HURRICANE, MOVE_NASTY_PLOT, MOVE_ROOST} },
    { .iv = 255, .lvl = 100, .species = SPECIES_ZAPDOS_GALARIAN,   .heldItem = ITEM_TEMPEST_ORB,  .ability = ABILITY_DEFIANT,     .moves = {MOVE_THUNDEROUS_KICK, MOVE_BRAVE_BIRD, MOVE_CLOSE_COMBAT, MOVE_BULK_UP} },
    { .iv = 255, .lvl = 100, .species = SPECIES_DEOXYS_ATTACK, .heldItem = ITEM_FOCUS_SASH,       .ability = ABILITY_PRESSURE,    .moves = {MOVE_PSYCHO_BOOST, MOVE_SUPERPOWER, MOVE_ICE_BEAM, MOVE_EXTREME_SPEED} },
    { .iv = 255, .lvl = 100, .species = SPECIES_MEW,           .heldItem = ITEM_PSYCHIC_ORB,      .ability = ABILITY_SYNCHRONIZE, .moves = {MOVE_PSYCHIC, MOVE_AURA_SPHERE, MOVE_SOFT_BOILED, MOVE_NASTY_PLOT} },
    { .iv = 255, .lvl = 100, .species = SPECIES_MEWTWO,        .heldItem = ITEM_MEWTWONITE_X,     .ability = ABILITY_PRESSURE,    .moves = {MOVE_BULK_UP, MOVE_DRAIN_PUNCH, MOVE_ZEN_HEADBUTT, MOVE_ICE_PUNCH} },
};
...
static const struct TrainerMonItemCustomMoves sParty_Brandon[] = {
    ...
    .heldItem = ITEM_LEFTOVERS,
    .moves = {MOVE_STONE_EDGE, MOVE_EARTHQUAKE, MOVE_BODY_PRESS, MOVE_STEALTH_ROCK}
    },
    {
    .iv = 255,
    .lvl = 100,
    ...
    .heldItem = ITEM_ASSAULT_VEST,
    .moves = {MOVE_FREEZE_DRY, MOVE_THUNDERBOLT, MOVE_FOCUS_BLAST, MOVE_ICE_BEAM}
    },
    {
    .iv = 255,
    .lvl = 100,
    ...
    .heldItem = ITEM_LEFTOVERS,
    .moves = {MOVE_IRON_DEFENSE, MOVE_BODY_PRESS, MOVE_HEAVY_SLAM, MOVE_THUNDER_WAVE}
    },
    {
    .iv = 255,
    .lvl = 100,
    ...
    .heldItem = ITEM_CHOICE_SPECS,
    .moves = {MOVE_DRAGON_ENERGY, MOVE_DRACO_METEOR, MOVE_FLAMETHROWER, MOVE_ANCIENT_POWER}
    },
    {
    .iv = 255,
    .lvl = 100,
    ...
    .heldItem = ITEM_LEFTOVERS,
    .moves = {MOVE_PROTECT, MOVE_BODY_SLAM, MOVE_DRAIN_PUNCH, MOVE_ICE_PUNCH}
    }
};
...
static const struct TrainerMonCustomized sHardParty_Sidney[] = {
    { .iv = 255, .lvl = 100, .species = SPECIES_PIKACHU,   .heldItem = ITEM_LIGHT_BALL,       .ability = ABILITY_STATIC,      .moves = {MOVE_VOLT_TACKLE, MOVE_THUNDERBOLT, MOVE_IRON_TAIL, MOVE_FAKE_OUT} },
    { .iv = 255, .lvl = 100, .species = SPECIES_DRAGONITE, .heldItem = ITEM_HEAVY_DUTY_BOOTS, .ability = ABILITY_MULTISCALE,  .moves = {MOVE_DRAGON_DANCE, MOVE_DUAL_WINGBEAT, MOVE_EARTHQUAKE, MOVE_EXTREME_SPEED} },
    { .iv = 255, .lvl = 100, .species = SPECIES_GENGAR,    .heldItem = ITEM_GENGARITE,        .ability = ABILITY_CURSED_BODY, .moves = {MOVE_NASTY_PLOT, MOVE_SHADOW_BALL, MOVE_SLUDGE_WAVE, MOVE_FOCUS_BLAST} },
    { .iv = 255, .lvl = 100, .species = SPECIES_LUCARIO,   .heldItem = ITEM_LIFE_ORB,         .ability = ABILITY_INNER_FOCUS, .moves = {MOVE_SWORDS_DANCE, MOVE_CLOSE_COMBAT, MOVE_METEOR_MASH, MOVE_EXTREME_SPEED} },
...
static const struct TrainerMonCustomized sHardParty_Phoebe[] = {
    { .iv = 255, .lvl = 100, .species = SPECIES_CHESNAUGHT, .heldItem = ITEM_LEFTOVERS,        .ability = ABILITY_BULLETPROOF, .moves = {MOVE_SPIKES, MOVE_WOOD_HAMMER, MOVE_DRAIN_PUNCH, MOVE_SYNTHESIS} },
    { .iv = 255, .lvl = 100, .species = SPECIES_BISHARP,    .heldItem = ITEM_BLACK_GLASSES,    .ability = ABILITY_DEFIANT,     .moves = {MOVE_SWORDS_DANCE, MOVE_KOWTOW_CLEAVE, MOVE_IRON_HEAD, MOVE_SUCKER_PUNCH} },
    { .iv = 255, .lvl = 100, .species = SPECIES_WEAVILE,    .heldItem = ITEM_HEAVY_DUTY_BOOTS, .ability = ABILITY_PRESSURE,    .moves = {MOVE_TRIPLE_AXEL, MOVE_KNOCK_OFF, MOVE_ICE_SHARD, MOVE_LOW_KICK} },
    { .iv = 255, .lvl = 100, .species = SPECIES_TYRANITAR,  .heldItem = ITEM_SMOOTH_ROCK,      .ability = ABILITY_SAND_STREAM, .moves = {MOVE_STEALTH_ROCK, MOVE_STONE_EDGE, MOVE_CRUNCH, MOVE_THUNDER_WAVE} },
...
static const struct TrainerMonCustomized sHardParty_Glacia[] = {
    { .iv = 255, .lvl = 100, .species = SPECIES_WEAVILE,    .heldItem = ITEM_HEAVY_DUTY_BOOTS, .ability = ABILITY_PRESSURE,    .moves = {MOVE_TRIPLE_AXEL, MOVE_KNOCK_OFF, MOVE_ICE_SHARD, MOVE_LOW_KICK} },
    { .iv = 255, .lvl = 100, .species = SPECIES_CROBAT,     .heldItem = ITEM_BLACK_SLUDGE,     .ability = ABILITY_INFILTRATOR, .moves = {MOVE_BRAVE_BIRD, MOVE_U_TURN, MOVE_TAUNT, MOVE_ROOST} },
    { .iv = 255, .lvl = 100, .species = SPECIES_ALAKAZAM,   .heldItem = ITEM_FOCUS_SASH,       .ability = ABILITY_MAGIC_GUARD, .moves = {MOVE_PSYSHOCK, MOVE_FOCUS_BLAST, MOVE_SHADOW_BALL, MOVE_ENCORE} },
    { .iv = 255, .lvl = 100, .species = SPECIES_GENGAR,     .heldItem = ITEM_LIFE_ORB,         .ability = ABILITY_CURSED_BODY, .moves = {MOVE_SHADOW_BALL, MOVE_SLUDGE_WAVE, MOVE_NASTY_PLOT, MOVE_FOCUS_BLAST} },
...
static const struct TrainerMonCustomized sHardParty_Drake[] = {
    { .iv = 255, .lvl = 100, .species = SPECIES_DRAGONITE,  .heldItem = ITEM_WEAKNESS_POLICY,  .ability = ABILITY_MULTISCALE,  .moves = {MOVE_DRAGON_DANCE, MOVE_DUAL_WINGBEAT, MOVE_EARTHQUAKE, MOVE_EXTREME_SPEED} },
    { .iv = 255, .lvl = 100, .species = SPECIES_GYARADOS,   .heldItem = ITEM_HEAVY_DUTY_BOOTS, .ability = ABILITY_INTIMIDATE,  .moves = {MOVE_DRAGON_DANCE, MOVE_WATERFALL, MOVE_CRUNCH, MOVE_TAUNT} },
    { .iv = 255, .lvl = 100, .species = SPECIES_AERODACTYL, .heldItem = ITEM_FOCUS_SASH,       .ability = ABILITY_PRESSURE,    .moves = {MOVE_STONE_EDGE, MOVE_DUAL_WINGBEAT, MOVE_EARTHQUAKE, MOVE_TAUNT} },
    { .iv = 255, .lvl = 100, .species = SPECIES_KINGDRA,    .heldItem = ITEM_SCOPE_LENS,       .ability = ABILITY_SNIPER,      .moves = {MOVE_DRACO_METEOR, MOVE_HYDRO_PUMP, MOVE_HURRICANE, MOVE_FOCUS_ENERGY} },
...
static const struct TrainerMonCustomized sHardParty_Wallace[] = {
    { .iv = 255, .lvl = 100, .species = SPECIES_ARCEUS_WATER,  .heldItem = ITEM_SPLASH_PLATE,     .ability = ABILITY_MULTITYPE,   .moves = {MOVE_CALM_MIND, MOVE_JUDGMENT, MOVE_ICE_BEAM, MOVE_RECOVER} },
    { .iv = 255, .lvl = 100, .species = SPECIES_DEOXYS_SPEED,  .heldItem = ITEM_FOCUS_SASH,       .ability = ABILITY_PRESSURE,    .moves = {MOVE_PSYCHO_BOOST, MOVE_ICE_BEAM, MOVE_SUPERPOWER, MOVE_STEALTH_ROCK} },
    { .iv = 255, .lvl = 100, .species = SPECIES_SCEPTILE,      .heldItem = ITEM_SCEPTILITE,       .ability = ABILITY_OVERGROW,    .moves = {MOVE_LEAF_STORM, MOVE_DRAGON_PULSE, MOVE_FOCUS_BLAST, MOVE_GIGA_DRAIN} },
    { .iv = 255, .lvl = 100, .species = SPECIES_CHARIZARD,     .heldItem = ITEM_HEAVY_DUTY_BOOTS, .ability = ABILITY_BLAZE,       .moves = {MOVE_FIRE_BLAST, MOVE_HURRICANE, MOVE_SCORCHING_SANDS, MOVE_ROOST} },
...
static const struct TrainerMonCustomized sHardParty_Steven[] = {
    { .iv = 255, .lvl = 100, .species = SPECIES_ARTICUNO_GALARIAN, .heldItem = ITEM_BLUE_ORB,     .ability = ABILITY_COMPETITIVE, .moves = {MOVE_FREEZING_GLARE, MOVE_HURRICANE, MOVE_RECOVER, MOVE_CALM_MIND} },
    { .iv = 255, .lvl = 100, .species = SPECIES_MOLTRES_GALARIAN,  .heldItem = ITEM_RED_ORB,      .ability = ABILITY_BERSERK,     .moves = {MOVE_FIERY_WRATH, MOVE_HURRICANE, MOVE_NASTY_PLOT, MOVE_ROOST} },
    { .iv = 255, .lvl = 100, .species = SPECIES_ZAPDOS_GALARIAN,   .heldItem = ITEM_TEMPEST_ORB,  .ability = ABILITY_DEFIANT,     .moves = {MOVE_THUNDEROUS_KICK, MOVE_BRAVE_BIRD, MOVE_CLOSE_COMBAT, MOVE_BULK_UP} },
    { .iv = 255, .lvl = 100, .species = SPECIES_DEOXYS_ATTACK, .heldItem = ITEM_FOCUS_SASH,       .ability = ABILITY_PRESSURE,    .moves = {MOVE_PSYCHO_BOOST, MOVE_SUPERPOWER, MOVE_ICE_BEAM, MOVE_EXTREME_SPEED} },
...
static const struct TrainerMonItemCustomMoves sHardParty_Roxanne1[] = {
    {
    .iv = 255,
    .lvl = 100,
    .species = SPECIES_TYRANITAR,
...
static const struct TrainerMonItemCustomMoves sHardParty_Wattson1[] = {
    {
    .iv = 255,
    .lvl = 100,
    .species = SPECIES_ROTOM_WASH,
...
static const struct TrainerMonItemCustomMoves sHardParty_Flannery1[] = {
    {
    .iv = 255,
    .lvl = 34,
    .species = SPECIES_MAGMAR,
...
static const struct TrainerMonItemCustomMoves sHardParty_Norman1[] = {
    {
    .iv = 255,
    .lvl = 82,
    .species = SPECIES_PIKACHU,
...
static const struct TrainerMonItemCustomMoves sHardParty_Winona1[] = {
    {
    .iv = 255,
    .lvl = 66,
    .species = SPECIES_PELIPPER,
...
static const struct TrainerMonItemCustomMoves sHardParty_TateAndLiza1[] = {
    {
    .iv = 255,
    .lvl = 98,
    .species = SPECIES_RILLABOOM,
...
static const struct TrainerMonItemCustomMoves sHardParty_Juan1[] = {
    {
    .iv = 255,
    .lvl = 18,
    .species = SPECIES_PELIPPER,
...
static const struct TrainerMonCustomized sParty_BaneModeAeg[] = {
    {
    .iv = 255,
    ...
    .moves = {MOVE_INFESTATION, MOVE_TOXIC, MOVE_STEALTH_ROCK, MOVE_PROTECT}
    },
    {
    .iv = 255,
    ...
    .moves = {MOVE_ENCORE, MOVE_INFESTATION, MOVE_REST, MOVE_SLEEP_TALK}
    },
    {
    .iv = 255,
    .ev = TRAINER_PARTY_EVS(0, 0, 252, 0, 252, 4),
    ...
    .species = SPECIES_SHUCKLE,
    .heldItem = ITEM_LEFTOVERS,
    .moves = {MOVE_SHELL_SMASH, MOVE_ROCK_TOMB, MOVE_STRUGGLE_BUG, MOVE_KNOCK_OFF}
    }
};

static const struct TrainerMonItemCustomMoves sParty_BaneModeRoute122Nacho[] = {
    {
    .iv = 255,
    .lvl = 63,
    .species = SPECIES_CINDERACE,
    ...
    .species = SPECIES_GRENINJA,
    .heldItem = ITEM_LIFE_ORB,
    .moves = {MOVE_HYDRO_PUMP, MOVE_DARK_PULSE, MOVE_ICE_BEAM, MOVE_SPIKES}
    },
    {
    .iv = 255,
    .lvl = 63,
    ...
    .heldItem = ITEM_CHOICE_SCARF,
    .moves = {MOVE_DRAGON_DARTS, MOVE_PHANTOM_FORCE, MOVE_U_TURN, MOVE_FIRE_BLAST}
    }
};

static const struct TrainerMonItemCustomMoves sParty_BaneModeRoute122Douglas[] = {
    {
    .iv = 255,
    .lvl = 63,
    .species = SPECIES_CLODSIRE,
    .heldItem = ITEM_LEFTOVERS,
    .moves = {MOVE_TOXIC, MOVE_EARTHQUAKE, MOVE_RECOVER, MOVE_HAZE}
    },
    {
    .iv = 255,
    .lvl = 63,
    .species = SPECIES_CORVIKNIGHT,
    .heldItem = ITEM_LEFTOVERS,
    .moves = {MOVE_BODY_PRESS, MOVE_BRAVE_BIRD, MOVE_ROOST, MOVE_U_TURN}
    },
    {
    .iv = 255,
    .lvl = 63,
    ...
    .moves = {MOVE_KINGS_SHIELD, MOVE_SHADOW_BALL, MOVE_FLASH_CANNON, MOVE_SACRED_SWORD}
    }
};

static const struct TrainerMonItemCustomMoves sParty_BaneModeRoute116Douglas[] = {
    {
    .iv = 31,
    .lvl = 47,
    .species = SPECIES_CLODSIRE,
    .heldItem = ITEM_LEFTOVERS,
    .moves = {MOVE_TOXIC_SPIKES, MOVE_EARTHQUAKE, MOVE_RECOVER, MOVE_HAZE}
    },
    {
    .iv = 31,
    .lvl = 47,
...
static const struct TrainerMonItemCustomMoves sParty_BaneModeRoute122Special[] = {
    {
    .iv = 255,
    .lvl = 63,
    .species = SPECIES_DRAGONITE,
    .heldItem = ITEM_HEAVY_DUTY_BOOTS,
    .moves = {MOVE_DRAGON_DANCE, MOVE_DUAL_WINGBEAT, MOVE_EARTHQUAKE, MOVE_EXTREME_SPEED}
    },
    {
    .iv = 255,
    .lvl = 63,
    .species = SPECIES_GENGAR,
    .heldItem = ITEM_FOCUS_SASH,
    .moves = {MOVE_SHADOW_BALL, MOVE_SLUDGE_WAVE, MOVE_NASTY_PLOT, MOVE_DESTINY_BOND}
    },
    {
    .iv = 255,
    .lvl = 63,
...
static const struct TrainerMonCustomized sParty_BaneModeWinstrateBane[] = {
    {
    .iv = 255,
    ...
    .species = SPECIES_SCRAFTY,
    .heldItem = ITEM_ROCKY_HELMET,
    .moves = {MOVE_FAKE_OUT, MOVE_TAUNT, MOVE_KNOCK_OFF, MOVE_DRAIN_PUNCH}
    },
    {
    .iv = 255,
    ...
    .species = SPECIES_SCRAFTY,
    .heldItem = ITEM_LUM_BERRY,
    .moves = {MOVE_DRAGON_DANCE, MOVE_CRUNCH, MOVE_DRAIN_PUNCH, MOVE_ICE_PUNCH}
    },
    {
    .iv = 255,
    .ev = TRAINER_PARTY_EVS(252, 172, 0, 0, 0, 84),
    .ability = ABILITY_INTIMIDATE,
    .nature = TRAINER_PARTY_NATURE(NATURE_ADAMANT),
    .lvl = 24,
    .species = SPECIES_SCRAFTY,
    .heldItem = ITEM_ASSAULT_VEST,
    .moves = {MOVE_DRAIN_PUNCH, MOVE_KNOCK_OFF, MOVE_ICE_PUNCH, MOVE_POISON_JAB}
    },
    {
    .iv = 255,
    ...
    .species = SPECIES_SCRAFTY,
    .heldItem = ITEM_LEFTOVERS,
    .moves = {MOVE_BULK_UP, MOVE_REST, MOVE_DRAIN_PUNCH, MOVE_CRUNCH}
    },
    {
    .iv = 255,
    ...
    .species = SPECIES_SCRAFTY,
    .heldItem = ITEM_CHOICE_SCARF,
    .moves = {MOVE_KNOCK_OFF, MOVE_CLOSE_COMBAT, MOVE_STONE_EDGE, MOVE_ICE_PUNCH}
    },
    {
    .iv = 255,
