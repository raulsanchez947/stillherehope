...
static const u8 sCreditsText_PkmnEmeraldVersion[]             = _("POKéMON EMERALD CREST");
static const u8 sCreditsText_Credits[]                        = _("2024");
...
static const u8 sCreditsText_ShigekiMorimoto[]                = _("Aaghat");
