const struct CompressedSpriteSheet gMonFrontPicTable[] =
{
    ...
    SPECIES_SPRITE(POLTCHAGEIST_COUNTERFEIT, gMonFrontPic_Poltchageist),
    SPECIES_SPRITE(POLTCHAGEIST_ARTISAN, gMonFrontPic_Poltchageist),
    SPECIES_SPRITE(SINISTCHA_UNREMARKABLE, gMonFrontPic_Sinistcha),
    SPECIES_SPRITE(SINISTCHA_MASTERPIECE, gMonFrontPic_Sinistcha),
    ...
    SPECIES_SPRITE(OGERPON, gMonFrontPic_OgerponTeal),
    ...
    // SPECIES_SPRITE(OGERPON_TEAL_TERA, gMonFrontPic_OgerponTealTera),
    // SPECIES_SPRITE(OGERPON_WELLSPRING_TERA, gMonFrontPic_OgerponWellspringTera),
    // SPECIES_SPRITE(OGERPON_HEARTHFLAME_TERA, gMonFrontPic_OgerponHearthflameTera),
    // SPECIES_SPRITE(OGERPON_CORNERSTONE_TERA, gMonFrontPic_OgerponCornerstoneTera),
