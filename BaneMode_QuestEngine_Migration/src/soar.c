...
const u16 sRegionMapBkgnd_Pal[] = INCBIN_U16("graphics/soar/region_map.gbapal");
const u16 sRegionMapBkgnd_Pal_Fall[] = INCBIN_U16("graphics/soar/region_map_fall.gbapal");
const u16 sRegionMapBkgnd_Pal_Winter[] = INCBIN_U16("graphics/soar/region_map_winter.gbapal");
const u16 sRegionMapBkgnd_Pal_Spring[] = INCBIN_U16("graphics/soar/region_map_spring.gbapal");
...
static const u16 *const seasons[4] = {
	sRegionMapBkgnd_Pal,
	sRegionMapBkgnd_Pal_Fall,
	sRegionMapBkgnd_Pal_Winter,
	sRegionMapBkgnd_Pal_Spring,
};
...
static const u32 sEonBrendanSpriteTiles2[] = INCBIN_U32("graphics/soar/braviary_brendan.4bpp.lz");
static const u32 sEonBrendanSpritePaletteData2[] = INCBIN_U32("graphics/soar/braviary_brendan.gbapal.lz");
static const u32 sEonMaySpriteTiles2[] = INCBIN_U32("graphics/soar/braviary_may.4bpp.lz");
static const u32 sEonMaySpritePaletteData2[] = INCBIN_U32("graphics/soar/braviary_may.gbapal.lz");

static const u32 sEonBrendanSpriteTiles3[] = INCBIN_U32("graphics/soar/latios_brendan.4bpp.lz");
static const u32 sEonBrendanSpritePaletteData3[] = INCBIN_U32("graphics/soar/latios_brendan.gbapal.lz");
static const u32 sEonMaySpriteTiles3[] = INCBIN_U32("graphics/soar/latios_may.4bpp.lz");
static const u32 sEonMaySpritePaletteData3[] = INCBIN_U32("graphics/soar/latios_may.gbapal.lz");
...
static const u8 sCelesticaUseMessage[] = _("{PLAYER} used the CELESTICA FLUTE.{PAUSE_UNTIL_PRESS}");
...
void CB2_InitSoar(void)
{
	...
	case 0:
		if (FlagGet(FLAG_EON_LATI))
			...
			StringExpandPlaceholders(gStringVar4, sCelesticaUseMessage);
...
static void LoadEonGraphics(void)
{
	...
	sEonSpriteSheet.data = sEonBrendanSpriteTiles3;
	sEonSpritePalette.data = sEonBrendanSpritePaletteData3;
...
static void LoadBraviaryGraphics(void)
{
	struct CompressedSpriteSheet sEonSpriteSheet = { .size = 4096,.tag = GFX_TAG_EON };
	struct CompressedSpritePalette sEonSpritePalette = { .tag = GFX_TAG_EON };
...
static void CB2_LoadSoarGraphics(void)
{
	...
	case 0:
		...
		if (FlagGet(FLAG_SEASONS)) {
			GetCurrentSeason();
			LoadPalette(seasons[gSaveBlock1Ptr->seasons], 0x70, 64);
		} else {
